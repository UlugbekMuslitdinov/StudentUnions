 ...
 * Page class
 */
class HoursDefaultDelete extends HoursDefault
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HoursDefaultDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("HoursDefaultList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("HoursDefaultList"); // Return to list
                return;
            }
        }
