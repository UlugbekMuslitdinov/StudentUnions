...
/**
 * Table class for location_descriptions
 */
class LocationDescriptions extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'location_descriptions';
        $this->TableName = 'location_descriptions';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`location_descriptions`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // location_id
        $this->location_id = new DbField('location_descriptions', 'location_descriptions', 'x_location_id', 'location_id', '`location_id`', '`location_id`', 3, 11, -1, false, '`location_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // short
        $this->short = new DbField('location_descriptions', 'location_descriptions', 'x_short', 'short', '`short`', '`short`', 201, 65535, -1, false, '`short`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // long
        $this->long = new DbField('location_descriptions', 'location_descriptions', 'x_long', 'long', '`long`', '`long`', 201, 65535, -1, false, '`long`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->long->Sortable = true; // Allow sort
        $this->Fields['long'] = &$this->long;

        // hours_message
        $this->hours_message = new DbField('location_descriptions', 'location_descriptions', 'x_hours_message', 'hours_message', '`hours_message`', '`hours_message`', 201, 1000, -1, false, '`hours_message`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`location_descriptions`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("LocationDescriptionsList");
        }
    }
    ...
    {
        global $Language;
        if ($pageName == "LocationDescriptionsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "LocationDescriptionsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "LocationDescriptionsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "LocationDescriptionsView";
            case Config("API_ADD_ACTION"):
                return "LocationDescriptionsAdd";
            case Config("API_EDIT_ACTION"):
                return "LocationDescriptionsEdit";
            case Config("API_DELETE_ACTION"):
                return "LocationDescriptionsDelete";
            case Config("API_LIST_ACTION"):
                return "LocationDescriptionsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("LocationDescriptionsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("LocationDescriptionsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "LocationDescriptionsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "LocationDescriptionsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("LocationDescriptionsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("LocationDescriptionsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("LocationDescriptionsDelete", $this->getUrlParm());
    }
