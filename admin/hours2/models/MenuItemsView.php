 ...
 * Page class
 */
class MenuItemsView extends MenuItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MenuItemsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "MenuItemsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MenuItemsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "MenuItemsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
