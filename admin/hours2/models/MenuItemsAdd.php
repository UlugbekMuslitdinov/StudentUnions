 ...
 * Page class
 */
class MenuItemsAdd extends MenuItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MenuItemsAdd";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("menu_items"));
                $doc->Text = @$content;
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "MenuItemsView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->menu_item->CurrentValue = null;
        $this->menu_item->OldValue = $this->menu_item->CurrentValue;
        $this->menu_item_price->CurrentValue = null;
        $this->menu_item_price->OldValue = $this->menu_item_price->CurrentValue;
        ...
        $this->menu_item_comments->CurrentValue = null;
        $this->menu_item_comments->OldValue = $this->menu_item_comments->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row['menu_item'] = $this->menu_item->CurrentValue;
        $row['menu_item_price'] = $this->menu_item_price->CurrentValue;
        ...
        $row['menu_item_comments'] = $this->menu_item_comments->CurrentValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // menu_item
        $this->menu_item->setDbValueDef($rsnew, $this->menu_item->CurrentValue, null, false);

        // menu_item_price
        $this->menu_item_price->setDbValueDef($rsnew, $this->menu_item_price->CurrentValue, null, false);
        ...
        // meal_details_id
        $this->meal_details_id->setDbValueDef($rsnew, $this->meal_details_id->CurrentValue, null, false);

        // menu_item_comments
        $this->menu_item_comments->setDbValueDef($rsnew, $this->menu_item_comments->CurrentValue, null, false);
