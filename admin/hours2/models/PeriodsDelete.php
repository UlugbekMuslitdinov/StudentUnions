 ...
 * Page class
 */
class PeriodsDelete extends Periods
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PeriodsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PeriodsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PeriodsList"); // Return to list
                return;
            }
        }
