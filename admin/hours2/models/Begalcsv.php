...
class Begalcsv extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // A
        $this->A = new DbField('begalcsv', 'begal.csv', 'x_A', 'A', '`A`', '`A`', 200, 10, -1, false, '`A`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->A->Sortable = true; // Allow sort
        $this->Fields['A'] = &$this->A;

        // B
        $this->B = new DbField('begalcsv', 'begal.csv', 'x_B', 'B', '`B`', '`B`', 200, 26, -1, false, '`B`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->B->Sortable = true; // Allow sort
        $this->Fields['B'] = &$this->B;

        // C
        $this->C = new DbField('begalcsv', 'begal.csv', 'x_C', 'C', '`C`', '`C`', 131, 17, -1, false, '`C`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // D
        $this->D = new DbField('begalcsv', 'begal.csv', 'x_D', 'D', '`D`', '`D`', 3, 2, -1, false, '`D`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->D->Sortable = true; // Allow sort
        $this->D->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['D'] = &$this->D;

        // E
        $this->E = new DbField('begalcsv', 'begal.csv', 'x_E', 'E', '`E`', '`E`', 200, 10, -1, false, '`E`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->E->Sortable = true; // Allow sort
        $this->Fields['E'] = &$this->E;

        // F
        $this->F = new DbField('begalcsv', 'begal.csv', 'x_F', 'F', '`F`', '`F`', 3, 1, -1, false, '`F`', false, false, false, 'FORMATTED TEXT', 'TEXT');
