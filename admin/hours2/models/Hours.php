...
class Hours extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // location_id
        $this->location_id = new DbField('hours', 'hours', 'x_location_id', 'location_id', '`location_id`', '`location_id`', 3, 11, -1, false, '`location_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // openm
        $this->openm = new DbField('hours', 'hours', 'x_openm', 'openm', '`openm`', CastDateFieldForLike("`openm`", 4, "DB"), 134, 10, 4, false, '`openm`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->openm->Sortable = true; // Allow sort
        $this->openm->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['openm'] = &$this->openm;

        // closem
        $this->closem = new DbField('hours', 'hours', 'x_closem', 'closem', '`closem`', CastDateFieldForLike("`closem`", 4, "DB"), 134, 10, 4, false, '`closem`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->closem->Sortable = true; // Allow sort
        $this->closem->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['closem'] = &$this->closem;

        // opent
        $this->opent = new DbField('hours', 'hours', 'x_opent', 'opent', '`opent`', CastDateFieldForLike("`opent`", 4, "DB"), 134, 10, 4, false, '`opent`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->opent->Sortable = true; // Allow sort
        $this->opent->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['opent'] = &$this->opent;

        // closet
        $this->closet = new DbField('hours', 'hours', 'x_closet', 'closet', '`closet`', CastDateFieldForLike("`closet`", 4, "DB"), 134, 10, 4, false, '`closet`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->closet->Sortable = true; // Allow sort
        $this->closet->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['closet'] = &$this->closet;

        // openw
        $this->openw = new DbField('hours', 'hours', 'x_openw', 'openw', '`openw`', CastDateFieldForLike("`openw`", 4, "DB"), 134, 10, 4, false, '`openw`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->openw->Sortable = true; // Allow sort
        $this->openw->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['openw'] = &$this->openw;

        // closew
        $this->closew = new DbField('hours', 'hours', 'x_closew', 'closew', '`closew`', CastDateFieldForLike("`closew`", 4, "DB"), 134, 10, 4, false, '`closew`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->closew->Sortable = true; // Allow sort
        $this->closew->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['closew'] = &$this->closew;

        // openr
        $this->openr = new DbField('hours', 'hours', 'x_openr', 'openr', '`openr`', CastDateFieldForLike("`openr`", 4, "DB"), 134, 10, 4, false, '`openr`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->openr->Sortable = true; // Allow sort
        $this->openr->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['openr'] = &$this->openr;

        // closer
        $this->closer = new DbField('hours', 'hours', 'x_closer', 'closer', '`closer`', CastDateFieldForLike("`closer`", 4, "DB"), 134, 10, 4, false, '`closer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->closer->Sortable = true; // Allow sort
        $this->closer->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['closer'] = &$this->closer;

        // openf
        $this->openf = new DbField('hours', 'hours', 'x_openf', 'openf', '`openf`', CastDateFieldForLike("`openf`", 4, "DB"), 134, 10, 4, false, '`openf`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->openf->Sortable = true; // Allow sort
        $this->openf->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['openf'] = &$this->openf;

        // closef
        $this->closef = new DbField('hours', 'hours', 'x_closef', 'closef', '`closef`', CastDateFieldForLike("`closef`", 4, "DB"), 134, 10, 4, false, '`closef`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->closef->Sortable = true; // Allow sort
        $this->closef->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['closef'] = &$this->closef;

        // opens
        $this->opens = new DbField('hours', 'hours', 'x_opens', 'opens', '`opens`', CastDateFieldForLike("`opens`", 4, "DB"), 134, 10, 4, false, '`opens`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->opens->Sortable = true; // Allow sort
        $this->opens->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['opens'] = &$this->opens;

        // closes
        $this->closes = new DbField('hours', 'hours', 'x_closes', 'closes', '`closes`', CastDateFieldForLike("`closes`", 4, "DB"), 134, 10, 4, false, '`closes`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->closes->Sortable = true; // Allow sort
        $this->closes->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['closes'] = &$this->closes;

        // openu
        $this->openu = new DbField('hours', 'hours', 'x_openu', 'openu', '`openu`', CastDateFieldForLike("`openu`", 4, "DB"), 134, 10, 4, false, '`openu`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->openu->Sortable = true; // Allow sort
        $this->openu->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['openu'] = &$this->openu;

        // closeu
        $this->closeu = new DbField('hours', 'hours', 'x_closeu', 'closeu', '`closeu`', CastDateFieldForLike("`closeu`", 4, "DB"), 134, 10, 4, false, '`closeu`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->closeu->Sortable = true; // Allow sort
        $this->closeu->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['closeu'] = &$this->closeu;

        // type
        $this->type = new DbField('hours', 'hours', 'x_type', 'type', '`type`', '`type`', 16, 1, -1, false, '`type`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        ...
        // id
        $this->id = new DbField('hours', 'hours', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        // openm
        $this->openm->EditAttrs["class"] = "form-control";
        $this->openm->EditCustomAttributes = "";
        $this->openm->EditValue = $this->openm->CurrentValue;
        $this->openm->PlaceHolder = RemoveHtml($this->openm->caption());

        // closem
        $this->closem->EditAttrs["class"] = "form-control";
        $this->closem->EditCustomAttributes = "";
        $this->closem->EditValue = $this->closem->CurrentValue;
        $this->closem->PlaceHolder = RemoveHtml($this->closem->caption());

        // opent
        $this->opent->EditAttrs["class"] = "form-control";
        $this->opent->EditCustomAttributes = "";
        $this->opent->EditValue = $this->opent->CurrentValue;
        $this->opent->PlaceHolder = RemoveHtml($this->opent->caption());

        // closet
        $this->closet->EditAttrs["class"] = "form-control";
        $this->closet->EditCustomAttributes = "";
        $this->closet->EditValue = $this->closet->CurrentValue;
        $this->closet->PlaceHolder = RemoveHtml($this->closet->caption());

        // openw
        $this->openw->EditAttrs["class"] = "form-control";
        $this->openw->EditCustomAttributes = "";
        $this->openw->EditValue = $this->openw->CurrentValue;
        $this->openw->PlaceHolder = RemoveHtml($this->openw->caption());

        // closew
        $this->closew->EditAttrs["class"] = "form-control";
        $this->closew->EditCustomAttributes = "";
        $this->closew->EditValue = $this->closew->CurrentValue;
        $this->closew->PlaceHolder = RemoveHtml($this->closew->caption());

        // openr
        $this->openr->EditAttrs["class"] = "form-control";
        $this->openr->EditCustomAttributes = "";
        $this->openr->EditValue = $this->openr->CurrentValue;
        $this->openr->PlaceHolder = RemoveHtml($this->openr->caption());

        // closer
        $this->closer->EditAttrs["class"] = "form-control";
        $this->closer->EditCustomAttributes = "";
        $this->closer->EditValue = $this->closer->CurrentValue;
        $this->closer->PlaceHolder = RemoveHtml($this->closer->caption());

        // openf
        $this->openf->EditAttrs["class"] = "form-control";
        $this->openf->EditCustomAttributes = "";
        $this->openf->EditValue = $this->openf->CurrentValue;
        $this->openf->PlaceHolder = RemoveHtml($this->openf->caption());

        // closef
        $this->closef->EditAttrs["class"] = "form-control";
        $this->closef->EditCustomAttributes = "";
        $this->closef->EditValue = $this->closef->CurrentValue;
        $this->closef->PlaceHolder = RemoveHtml($this->closef->caption());

        // opens
        $this->opens->EditAttrs["class"] = "form-control";
        $this->opens->EditCustomAttributes = "";
        $this->opens->EditValue = $this->opens->CurrentValue;
        $this->opens->PlaceHolder = RemoveHtml($this->opens->caption());

        // closes
        $this->closes->EditAttrs["class"] = "form-control";
        $this->closes->EditCustomAttributes = "";
        $this->closes->EditValue = $this->closes->CurrentValue;
        $this->closes->PlaceHolder = RemoveHtml($this->closes->caption());

        // openu
        $this->openu->EditAttrs["class"] = "form-control";
        $this->openu->EditCustomAttributes = "";
        $this->openu->EditValue = $this->openu->CurrentValue;
        $this->openu->PlaceHolder = RemoveHtml($this->openu->caption());

        // closeu
        $this->closeu->EditAttrs["class"] = "form-control";
        $this->closeu->EditCustomAttributes = "";
        $this->closeu->EditValue = $this->closeu->CurrentValue;
