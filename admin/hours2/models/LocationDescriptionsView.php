 ...
 * Page class
 */
class LocationDescriptionsView extends LocationDescriptions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LocationDescriptionsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("location_id") ?? Route("location_id")) !== null) {
            $this->RecKey["location_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("location_id") ?? Route("location_id")) !== null) {
                ...
                $this->RecKey["location_id"] = $this->location_id->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->location_id->setQueryStringValue($keyValue);
                $this->RecKey["location_id"] = $this->location_id->QueryStringValue;
            } else {
                $returnUrl = "LocationDescriptionsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "LocationDescriptionsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "LocationDescriptionsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
