...
class HoursException extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // location_id
        $this->location_id = new DbField('hours_exception', 'hours_exception', 'x_location_id', 'location_id', '`location_id`', '`location_id`', 3, 11, -1, false, '`location_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // start
        $this->start = new DbField('hours_exception', 'hours_exception', 'x_start', 'start', '`start`', CastDateFieldForLike("`start`", 0, "DB"), 133, 10, 0, false, '`start`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // end
        $this->end = new DbField('hours_exception', 'hours_exception', 'x_end', 'end', '`end`', CastDateFieldForLike("`end`", 0, "DB"), 133, 10, 0, false, '`end`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // mon_openx
        $this->mon_openx = new DbField('hours_exception', 'hours_exception', 'x_mon_openx', 'mon_openx', '`mon_openx`', CastDateFieldForLike("`mon_openx`", 4, "DB"), 134, 10, 4, false, '`mon_openx`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->mon_openx->Sortable = true; // Allow sort
        $this->mon_openx->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['mon_openx'] = &$this->mon_openx;

        // mon_closex
        $this->mon_closex = new DbField('hours_exception', 'hours_exception', 'x_mon_closex', 'mon_closex', '`mon_closex`', CastDateFieldForLike("`mon_closex`", 4, "DB"), 134, 10, 4, false, '`mon_closex`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->mon_closex->Sortable = true; // Allow sort
        $this->mon_closex->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['mon_closex'] = &$this->mon_closex;

        // tue_openx
        $this->tue_openx = new DbField('hours_exception', 'hours_exception', 'x_tue_openx', 'tue_openx', '`tue_openx`', CastDateFieldForLike("`tue_openx`", 4, "DB"), 134, 10, 4, false, '`tue_openx`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tue_openx->Sortable = true; // Allow sort
        $this->tue_openx->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['tue_openx'] = &$this->tue_openx;

        // tue_closex
        $this->tue_closex = new DbField('hours_exception', 'hours_exception', 'x_tue_closex', 'tue_closex', '`tue_closex`', CastDateFieldForLike("`tue_closex`", 4, "DB"), 134, 10, 4, false, '`tue_closex`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tue_closex->Sortable = true; // Allow sort
        $this->tue_closex->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['tue_closex'] = &$this->tue_closex;

        // wed_openx
        $this->wed_openx = new DbField('hours_exception', 'hours_exception', 'x_wed_openx', 'wed_openx', '`wed_openx`', CastDateFieldForLike("`wed_openx`", 4, "DB"), 134, 10, 4, false, '`wed_openx`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->wed_openx->Sortable = true; // Allow sort
        $this->wed_openx->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['wed_openx'] = &$this->wed_openx;

        // wed_closex
        $this->wed_closex = new DbField('hours_exception', 'hours_exception', 'x_wed_closex', 'wed_closex', '`wed_closex`', CastDateFieldForLike("`wed_closex`", 4, "DB"), 134, 10, 4, false, '`wed_closex`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->wed_closex->Sortable = true; // Allow sort
        $this->wed_closex->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['wed_closex'] = &$this->wed_closex;

        // thu_openx
        $this->thu_openx = new DbField('hours_exception', 'hours_exception', 'x_thu_openx', 'thu_openx', '`thu_openx`', CastDateFieldForLike("`thu_openx`", 4, "DB"), 134, 10, 4, false, '`thu_openx`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->thu_openx->Sortable = true; // Allow sort
        $this->thu_openx->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['thu_openx'] = &$this->thu_openx;

        // thu_closex
        $this->thu_closex = new DbField('hours_exception', 'hours_exception', 'x_thu_closex', 'thu_closex', '`thu_closex`', CastDateFieldForLike("`thu_closex`", 4, "DB"), 134, 10, 4, false, '`thu_closex`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->thu_closex->Sortable = true; // Allow sort
        $this->thu_closex->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['thu_closex'] = &$this->thu_closex;

        // fri_openx
        $this->fri_openx = new DbField('hours_exception', 'hours_exception', 'x_fri_openx', 'fri_openx', '`fri_openx`', CastDateFieldForLike("`fri_openx`", 4, "DB"), 134, 10, 4, false, '`fri_openx`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->fri_openx->Sortable = true; // Allow sort
        $this->fri_openx->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['fri_openx'] = &$this->fri_openx;

        // fri_closex
        $this->fri_closex = new DbField('hours_exception', 'hours_exception', 'x_fri_closex', 'fri_closex', '`fri_closex`', CastDateFieldForLike("`fri_closex`", 4, "DB"), 134, 10, 4, false, '`fri_closex`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->fri_closex->Sortable = true; // Allow sort
        $this->fri_closex->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['fri_closex'] = &$this->fri_closex;

        // sat_openx
        $this->sat_openx = new DbField('hours_exception', 'hours_exception', 'x_sat_openx', 'sat_openx', '`sat_openx`', CastDateFieldForLike("`sat_openx`", 4, "DB"), 134, 10, 4, false, '`sat_openx`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->sat_openx->Sortable = true; // Allow sort
        $this->sat_openx->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['sat_openx'] = &$this->sat_openx;

        // sat_closex
        $this->sat_closex = new DbField('hours_exception', 'hours_exception', 'x_sat_closex', 'sat_closex', '`sat_closex`', CastDateFieldForLike("`sat_closex`", 4, "DB"), 134, 10, 4, false, '`sat_closex`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->sat_closex->Sortable = true; // Allow sort
        $this->sat_closex->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['sat_closex'] = &$this->sat_closex;

        // sun_openx
        $this->sun_openx = new DbField('hours_exception', 'hours_exception', 'x_sun_openx', 'sun_openx', '`sun_openx`', CastDateFieldForLike("`sun_openx`", 4, "DB"), 134, 10, 4, false, '`sun_openx`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->sun_openx->Sortable = true; // Allow sort
        $this->sun_openx->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['sun_openx'] = &$this->sun_openx;

        // sun_closex
        $this->sun_closex = new DbField('hours_exception', 'hours_exception', 'x_sun_closex', 'sun_closex', '`sun_closex`', CastDateFieldForLike("`sun_closex`", 4, "DB"), 134, 10, 4, false, '`sun_closex`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->sun_closex->Sortable = true; // Allow sort
        $this->sun_closex->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['sun_closex'] = &$this->sun_closex;

        // closex
        $this->closex = new DbField('hours_exception', 'hours_exception', 'x_closex', 'closex', '`closex`', '`closex`', 200, 6, -1, false, '`closex`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->closex->Sortable = true; // Allow sort
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("HoursExceptionList");
        }
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        // mon_openx
        $this->mon_openx->EditAttrs["class"] = "form-control";
        $this->mon_openx->EditCustomAttributes = "";
        $this->mon_openx->EditValue = $this->mon_openx->CurrentValue;
        $this->mon_openx->PlaceHolder = RemoveHtml($this->mon_openx->caption());

        // mon_closex
        $this->mon_closex->EditAttrs["class"] = "form-control";
        $this->mon_closex->EditCustomAttributes = "";
        $this->mon_closex->EditValue = $this->mon_closex->CurrentValue;
        $this->mon_closex->PlaceHolder = RemoveHtml($this->mon_closex->caption());

        // tue_openx
        $this->tue_openx->EditAttrs["class"] = "form-control";
        $this->tue_openx->EditCustomAttributes = "";
        $this->tue_openx->EditValue = $this->tue_openx->CurrentValue;
        $this->tue_openx->PlaceHolder = RemoveHtml($this->tue_openx->caption());

        // tue_closex
        $this->tue_closex->EditAttrs["class"] = "form-control";
        $this->tue_closex->EditCustomAttributes = "";
        $this->tue_closex->EditValue = $this->tue_closex->CurrentValue;
        $this->tue_closex->PlaceHolder = RemoveHtml($this->tue_closex->caption());

        // wed_openx
        $this->wed_openx->EditAttrs["class"] = "form-control";
        $this->wed_openx->EditCustomAttributes = "";
        $this->wed_openx->EditValue = $this->wed_openx->CurrentValue;
        $this->wed_openx->PlaceHolder = RemoveHtml($this->wed_openx->caption());

        // wed_closex
        $this->wed_closex->EditAttrs["class"] = "form-control";
        $this->wed_closex->EditCustomAttributes = "";
        $this->wed_closex->EditValue = $this->wed_closex->CurrentValue;
        $this->wed_closex->PlaceHolder = RemoveHtml($this->wed_closex->caption());

        // thu_openx
        $this->thu_openx->EditAttrs["class"] = "form-control";
        $this->thu_openx->EditCustomAttributes = "";
        $this->thu_openx->EditValue = $this->thu_openx->CurrentValue;
        $this->thu_openx->PlaceHolder = RemoveHtml($this->thu_openx->caption());

        // thu_closex
        $this->thu_closex->EditAttrs["class"] = "form-control";
        $this->thu_closex->EditCustomAttributes = "";
        $this->thu_closex->EditValue = $this->thu_closex->CurrentValue;
        $this->thu_closex->PlaceHolder = RemoveHtml($this->thu_closex->caption());

        // fri_openx
        $this->fri_openx->EditAttrs["class"] = "form-control";
        $this->fri_openx->EditCustomAttributes = "";
        $this->fri_openx->EditValue = $this->fri_openx->CurrentValue;
        $this->fri_openx->PlaceHolder = RemoveHtml($this->fri_openx->caption());

        // fri_closex
        $this->fri_closex->EditAttrs["class"] = "form-control";
        $this->fri_closex->EditCustomAttributes = "";
        $this->fri_closex->EditValue = $this->fri_closex->CurrentValue;
        $this->fri_closex->PlaceHolder = RemoveHtml($this->fri_closex->caption());

        // sat_openx
        $this->sat_openx->EditAttrs["class"] = "form-control";
        $this->sat_openx->EditCustomAttributes = "";
        $this->sat_openx->EditValue = $this->sat_openx->CurrentValue;
        $this->sat_openx->PlaceHolder = RemoveHtml($this->sat_openx->caption());

        // sat_closex
        $this->sat_closex->EditAttrs["class"] = "form-control";
        $this->sat_closex->EditCustomAttributes = "";
        $this->sat_closex->EditValue = $this->sat_closex->CurrentValue;
        $this->sat_closex->PlaceHolder = RemoveHtml($this->sat_closex->caption());

        // sun_openx
        $this->sun_openx->EditAttrs["class"] = "form-control";
        $this->sun_openx->EditCustomAttributes = "";
        $this->sun_openx->EditValue = $this->sun_openx->CurrentValue;
        $this->sun_openx->PlaceHolder = RemoveHtml($this->sun_openx->caption());

        // sun_closex
        $this->sun_closex->EditAttrs["class"] = "form-control";
        $this->sun_closex->EditCustomAttributes = "";
        $this->sun_closex->EditValue = $this->sun_closex->CurrentValue;
        $this->sun_closex->PlaceHolder = RemoveHtml($this->sun_closex->caption());

        // closex
        $this->closex->EditAttrs["class"] = "form-control";
