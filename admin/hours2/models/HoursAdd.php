...
class HoursAdd extends Hours
{
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->openm->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->openm->setFormValue($val);
            }
            $this->openm->CurrentValue = UnFormatDateTime($this->openm->CurrentValue, 4);
        }
        ...
        if (!$this->closem->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->closem->setFormValue($val);
            }
            $this->closem->CurrentValue = UnFormatDateTime($this->closem->CurrentValue, 4);
        }
        ...
        if (!$this->opent->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->opent->setFormValue($val);
            }
            $this->opent->CurrentValue = UnFormatDateTime($this->opent->CurrentValue, 4);
        }
        ...
        if (!$this->closet->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->closet->setFormValue($val);
            }
            $this->closet->CurrentValue = UnFormatDateTime($this->closet->CurrentValue, 4);
        }
        ...
        if (!$this->openw->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->openw->setFormValue($val);
            }
            $this->openw->CurrentValue = UnFormatDateTime($this->openw->CurrentValue, 4);
        }
        ...
        if (!$this->closew->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->closew->setFormValue($val);
            }
            $this->closew->CurrentValue = UnFormatDateTime($this->closew->CurrentValue, 4);
        }
        ...
        if (!$this->openr->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->openr->setFormValue($val);
            }
            $this->openr->CurrentValue = UnFormatDateTime($this->openr->CurrentValue, 4);
        }
        ...
        if (!$this->closer->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->closer->setFormValue($val);
            }
            $this->closer->CurrentValue = UnFormatDateTime($this->closer->CurrentValue, 4);
        }
        ...
        if (!$this->openf->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->openf->setFormValue($val);
            }
            $this->openf->CurrentValue = UnFormatDateTime($this->openf->CurrentValue, 4);
        }
        ...
        if (!$this->closef->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->closef->setFormValue($val);
            }
            $this->closef->CurrentValue = UnFormatDateTime($this->closef->CurrentValue, 4);
        }
        ...
        if (!$this->opens->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->opens->setFormValue($val);
            }
            $this->opens->CurrentValue = UnFormatDateTime($this->opens->CurrentValue, 4);
        }
        ...
        if (!$this->closes->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->closes->setFormValue($val);
            }
            $this->closes->CurrentValue = UnFormatDateTime($this->closes->CurrentValue, 4);
        }
        ...
        if (!$this->openu->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->openu->setFormValue($val);
            }
            $this->openu->CurrentValue = UnFormatDateTime($this->openu->CurrentValue, 4);
        }
        ...
        if (!$this->closeu->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->closeu->setFormValue($val);
            }
            $this->closeu->CurrentValue = UnFormatDateTime($this->closeu->CurrentValue, 4);
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->openm->EditValue = HtmlEncode($this->openm->CurrentValue);
            ...
            $this->closem->EditValue = HtmlEncode($this->closem->CurrentValue);
            ...
            $this->opent->EditValue = HtmlEncode($this->opent->CurrentValue);
            ...
            $this->closet->EditValue = HtmlEncode($this->closet->CurrentValue);
            ...
            $this->openw->EditValue = HtmlEncode($this->openw->CurrentValue);
            ...
            $this->closew->EditValue = HtmlEncode($this->closew->CurrentValue);
            ...
            $this->openr->EditValue = HtmlEncode($this->openr->CurrentValue);
            ...
            $this->closer->EditValue = HtmlEncode($this->closer->CurrentValue);
            ...
            $this->openf->EditValue = HtmlEncode($this->openf->CurrentValue);
            ...
            $this->closef->EditValue = HtmlEncode($this->closef->CurrentValue);
            ...
            $this->opens->EditValue = HtmlEncode($this->opens->CurrentValue);
            ...
            $this->closes->EditValue = HtmlEncode($this->closes->CurrentValue);
            ...
            $this->openu->EditValue = HtmlEncode($this->openu->CurrentValue);
            ...
            $this->closeu->EditValue = HtmlEncode($this->closeu->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if (!CheckTime($this->openm->FormValue)) {
        ...
        if (!CheckTime($this->closem->FormValue)) {
        ...
        if (!CheckTime($this->opent->FormValue)) {
        ...
        if (!CheckTime($this->closet->FormValue)) {
        ...
        if (!CheckTime($this->openw->FormValue)) {
        ...
        if (!CheckTime($this->closew->FormValue)) {
        ...
        if (!CheckTime($this->openr->FormValue)) {
        ...
        if (!CheckTime($this->closer->FormValue)) {
        ...
        if (!CheckTime($this->openf->FormValue)) {
        ...
        if (!CheckTime($this->closef->FormValue)) {
        ...
        if (!CheckTime($this->opens->FormValue)) {
        ...
        if (!CheckTime($this->closes->FormValue)) {
        ...
        if (!CheckTime($this->openu->FormValue)) {
        ...
        if (!CheckTime($this->closeu->FormValue)) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // openm
        $this->openm->setDbValueDef($rsnew, $this->openm->CurrentValue, null, strval($this->openm->CurrentValue) == "");

        // closem
        $this->closem->setDbValueDef($rsnew, $this->closem->CurrentValue, null, strval($this->closem->CurrentValue) == "");

        // opent
        $this->opent->setDbValueDef($rsnew, $this->opent->CurrentValue, null, strval($this->opent->CurrentValue) == "");

        // closet
        $this->closet->setDbValueDef($rsnew, $this->closet->CurrentValue, null, strval($this->closet->CurrentValue) == "");

        // openw
        $this->openw->setDbValueDef($rsnew, $this->openw->CurrentValue, null, strval($this->openw->CurrentValue) == "");

        // closew
        $this->closew->setDbValueDef($rsnew, $this->closew->CurrentValue, null, strval($this->closew->CurrentValue) == "");

        // openr
        $this->openr->setDbValueDef($rsnew, $this->openr->CurrentValue, null, strval($this->openr->CurrentValue) == "");

        // closer
        $this->closer->setDbValueDef($rsnew, $this->closer->CurrentValue, null, strval($this->closer->CurrentValue) == "");

        // openf
        $this->openf->setDbValueDef($rsnew, $this->openf->CurrentValue, null, strval($this->openf->CurrentValue) == "");

        // closef
        $this->closef->setDbValueDef($rsnew, $this->closef->CurrentValue, null, strval($this->closef->CurrentValue) == "");

        // opens
        $this->opens->setDbValueDef($rsnew, $this->opens->CurrentValue, null, strval($this->opens->CurrentValue) == "");

        // closes
        $this->closes->setDbValueDef($rsnew, $this->closes->CurrentValue, null, strval($this->closes->CurrentValue) == "");

        // openu
        $this->openu->setDbValueDef($rsnew, $this->openu->CurrentValue, null, strval($this->openu->CurrentValue) == "");

        // closeu
        $this->closeu->setDbValueDef($rsnew, $this->closeu->CurrentValue, null, strval($this->closeu->CurrentValue) == "");
