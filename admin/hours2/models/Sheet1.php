...
/**
 * Table class for sheet1
 */
class Sheet1 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'sheet1';
        $this->TableName = 'sheet1';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`sheet1`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // A
        $this->A = new DbField('sheet1', 'sheet1', 'x_A', 'A', '`A`', '`A`', 200, 11, -1, false, '`A`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->A->Sortable = true; // Allow sort
        $this->Fields['A'] = &$this->A;

        // B
        $this->B = new DbField('sheet1', 'sheet1', 'x_B', 'B', '`B`', '`B`', 200, 63, -1, false, '`B`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->B->Sortable = true; // Allow sort
        $this->Fields['B'] = &$this->B;

        // C
        $this->C = new DbField('sheet1', 'sheet1', 'x_C', 'C', '`C`', '`C`', 200, 15, -1, false, '`C`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->C->Sortable = true; // Allow sort
        $this->Fields['C'] = &$this->C;

        // D
        $this->D = new DbField('sheet1', 'sheet1', 'x_D', 'D', '`D`', '`D`', 200, 8, -1, false, '`D`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->D->Sortable = true; // Allow sort
        $this->Fields['D'] = &$this->D;

        // E
        $this->E = new DbField('sheet1', 'sheet1', 'x_E', 'E', '`E`', '`E`', 200, 15, -1, false, '`E`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`sheet1`";
    }
    ...
    {
        global $Language;
        if ($pageName == "Sheet1View") {
            return $Language->phrase("View");
        } elseif ($pageName == "Sheet1Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "Sheet1Add") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("Sheet1View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("Sheet1View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "Sheet1Add?" . $this->getUrlParm($parm);
        } else {
            $url = "Sheet1Add";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("Sheet1Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("Sheet1Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("Sheet1Delete", $this->getUrlParm());
    }
