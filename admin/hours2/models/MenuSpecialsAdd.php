 ...
 * Page class
 */
class MenuSpecialsAdd extends MenuSpecials
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MenuSpecialsAdd";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("menu_specials"));
                $doc->Text = @$content;
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "MenuSpecialsView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->menu_special->CurrentValue = null;
        $this->menu_special->OldValue = $this->menu_special->CurrentValue;
        $this->menu_special_price->CurrentValue = null;
        $this->menu_special_price->OldValue = $this->menu_special_price->CurrentValue;
        $this->menu_restaurant->CurrentValue = null;
        $this->menu_restaurant->OldValue = $this->menu_restaurant->CurrentValue;
        $this->menu_category->CurrentValue = null;
        $this->menu_category->OldValue = $this->menu_category->CurrentValue;
        $this->menu_special_comments->CurrentValue = null;
        $this->menu_special_comments->OldValue = $this->menu_special_comments->CurrentValue;
        $this->menu_special_startdate->CurrentValue = null;
        $this->menu_special_startdate->OldValue = $this->menu_special_startdate->CurrentValue;
        $this->menu_special_enddate->CurrentValue = null;
        $this->menu_special_enddate->OldValue = $this->menu_special_enddate->CurrentValue;
        $this->menu_special_replace_item->CurrentValue = null;
        $this->menu_special_replace_item->OldValue = $this->menu_special_replace_item->CurrentValue;
    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->menu_special_price->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->menu_special_price->setFormValue($val);
            }
        }
        ...
        if (!$this->menu_restaurant->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->menu_restaurant->setFormValue($val);
            }
        }
        ...
        if (!$this->menu_category->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->menu_category->setFormValue($val);
            }
        }
        ...
        if (!$this->menu_special_startdate->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->menu_special_startdate->setFormValue($val);
            }
            $this->menu_special_startdate->CurrentValue = UnFormatDateTime($this->menu_special_startdate->CurrentValue, 0);
        }
        ...
        if (!$this->menu_special_enddate->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->menu_special_enddate->setFormValue($val);
            }
            $this->menu_special_enddate->CurrentValue = UnFormatDateTime($this->menu_special_enddate->CurrentValue, 0);
        }
        ...
        if (!$this->menu_special_replace_item->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->menu_special_replace_item->setFormValue($val);
            }
        }
    ...
    protected function newRow()
    {
        ...
        $row['menu_special'] = $this->menu_special->CurrentValue;
        $row['menu_special_price'] = $this->menu_special_price->CurrentValue;
        $row['menu_restaurant'] = $this->menu_restaurant->CurrentValue;
        $row['menu_category'] = $this->menu_category->CurrentValue;
        $row['menu_special_comments'] = $this->menu_special_comments->CurrentValue;
        $row['menu_special_startdate'] = $this->menu_special_startdate->CurrentValue;
        $row['menu_special_enddate'] = $this->menu_special_enddate->CurrentValue;
        $row['menu_special_replace_item'] = $this->menu_special_replace_item->CurrentValue;
        return $row;
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->menu_special_price->FormValue == $this->menu_special_price->CurrentValue && is_numeric(ConvertToFloatString($this->menu_special_price->CurrentValue))) {
            $this->menu_special_price->CurrentValue = ConvertToFloatString($this->menu_special_price->CurrentValue);
        }
    ...
    protected function validateForm()
    {
        ...
        if (!CheckDate($this->menu_special_startdate->FormValue)) {
        ...
        if (!CheckDate($this->menu_special_enddate->FormValue)) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // menu_special
        $this->menu_special->setDbValueDef($rsnew, $this->menu_special->CurrentValue, null, false);

        // menu_special_price
        $this->menu_special_price->setDbValueDef($rsnew, $this->menu_special_price->CurrentValue, null, false);

        // menu_restaurant
        $this->menu_restaurant->setDbValueDef($rsnew, $this->menu_restaurant->CurrentValue, null, false);

        // menu_category
        $this->menu_category->setDbValueDef($rsnew, $this->menu_category->CurrentValue, null, false);

        // menu_special_comments
        $this->menu_special_comments->setDbValueDef($rsnew, $this->menu_special_comments->CurrentValue, null, false);

        // menu_special_startdate
        $this->menu_special_startdate->setDbValueDef($rsnew, UnFormatDateTime($this->menu_special_startdate->CurrentValue, 0), null, false);

        // menu_special_enddate
        $this->menu_special_enddate->setDbValueDef($rsnew, UnFormatDateTime($this->menu_special_enddate->CurrentValue, 0), null, false);

        // menu_special_replace_item
        $this->menu_special_replace_item->setDbValueDef($rsnew, $this->menu_special_replace_item->CurrentValue, null, false);
