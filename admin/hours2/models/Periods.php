...
/**
 * Table class for periods
 */
class Periods extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'periods';
        $this->TableName = 'periods';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`periods`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ID
        $this->ID = new DbField('periods', 'periods', 'x_ID', 'ID', '`ID`', '`ID`', 3, 11, -1, false, '`ID`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // start_date
        $this->start_date = new DbField('periods', 'periods', 'x_start_date', 'start_date', '`start_date`', CastDateFieldForLike("`start_date`", 0, "DB"), 133, 10, 0, false, '`start_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // end_date
        $this->end_date = new DbField('periods', 'periods', 'x_end_date', 'end_date', '`end_date`', CastDateFieldForLike("`end_date`", 0, "DB"), 133, 10, 0, false, '`end_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // type
        $this->type = new DbField('periods', 'periods', 'x_type', 'type', '`type`', '`type`', 16, 1, -1, false, '`type`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->type->Sortable = true; // Allow sort
        $this->type->DataType = DATATYPE_BOOLEAN;
        $this->type->Lookup = new Lookup('type', 'periods', false, '', ["","","",""], [], [], [], [], [], [], '', '');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`periods`";
    }
    ...
    {
        global $Language;
        if ($pageName == "PeriodsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "PeriodsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PeriodsAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PeriodsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PeriodsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PeriodsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PeriodsAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("PeriodsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PeriodsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PeriodsDelete", $this->getUrlParm());
    }
