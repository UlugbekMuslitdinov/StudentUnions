...
class MealTimes extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('meal_times', 'meal_times', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // location_id
        $this->location_id = new DbField('meal_times', 'meal_times', 'x_location_id', 'location_id', '`location_id`', '`location_id`', 3, 11, -1, false, '`location_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // meal_details_id
        $this->meal_details_id = new DbField('meal_times', 'meal_times', 'x_meal_details_id', 'meal_details_id', '`meal_details_id`', '`meal_details_id`', 3, 11, -1, false, '`meal_details_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->meal_details_id->Nullable = false; // NOT NULL field
        $this->meal_details_id->Required = true; // Required field
        $this->meal_details_id->Sortable = true; // Allow sort
        ...
        // startm
        $this->startm = new DbField('meal_times', 'meal_times', 'x_startm', 'startm', '`startm`', CastDateFieldForLike("`startm`", 4, "DB"), 134, 10, 4, false, '`startm`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->startm->Sortable = true; // Allow sort
        $this->startm->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['startm'] = &$this->startm;

        // endm
        $this->endm = new DbField('meal_times', 'meal_times', 'x_endm', 'endm', '`endm`', CastDateFieldForLike("`endm`", 4, "DB"), 134, 10, 4, false, '`endm`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->endm->Sortable = true; // Allow sort
        $this->endm->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['endm'] = &$this->endm;

        // startt
        $this->startt = new DbField('meal_times', 'meal_times', 'x_startt', 'startt', '`startt`', CastDateFieldForLike("`startt`", 4, "DB"), 134, 10, 4, false, '`startt`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->startt->Sortable = true; // Allow sort
        $this->startt->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['startt'] = &$this->startt;

        // endt
        $this->endt = new DbField('meal_times', 'meal_times', 'x_endt', 'endt', '`endt`', CastDateFieldForLike("`endt`", 4, "DB"), 134, 10, 4, false, '`endt`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->endt->Sortable = true; // Allow sort
        $this->endt->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['endt'] = &$this->endt;

        // startw
        $this->startw = new DbField('meal_times', 'meal_times', 'x_startw', 'startw', '`startw`', CastDateFieldForLike("`startw`", 4, "DB"), 134, 10, 4, false, '`startw`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->startw->Sortable = true; // Allow sort
        $this->startw->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['startw'] = &$this->startw;

        // endw
        $this->endw = new DbField('meal_times', 'meal_times', 'x_endw', 'endw', '`endw`', CastDateFieldForLike("`endw`", 4, "DB"), 134, 10, 4, false, '`endw`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->endw->Sortable = true; // Allow sort
        $this->endw->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['endw'] = &$this->endw;

        // startr
        $this->startr = new DbField('meal_times', 'meal_times', 'x_startr', 'startr', '`startr`', CastDateFieldForLike("`startr`", 4, "DB"), 134, 10, 4, false, '`startr`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->startr->Sortable = true; // Allow sort
        $this->startr->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['startr'] = &$this->startr;

        // endr
        $this->endr = new DbField('meal_times', 'meal_times', 'x_endr', 'endr', '`endr`', CastDateFieldForLike("`endr`", 4, "DB"), 134, 10, 4, false, '`endr`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->endr->Sortable = true; // Allow sort
        $this->endr->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['endr'] = &$this->endr;

        // startf
        $this->startf = new DbField('meal_times', 'meal_times', 'x_startf', 'startf', '`startf`', CastDateFieldForLike("`startf`", 4, "DB"), 134, 10, 4, false, '`startf`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->startf->Sortable = true; // Allow sort
        $this->startf->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['startf'] = &$this->startf;

        // endf
        $this->endf = new DbField('meal_times', 'meal_times', 'x_endf', 'endf', '`endf`', CastDateFieldForLike("`endf`", 4, "DB"), 134, 10, 4, false, '`endf`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->endf->Sortable = true; // Allow sort
        $this->endf->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['endf'] = &$this->endf;

        // starts
        $this->starts = new DbField('meal_times', 'meal_times', 'x_starts', 'starts', '`starts`', CastDateFieldForLike("`starts`", 4, "DB"), 134, 10, 4, false, '`starts`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->starts->Sortable = true; // Allow sort
        $this->starts->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['starts'] = &$this->starts;

        // ends
        $this->ends = new DbField('meal_times', 'meal_times', 'x_ends', 'ends', '`ends`', CastDateFieldForLike("`ends`", 4, "DB"), 134, 10, 4, false, '`ends`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ends->Sortable = true; // Allow sort
        $this->ends->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['ends'] = &$this->ends;

        // startu
        $this->startu = new DbField('meal_times', 'meal_times', 'x_startu', 'startu', '`startu`', CastDateFieldForLike("`startu`", 4, "DB"), 134, 10, 4, false, '`startu`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->startu->Sortable = true; // Allow sort
        $this->startu->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['startu'] = &$this->startu;

        // endu
        $this->endu = new DbField('meal_times', 'meal_times', 'x_endu', 'endu', '`endu`', CastDateFieldForLike("`endu`", 4, "DB"), 134, 10, 4, false, '`endu`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->endu->Sortable = true; // Allow sort
        $this->endu->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->startm->EditValue = $this->startm->CurrentValue;
        ...
        $this->endm->EditValue = $this->endm->CurrentValue;
        ...
        $this->startt->EditValue = $this->startt->CurrentValue;
        ...
        $this->endt->EditValue = $this->endt->CurrentValue;
        ...
        $this->startw->EditValue = $this->startw->CurrentValue;
        ...
        $this->endw->EditValue = $this->endw->CurrentValue;
        ...
        $this->startr->EditValue = $this->startr->CurrentValue;
        ...
        $this->endr->EditValue = $this->endr->CurrentValue;
        ...
        $this->startf->EditValue = $this->startf->CurrentValue;
        ...
        $this->endf->EditValue = $this->endf->CurrentValue;
        ...
        $this->starts->EditValue = $this->starts->CurrentValue;
        ...
        $this->ends->EditValue = $this->ends->CurrentValue;
        ...
        $this->startu->EditValue = $this->startu->CurrentValue;
        ...
        $this->endu->EditValue = $this->endu->CurrentValue;
