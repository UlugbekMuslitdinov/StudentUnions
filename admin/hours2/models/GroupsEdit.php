 ...
 * Page class
 */
class GroupsEdit extends Groups
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("group_id") ?? Key(0) ?? Route(2)) !== null) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // group_key
            $this->group_key->setDbValueDef($rsnew, $this->group_key->CurrentValue, "", $this->group_key->ReadOnly);
