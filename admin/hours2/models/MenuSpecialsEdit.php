...
class MenuSpecialsEdit extends MenuSpecials
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // menu_special_startdate
            $this->menu_special_startdate->setDbValueDef($rsnew, UnFormatDateTime($this->menu_special_startdate->CurrentValue, 0), null, $this->menu_special_startdate->ReadOnly);

            // menu_special_enddate
            $this->menu_special_enddate->setDbValueDef($rsnew, UnFormatDateTime($this->menu_special_enddate->CurrentValue, 0), null, $this->menu_special_enddate->ReadOnly);
