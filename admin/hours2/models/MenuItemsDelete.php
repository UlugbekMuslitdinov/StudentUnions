 ...
 * Page class
 */
class MenuItemsDelete extends MenuItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MenuItemsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MenuItemsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MenuItemsList"); // Return to list
                return;
            }
        }
