 ...
 * Page class
 */
class HoursDefaultAdd extends HoursDefault
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HoursDefaultAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "HoursDefaultView") {
    ...
    {
        $this->hour_id->CurrentValue = 0;
        $this->mon_open->CurrentValue = null;
        $this->mon_open->OldValue = $this->mon_open->CurrentValue;
        $this->mon_close->CurrentValue = null;
        $this->mon_close->OldValue = $this->mon_close->CurrentValue;
        $this->tue_open->CurrentValue = null;
        $this->tue_open->OldValue = $this->tue_open->CurrentValue;
        $this->tue_close->CurrentValue = null;
        $this->tue_close->OldValue = $this->tue_close->CurrentValue;
        $this->wed_open->CurrentValue = null;
        $this->wed_open->OldValue = $this->wed_open->CurrentValue;
        $this->wed_close->CurrentValue = null;
        $this->wed_close->OldValue = $this->wed_close->CurrentValue;
        $this->thu_open->CurrentValue = null;
        $this->thu_open->OldValue = $this->thu_open->CurrentValue;
        $this->thu_close->CurrentValue = null;
        $this->thu_close->OldValue = $this->thu_close->CurrentValue;
        $this->fri_open->CurrentValue = null;
        $this->fri_open->OldValue = $this->fri_open->CurrentValue;
        $this->fri_close->CurrentValue = null;
        $this->fri_close->OldValue = $this->fri_close->CurrentValue;
        $this->sat_open->CurrentValue = null;
        $this->sat_open->OldValue = $this->sat_open->CurrentValue;
        $this->sat_close->CurrentValue = null;
        $this->sat_close->OldValue = $this->sat_close->CurrentValue;
        $this->sun_open->CurrentValue = null;
        $this->sun_open->OldValue = $this->sun_open->CurrentValue;
        $this->sun_close->CurrentValue = null;
        $this->sun_close->OldValue = $this->sun_close->CurrentValue;
        $this->close->CurrentValue = null;
        $this->close->OldValue = $this->close->CurrentValue;
    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->mon_open->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->mon_open->setFormValue($val);
            }
            $this->mon_open->CurrentValue = UnFormatDateTime($this->mon_open->CurrentValue, 4);
        }
        ...
        if (!$this->mon_close->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->mon_close->setFormValue($val);
            }
            $this->mon_close->CurrentValue = UnFormatDateTime($this->mon_close->CurrentValue, 4);
        }
        ...
        if (!$this->tue_open->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->tue_open->setFormValue($val);
            }
            $this->tue_open->CurrentValue = UnFormatDateTime($this->tue_open->CurrentValue, 4);
        }
        ...
        if (!$this->tue_close->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->tue_close->setFormValue($val);
            }
            $this->tue_close->CurrentValue = UnFormatDateTime($this->tue_close->CurrentValue, 4);
        }
        ...
        if (!$this->wed_open->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->wed_open->setFormValue($val);
            }
            $this->wed_open->CurrentValue = UnFormatDateTime($this->wed_open->CurrentValue, 4);
        }
        ...
        if (!$this->wed_close->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->wed_close->setFormValue($val);
            }
            $this->wed_close->CurrentValue = UnFormatDateTime($this->wed_close->CurrentValue, 4);
        }
        ...
        if (!$this->thu_open->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->thu_open->setFormValue($val);
            }
            $this->thu_open->CurrentValue = UnFormatDateTime($this->thu_open->CurrentValue, 4);
        }
        ...
        if (!$this->thu_close->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->thu_close->setFormValue($val);
            }
            $this->thu_close->CurrentValue = UnFormatDateTime($this->thu_close->CurrentValue, 4);
        }
        ...
        if (!$this->fri_open->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->fri_open->setFormValue($val);
            }
            $this->fri_open->CurrentValue = UnFormatDateTime($this->fri_open->CurrentValue, 4);
        }
        ...
        if (!$this->fri_close->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->fri_close->setFormValue($val);
            }
            $this->fri_close->CurrentValue = UnFormatDateTime($this->fri_close->CurrentValue, 4);
        }
        ...
        if (!$this->sat_open->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->sat_open->setFormValue($val);
            }
            $this->sat_open->CurrentValue = UnFormatDateTime($this->sat_open->CurrentValue, 4);
        }
        ...
        if (!$this->sat_close->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->sat_close->setFormValue($val);
            }
            $this->sat_close->CurrentValue = UnFormatDateTime($this->sat_close->CurrentValue, 4);
        }
        ...
        if (!$this->sun_open->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->sun_open->setFormValue($val);
            }
            $this->sun_open->CurrentValue = UnFormatDateTime($this->sun_open->CurrentValue, 4);
        }
        ...
        if (!$this->sun_close->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->sun_close->setFormValue($val);
            }
            $this->sun_close->CurrentValue = UnFormatDateTime($this->sun_close->CurrentValue, 4);
        }
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['hour_id'] = $this->hour_id->CurrentValue;
        $row['mon_open'] = $this->mon_open->CurrentValue;
        $row['mon_close'] = $this->mon_close->CurrentValue;
        $row['tue_open'] = $this->tue_open->CurrentValue;
        $row['tue_close'] = $this->tue_close->CurrentValue;
        $row['wed_open'] = $this->wed_open->CurrentValue;
        $row['wed_close'] = $this->wed_close->CurrentValue;
        $row['thu_open'] = $this->thu_open->CurrentValue;
        $row['thu_close'] = $this->thu_close->CurrentValue;
        $row['fri_open'] = $this->fri_open->CurrentValue;
        $row['fri_close'] = $this->fri_close->CurrentValue;
        $row['sat_open'] = $this->sat_open->CurrentValue;
        $row['sat_close'] = $this->sat_close->CurrentValue;
        $row['sun_open'] = $this->sun_open->CurrentValue;
        $row['sun_close'] = $this->sun_close->CurrentValue;
        $row['close'] = $this->close->CurrentValue;
        return $row;
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // hour_id
            $this->hour_id->EditAttrs["class"] = "form-control";
            ...
            // mon_open
            $this->mon_open->EditAttrs["class"] = "form-control";
            $this->mon_open->EditCustomAttributes = "";
            $this->mon_open->EditValue = HtmlEncode($this->mon_open->CurrentValue);
            $this->mon_open->PlaceHolder = RemoveHtml($this->mon_open->caption());

            // mon_close
            $this->mon_close->EditAttrs["class"] = "form-control";
            $this->mon_close->EditCustomAttributes = "";
            $this->mon_close->EditValue = HtmlEncode($this->mon_close->CurrentValue);
            $this->mon_close->PlaceHolder = RemoveHtml($this->mon_close->caption());

            // tue_open
            $this->tue_open->EditAttrs["class"] = "form-control";
            $this->tue_open->EditCustomAttributes = "";
            $this->tue_open->EditValue = HtmlEncode($this->tue_open->CurrentValue);
            $this->tue_open->PlaceHolder = RemoveHtml($this->tue_open->caption());

            // tue_close
            $this->tue_close->EditAttrs["class"] = "form-control";
            $this->tue_close->EditCustomAttributes = "";
            $this->tue_close->EditValue = HtmlEncode($this->tue_close->CurrentValue);
            $this->tue_close->PlaceHolder = RemoveHtml($this->tue_close->caption());

            // wed_open
            $this->wed_open->EditAttrs["class"] = "form-control";
            $this->wed_open->EditCustomAttributes = "";
            $this->wed_open->EditValue = HtmlEncode($this->wed_open->CurrentValue);
            $this->wed_open->PlaceHolder = RemoveHtml($this->wed_open->caption());

            // wed_close
            $this->wed_close->EditAttrs["class"] = "form-control";
            $this->wed_close->EditCustomAttributes = "";
            $this->wed_close->EditValue = HtmlEncode($this->wed_close->CurrentValue);
            $this->wed_close->PlaceHolder = RemoveHtml($this->wed_close->caption());

            // thu_open
            $this->thu_open->EditAttrs["class"] = "form-control";
            $this->thu_open->EditCustomAttributes = "";
            $this->thu_open->EditValue = HtmlEncode($this->thu_open->CurrentValue);
            $this->thu_open->PlaceHolder = RemoveHtml($this->thu_open->caption());

            // thu_close
            $this->thu_close->EditAttrs["class"] = "form-control";
            $this->thu_close->EditCustomAttributes = "";
            $this->thu_close->EditValue = HtmlEncode($this->thu_close->CurrentValue);
            $this->thu_close->PlaceHolder = RemoveHtml($this->thu_close->caption());

            // fri_open
            $this->fri_open->EditAttrs["class"] = "form-control";
            $this->fri_open->EditCustomAttributes = "";
            $this->fri_open->EditValue = HtmlEncode($this->fri_open->CurrentValue);
            $this->fri_open->PlaceHolder = RemoveHtml($this->fri_open->caption());

            // fri_close
            $this->fri_close->EditAttrs["class"] = "form-control";
            $this->fri_close->EditCustomAttributes = "";
            $this->fri_close->EditValue = HtmlEncode($this->fri_close->CurrentValue);
            $this->fri_close->PlaceHolder = RemoveHtml($this->fri_close->caption());

            // sat_open
            $this->sat_open->EditAttrs["class"] = "form-control";
            $this->sat_open->EditCustomAttributes = "";
            $this->sat_open->EditValue = HtmlEncode($this->sat_open->CurrentValue);
            $this->sat_open->PlaceHolder = RemoveHtml($this->sat_open->caption());

            // sat_close
            $this->sat_close->EditAttrs["class"] = "form-control";
            $this->sat_close->EditCustomAttributes = "";
            $this->sat_close->EditValue = HtmlEncode($this->sat_close->CurrentValue);
            $this->sat_close->PlaceHolder = RemoveHtml($this->sat_close->caption());

            // sun_open
            $this->sun_open->EditAttrs["class"] = "form-control";
            $this->sun_open->EditCustomAttributes = "";
            $this->sun_open->EditValue = HtmlEncode($this->sun_open->CurrentValue);
            $this->sun_open->PlaceHolder = RemoveHtml($this->sun_open->caption());

            // sun_close
            $this->sun_close->EditAttrs["class"] = "form-control";
            $this->sun_close->EditCustomAttributes = "";
            $this->sun_close->EditValue = HtmlEncode($this->sun_close->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if (!CheckTime($this->mon_open->FormValue)) {
        ...
        if (!CheckTime($this->mon_close->FormValue)) {
        ...
        if (!CheckTime($this->tue_open->FormValue)) {
        ...
        if (!CheckTime($this->tue_close->FormValue)) {
        ...
        if (!CheckTime($this->wed_open->FormValue)) {
        ...
        if (!CheckTime($this->wed_close->FormValue)) {
        ...
        if (!CheckTime($this->thu_open->FormValue)) {
        ...
        if (!CheckTime($this->thu_close->FormValue)) {
        ...
        if (!CheckTime($this->fri_open->FormValue)) {
        ...
        if (!CheckTime($this->fri_close->FormValue)) {
        ...
        if (!CheckTime($this->sat_open->FormValue)) {
        ...
        if (!CheckTime($this->sat_close->FormValue)) {
        ...
        if (!CheckTime($this->sun_open->FormValue)) {
        ...
        if (!CheckTime($this->sun_close->FormValue)) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // hour_id
        $this->hour_id->setDbValueDef($rsnew, $this->hour_id->CurrentValue, 0, strval($this->hour_id->CurrentValue) == "");

        // mon_open
        $this->mon_open->setDbValueDef($rsnew, $this->mon_open->CurrentValue, null, false);

        // mon_close
        $this->mon_close->setDbValueDef($rsnew, $this->mon_close->CurrentValue, null, false);

        // tue_open
        $this->tue_open->setDbValueDef($rsnew, $this->tue_open->CurrentValue, null, false);

        // tue_close
        $this->tue_close->setDbValueDef($rsnew, $this->tue_close->CurrentValue, null, false);

        // wed_open
        $this->wed_open->setDbValueDef($rsnew, $this->wed_open->CurrentValue, null, false);

        // wed_close
        $this->wed_close->setDbValueDef($rsnew, $this->wed_close->CurrentValue, null, false);

        // thu_open
        $this->thu_open->setDbValueDef($rsnew, $this->thu_open->CurrentValue, null, false);

        // thu_close
        $this->thu_close->setDbValueDef($rsnew, $this->thu_close->CurrentValue, null, false);

        // fri_open
        $this->fri_open->setDbValueDef($rsnew, $this->fri_open->CurrentValue, null, false);

        // fri_close
        $this->fri_close->setDbValueDef($rsnew, $this->fri_close->CurrentValue, null, false);

        // sat_open
        $this->sat_open->setDbValueDef($rsnew, $this->sat_open->CurrentValue, null, false);

        // sat_close
        $this->sat_close->setDbValueDef($rsnew, $this->sat_close->CurrentValue, null, false);

        // sun_open
        $this->sun_open->setDbValueDef($rsnew, $this->sun_open->CurrentValue, null, false);

        // sun_close
        $this->sun_close->setDbValueDef($rsnew, $this->sun_close->CurrentValue, null, false);

        // close
        $this->close->setDbValueDef($rsnew, $this->close->CurrentValue, null, false);

        // Call Row Inserting event
        $insertRow = $this->rowInserting($rsold, $rsnew);

        // Check if key value entered
        if ($insertRow && $this->ValidateKey && strval($rsnew['hour_id']) == "") {
