 ...
 * Page class
 */
class MenuSpecialsView extends MenuSpecials
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MenuSpecialsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "MenuSpecialsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MenuSpecialsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "MenuSpecialsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
