...
class HoursEdit extends Hours
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // openm
            $this->openm->setDbValueDef($rsnew, $this->openm->CurrentValue, null, $this->openm->ReadOnly);

            // closem
            $this->closem->setDbValueDef($rsnew, $this->closem->CurrentValue, null, $this->closem->ReadOnly);

            // opent
            $this->opent->setDbValueDef($rsnew, $this->opent->CurrentValue, null, $this->opent->ReadOnly);

            // closet
            $this->closet->setDbValueDef($rsnew, $this->closet->CurrentValue, null, $this->closet->ReadOnly);

            // openw
            $this->openw->setDbValueDef($rsnew, $this->openw->CurrentValue, null, $this->openw->ReadOnly);

            // closew
            $this->closew->setDbValueDef($rsnew, $this->closew->CurrentValue, null, $this->closew->ReadOnly);

            // openr
            $this->openr->setDbValueDef($rsnew, $this->openr->CurrentValue, null, $this->openr->ReadOnly);

            // closer
            $this->closer->setDbValueDef($rsnew, $this->closer->CurrentValue, null, $this->closer->ReadOnly);

            // openf
            $this->openf->setDbValueDef($rsnew, $this->openf->CurrentValue, null, $this->openf->ReadOnly);

            // closef
            $this->closef->setDbValueDef($rsnew, $this->closef->CurrentValue, null, $this->closef->ReadOnly);

            // opens
            $this->opens->setDbValueDef($rsnew, $this->opens->CurrentValue, null, $this->opens->ReadOnly);

            // closes
            $this->closes->setDbValueDef($rsnew, $this->closes->CurrentValue, null, $this->closes->ReadOnly);

            // openu
            $this->openu->setDbValueDef($rsnew, $this->openu->CurrentValue, null, $this->openu->ReadOnly);

            // closeu
            $this->closeu->setDbValueDef($rsnew, $this->closeu->CurrentValue, null, $this->closeu->ReadOnly);
            ...
            $this->type->setDbValueDef($rsnew, $tmpBool, null, $this->type->ReadOnly);
