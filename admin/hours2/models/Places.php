...
class Places extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // name
        $this->name = new DbField('places', 'places', 'x_name', 'name', '`name`', '`name`', 201, 65535, -1, false, '`name`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->name->Sortable = true; // Allow sort
        $this->Fields['name'] = &$this->name;

        // category
        $this->category = new DbField('places', 'places', 'x_category', 'category', '`category`', '`category`', 201, 65535, -1, false, '`category`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->category->Sortable = true; // Allow sort
        $this->Fields['category'] = &$this->category;

        // url
        $this->url = new DbField('places', 'places', 'x_url', 'url', '`url`', '`url`', 201, 65535, -1, false, '`url`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->url->Sortable = true; // Allow sort
        $this->Fields['url'] = &$this->url;

        // email
        $this->_email = new DbField('places', 'places', 'x__email', 'email', '`email`', '`email`', 201, 65535, -1, false, '`email`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->_email->Sortable = true; // Allow sort
        $this->Fields['email'] = &$this->_email;

        // building
        $this->building = new DbField('places', 'places', 'x_building', 'building', '`building`', '`building`', 201, 65535, -1, false, '`building`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->building->Sortable = true; // Allow sort
        $this->Fields['building'] = &$this->building;

        // building_id
        $this->building_id = new DbField('places', 'places', 'x_building_id', 'building_id', '`building_id`', '`building_id`', 201, 65535, -1, false, '`building_id`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->building_id->Sortable = true; // Allow sort
        $this->Fields['building_id'] = &$this->building_id;

        // mailing_address
        $this->mailing_address = new DbField('places', 'places', 'x_mailing_address', 'mailing_address', '`mailing_address`', '`mailing_address`', 201, 65535, -1, false, '`mailing_address`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->mailing_address->Sortable = true; // Allow sort
        $this->Fields['mailing_address'] = &$this->mailing_address;

        // main_phone
        $this->main_phone = new DbField('places', 'places', 'x_main_phone', 'main_phone', '`main_phone`', '`main_phone`', 201, 65535, -1, false, '`main_phone`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->main_phone->Sortable = true; // Allow sort
        $this->Fields['main_phone'] = &$this->main_phone;

        // other_phone
        $this->other_phone = new DbField('places', 'places', 'x_other_phone', 'other_phone', '`other_phone`', '`other_phone`', 201, 65535, -1, false, '`other_phone`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->other_phone->Sortable = true; // Allow sort
        $this->Fields['other_phone'] = &$this->other_phone;

        // FAX
        $this->FAX = new DbField('places', 'places', 'x_FAX', 'FAX', '`FAX`', '`FAX`', 201, 65535, -1, false, '`FAX`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->FAX->Sortable = true; // Allow sort
        $this->Fields['FAX'] = &$this->FAX;

        // Monday
        $this->Monday = new DbField('places', 'places', 'x_Monday', 'Monday', '`Monday`', '`Monday`', 201, 65535, -1, false, '`Monday`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->Monday->Sortable = true; // Allow sort
        $this->Fields['Monday'] = &$this->Monday;

        // Tuesday
        $this->Tuesday = new DbField('places', 'places', 'x_Tuesday', 'Tuesday', '`Tuesday`', '`Tuesday`', 201, 65535, -1, false, '`Tuesday`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->Tuesday->Sortable = true; // Allow sort
        $this->Fields['Tuesday'] = &$this->Tuesday;

        // Wednesday
        $this->Wednesday = new DbField('places', 'places', 'x_Wednesday', 'Wednesday', '`Wednesday`', '`Wednesday`', 201, 65535, -1, false, '`Wednesday`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->Wednesday->Sortable = true; // Allow sort
        $this->Fields['Wednesday'] = &$this->Wednesday;

        // Thursday
        $this->Thursday = new DbField('places', 'places', 'x_Thursday', 'Thursday', '`Thursday`', '`Thursday`', 201, 65535, -1, false, '`Thursday`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->Thursday->Sortable = true; // Allow sort
        $this->Fields['Thursday'] = &$this->Thursday;

        // Friday
        $this->Friday = new DbField('places', 'places', 'x_Friday', 'Friday', '`Friday`', '`Friday`', 201, 65535, -1, false, '`Friday`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->Friday->Sortable = true; // Allow sort
        $this->Fields['Friday'] = &$this->Friday;

        // Saturday
        $this->Saturday = new DbField('places', 'places', 'x_Saturday', 'Saturday', '`Saturday`', '`Saturday`', 201, 65535, -1, false, '`Saturday`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->Saturday->Sortable = true; // Allow sort
        $this->Fields['Saturday'] = &$this->Saturday;

        // Sunday
        $this->Sunday = new DbField('places', 'places', 'x_Sunday', 'Sunday', '`Sunday`', '`Sunday`', 201, 65535, -1, false, '`Sunday`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->Sunday->Sortable = true; // Allow sort
        $this->Fields['Sunday'] = &$this->Sunday;

        // hours
        $this->hours = new DbField('places', 'places', 'x_hours', 'hours', '`hours`', '`hours`', 201, 65535, -1, false, '`hours`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->hours->Sortable = true; // Allow sort
        $this->Fields['hours'] = &$this->hours;

        // lat
        $this->lat = new DbField('places', 'places', 'x_lat', 'lat', '`lat`', '`lat`', 201, 65535, -1, false, '`lat`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->lat->Sortable = true; // Allow sort
        $this->Fields['lat'] = &$this->lat;

        // long
        $this->long = new DbField('places', 'places', 'x_long', 'long', '`long`', '`long`', 201, 65535, -1, false, '`long`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // notes
        $this->notes = new DbField('places', 'places', 'x_notes', 'notes', '`notes`', '`notes`', 201, 65535, -1, false, '`notes`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        // building_id
        $this->building_id->EditAttrs["class"] = "form-control";
        ...
        // mailing_address
        $this->mailing_address->EditAttrs["class"] = "form-control";
        ...
        // main_phone
        $this->main_phone->EditAttrs["class"] = "form-control";
        ...
        // other_phone
        $this->other_phone->EditAttrs["class"] = "form-control";
        ...
        // Monday
        $this->Monday->EditAttrs["class"] = "form-control";
        ...
        // Tuesday
        $this->Tuesday->EditAttrs["class"] = "form-control";
        ...
        // Wednesday
        $this->Wednesday->EditAttrs["class"] = "form-control";
        ...
        // Thursday
        $this->Thursday->EditAttrs["class"] = "form-control";
        ...
        // Friday
        $this->Friday->EditAttrs["class"] = "form-control";
        ...
        // Saturday
        $this->Saturday->EditAttrs["class"] = "form-control";
        ...
        // Sunday
        $this->Sunday->EditAttrs["class"] = "form-control";
