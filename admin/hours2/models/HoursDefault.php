...
class HoursDefault extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // hour_id
        $this->hour_id = new DbField('hours_default', 'hours_default', 'x_hour_id', 'hour_id', '`hour_id`', '`hour_id`', 3, 11, -1, false, '`hour_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->hour_id->Sortable = true; // Allow sort
        $this->hour_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['hour_id'] = &$this->hour_id;

        // mon_open
        $this->mon_open = new DbField('hours_default', 'hours_default', 'x_mon_open', 'mon_open', '`mon_open`', CastDateFieldForLike("`mon_open`", 4, "DB"), 134, 10, 4, false, '`mon_open`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->mon_open->Sortable = true; // Allow sort
        $this->mon_open->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['mon_open'] = &$this->mon_open;

        // mon_close
        $this->mon_close = new DbField('hours_default', 'hours_default', 'x_mon_close', 'mon_close', '`mon_close`', CastDateFieldForLike("`mon_close`", 4, "DB"), 134, 10, 4, false, '`mon_close`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->mon_close->Sortable = true; // Allow sort
        $this->mon_close->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['mon_close'] = &$this->mon_close;

        // tue_open
        $this->tue_open = new DbField('hours_default', 'hours_default', 'x_tue_open', 'tue_open', '`tue_open`', CastDateFieldForLike("`tue_open`", 4, "DB"), 134, 10, 4, false, '`tue_open`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tue_open->Sortable = true; // Allow sort
        $this->tue_open->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['tue_open'] = &$this->tue_open;

        // tue_close
        $this->tue_close = new DbField('hours_default', 'hours_default', 'x_tue_close', 'tue_close', '`tue_close`', CastDateFieldForLike("`tue_close`", 4, "DB"), 134, 10, 4, false, '`tue_close`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tue_close->Sortable = true; // Allow sort
        $this->tue_close->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['tue_close'] = &$this->tue_close;

        // wed_open
        $this->wed_open = new DbField('hours_default', 'hours_default', 'x_wed_open', 'wed_open', '`wed_open`', CastDateFieldForLike("`wed_open`", 4, "DB"), 134, 10, 4, false, '`wed_open`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->wed_open->Sortable = true; // Allow sort
        $this->wed_open->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['wed_open'] = &$this->wed_open;

        // wed_close
        $this->wed_close = new DbField('hours_default', 'hours_default', 'x_wed_close', 'wed_close', '`wed_close`', CastDateFieldForLike("`wed_close`", 4, "DB"), 134, 10, 4, false, '`wed_close`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->wed_close->Sortable = true; // Allow sort
        $this->wed_close->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['wed_close'] = &$this->wed_close;

        // thu_open
        $this->thu_open = new DbField('hours_default', 'hours_default', 'x_thu_open', 'thu_open', '`thu_open`', CastDateFieldForLike("`thu_open`", 4, "DB"), 134, 10, 4, false, '`thu_open`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->thu_open->Sortable = true; // Allow sort
        $this->thu_open->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['thu_open'] = &$this->thu_open;

        // thu_close
        $this->thu_close = new DbField('hours_default', 'hours_default', 'x_thu_close', 'thu_close', '`thu_close`', CastDateFieldForLike("`thu_close`", 4, "DB"), 134, 10, 4, false, '`thu_close`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->thu_close->Sortable = true; // Allow sort
        $this->thu_close->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['thu_close'] = &$this->thu_close;

        // fri_open
        $this->fri_open = new DbField('hours_default', 'hours_default', 'x_fri_open', 'fri_open', '`fri_open`', CastDateFieldForLike("`fri_open`", 4, "DB"), 134, 10, 4, false, '`fri_open`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->fri_open->Sortable = true; // Allow sort
        $this->fri_open->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['fri_open'] = &$this->fri_open;

        // fri_close
        $this->fri_close = new DbField('hours_default', 'hours_default', 'x_fri_close', 'fri_close', '`fri_close`', CastDateFieldForLike("`fri_close`", 4, "DB"), 134, 10, 4, false, '`fri_close`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->fri_close->Sortable = true; // Allow sort
        $this->fri_close->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['fri_close'] = &$this->fri_close;

        // sat_open
        $this->sat_open = new DbField('hours_default', 'hours_default', 'x_sat_open', 'sat_open', '`sat_open`', CastDateFieldForLike("`sat_open`", 4, "DB"), 134, 10, 4, false, '`sat_open`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->sat_open->Sortable = true; // Allow sort
        $this->sat_open->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['sat_open'] = &$this->sat_open;

        // sat_close
        $this->sat_close = new DbField('hours_default', 'hours_default', 'x_sat_close', 'sat_close', '`sat_close`', CastDateFieldForLike("`sat_close`", 4, "DB"), 134, 10, 4, false, '`sat_close`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->sat_close->Sortable = true; // Allow sort
        $this->sat_close->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['sat_close'] = &$this->sat_close;

        // sun_open
        $this->sun_open = new DbField('hours_default', 'hours_default', 'x_sun_open', 'sun_open', '`sun_open`', CastDateFieldForLike("`sun_open`", 4, "DB"), 134, 10, 4, false, '`sun_open`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->sun_open->Sortable = true; // Allow sort
        $this->sun_open->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['sun_open'] = &$this->sun_open;

        // sun_close
        $this->sun_close = new DbField('hours_default', 'hours_default', 'x_sun_close', 'sun_close', '`sun_close`', CastDateFieldForLike("`sun_close`", 4, "DB"), 134, 10, 4, false, '`sun_close`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->sun_close->Sortable = true; // Allow sort
        $this->sun_close->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_SEPARATOR"], $Language->phrase("IncorrectTime"));
        $this->Fields['sun_close'] = &$this->sun_close;

        // close
        $this->close = new DbField('hours_default', 'hours_default', 'x_close', 'close', '`close`', '`close`', 200, 6, -1, false, '`close`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("HoursDefaultList");
        }
    }
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->hour_id->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->hour_id->CurrentValue);
        } else {
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->mon_open->EditValue = $this->mon_open->CurrentValue;
        ...
        $this->mon_close->EditValue = $this->mon_close->CurrentValue;
        ...
        $this->tue_open->EditValue = $this->tue_open->CurrentValue;
        ...
        $this->tue_close->EditValue = $this->tue_close->CurrentValue;
        ...
        $this->wed_open->EditValue = $this->wed_open->CurrentValue;
        ...
        $this->wed_close->EditValue = $this->wed_close->CurrentValue;
        ...
        $this->thu_open->EditValue = $this->thu_open->CurrentValue;
        ...
        $this->thu_close->EditValue = $this->thu_close->CurrentValue;
        ...
        $this->fri_open->EditValue = $this->fri_open->CurrentValue;
        ...
        $this->fri_close->EditValue = $this->fri_close->CurrentValue;
        ...
        $this->sat_open->EditValue = $this->sat_open->CurrentValue;
        ...
        $this->sat_close->EditValue = $this->sat_close->CurrentValue;
        ...
        $this->sun_open->EditValue = $this->sun_open->CurrentValue;
        ...
        $this->sun_close->EditValue = $this->sun_close->CurrentValue;
