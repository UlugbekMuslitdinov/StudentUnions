...
class ExceptionsAdd extends Exceptions
{
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("exceptions"));
                $doc->Text = @$content;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->date_of->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->date_of->setFormValue($val);
            }
            $this->date_of->CurrentValue = UnFormatDateTime($this->date_of->CurrentValue, 0);
        }
        ...
        if (!$this->open->IsDetailKey) {
            ...
            $this->open->CurrentValue = UnFormatDateTime($this->open->CurrentValue, 4);
        }
        ...
        if (!$this->close->IsDetailKey) {
            ...
            $this->close->CurrentValue = UnFormatDateTime($this->close->CurrentValue, 4);
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // date_of
            $this->date_of->EditAttrs["class"] = "form-control";
    ...
    protected function validateForm()
    {
        ...
        if (!CheckDate($this->date_of->FormValue)) {
        ...
        if (!CheckTime($this->open->FormValue)) {
        ...
        if (!CheckTime($this->close->FormValue)) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // date_of
        $this->date_of->setDbValueDef($rsnew, UnFormatDateTime($this->date_of->CurrentValue, 0), null, false);

        // open
        $this->open->setDbValueDef($rsnew, $this->open->CurrentValue, null, false);
