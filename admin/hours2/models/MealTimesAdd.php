...
class MealTimesAdd extends MealTimes
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        // startm
        $this->startm->setDbValueDef($rsnew, $this->startm->CurrentValue, null, false);

        // endm
        $this->endm->setDbValueDef($rsnew, $this->endm->CurrentValue, null, false);

        // startt
        $this->startt->setDbValueDef($rsnew, $this->startt->CurrentValue, null, false);

        // endt
        $this->endt->setDbValueDef($rsnew, $this->endt->CurrentValue, null, false);

        // startw
        $this->startw->setDbValueDef($rsnew, $this->startw->CurrentValue, null, false);

        // endw
        $this->endw->setDbValueDef($rsnew, $this->endw->CurrentValue, null, false);

        // startr
        $this->startr->setDbValueDef($rsnew, $this->startr->CurrentValue, null, false);

        // endr
        $this->endr->setDbValueDef($rsnew, $this->endr->CurrentValue, null, false);

        // startf
        $this->startf->setDbValueDef($rsnew, $this->startf->CurrentValue, null, false);

        // endf
        $this->endf->setDbValueDef($rsnew, $this->endf->CurrentValue, null, false);

        // starts
        $this->starts->setDbValueDef($rsnew, $this->starts->CurrentValue, null, false);

        // ends
        $this->ends->setDbValueDef($rsnew, $this->ends->CurrentValue, null, false);

        // startu
        $this->startu->setDbValueDef($rsnew, $this->startu->CurrentValue, null, false);

        // endu
        $this->endu->setDbValueDef($rsnew, $this->endu->CurrentValue, null, false);
