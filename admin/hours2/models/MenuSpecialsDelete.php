 ...
 * Page class
 */
class MenuSpecialsDelete extends MenuSpecials
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MenuSpecialsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MenuSpecialsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MenuSpecialsList"); // Return to list
                return;
            }
        }
