...
loadjs.ready("head", function () {
    ...
    fmenu_categoriesadd = currentForm = new ew.Form("fmenu_categoriesadd", "add");
    ...
    // Validate form
    fmenu_categoriesadd.validate = function () {
    ...
    fmenu_categoriesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fmenu_categoriesadd" id="fmenu_categoriesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
