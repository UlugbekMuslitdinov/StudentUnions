...
loadjs.ready("head", function () {
    ...
    fhoursdelete = currentForm = new ew.Form("fhoursdelete", "delete");
...
$Page->showMessage();
?>
<form name="fhoursdelete" id="fhoursdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<span id="el<?= $Page->RowCount ?>_hours_location_id" class="hours_location_id">
...
<span id="el<?= $Page->RowCount ?>_hours_openm" class="hours_openm">
...
<span id="el<?= $Page->RowCount ?>_hours_closem" class="hours_closem">
...
<span id="el<?= $Page->RowCount ?>_hours_opent" class="hours_opent">
...
<span id="el<?= $Page->RowCount ?>_hours_closet" class="hours_closet">
...
<span id="el<?= $Page->RowCount ?>_hours_openw" class="hours_openw">
...
<span id="el<?= $Page->RowCount ?>_hours_closew" class="hours_closew">
...
<span id="el<?= $Page->RowCount ?>_hours_openr" class="hours_openr">
...
<span id="el<?= $Page->RowCount ?>_hours_closer" class="hours_closer">
...
<span id="el<?= $Page->RowCount ?>_hours_openf" class="hours_openf">
...
<span id="el<?= $Page->RowCount ?>_hours_closef" class="hours_closef">
...
<span id="el<?= $Page->RowCount ?>_hours_opens" class="hours_opens">
...
<span id="el<?= $Page->RowCount ?>_hours_closes" class="hours_closes">
...
<span id="el<?= $Page->RowCount ?>_hours_openu" class="hours_openu">
...
<span id="el<?= $Page->RowCount ?>_hours_closeu" class="hours_closeu">
...
<span id="el<?= $Page->RowCount ?>_hours_type" class="hours_type">
...
<span id="el<?= $Page->RowCount ?>_hours_id" class="hours_id">
