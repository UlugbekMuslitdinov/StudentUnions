...
loadjs.ready("head", function () {
    ...
    fhours_defaultdelete = currentForm = new ew.Form("fhours_defaultdelete", "delete");
...
$Page->showMessage();
?>
<form name="fhours_defaultdelete" id="fhours_defaultdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<span id="el<?= $Page->RowCount ?>_hours_default_hour_id" class="hours_default_hour_id">
...
<span id="el<?= $Page->RowCount ?>_hours_default_mon_open" class="hours_default_mon_open">
...
<span id="el<?= $Page->RowCount ?>_hours_default_mon_close" class="hours_default_mon_close">
...
<span id="el<?= $Page->RowCount ?>_hours_default_tue_open" class="hours_default_tue_open">
...
<span id="el<?= $Page->RowCount ?>_hours_default_tue_close" class="hours_default_tue_close">
...
<span id="el<?= $Page->RowCount ?>_hours_default_wed_open" class="hours_default_wed_open">
...
<span id="el<?= $Page->RowCount ?>_hours_default_wed_close" class="hours_default_wed_close">
...
<span id="el<?= $Page->RowCount ?>_hours_default_thu_open" class="hours_default_thu_open">
...
<span id="el<?= $Page->RowCount ?>_hours_default_thu_close" class="hours_default_thu_close">
...
<span id="el<?= $Page->RowCount ?>_hours_default_fri_open" class="hours_default_fri_open">
...
<span id="el<?= $Page->RowCount ?>_hours_default_fri_close" class="hours_default_fri_close">
...
<span id="el<?= $Page->RowCount ?>_hours_default_sat_open" class="hours_default_sat_open">
...
<span id="el<?= $Page->RowCount ?>_hours_default_sat_close" class="hours_default_sat_close">
...
<span id="el<?= $Page->RowCount ?>_hours_default_sun_open" class="hours_default_sun_open">
...
<span id="el<?= $Page->RowCount ?>_hours_default_sun_close" class="hours_default_sun_close">
...
<span id="el<?= $Page->RowCount ?>_hours_default_close" class="hours_default_close">
