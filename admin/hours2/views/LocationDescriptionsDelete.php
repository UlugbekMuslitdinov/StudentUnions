...
loadjs.ready("head", function () {
    ...
    flocation_descriptionsdelete = currentForm = new ew.Form("flocation_descriptionsdelete", "delete");
...
$Page->showMessage();
?>
<form name="flocation_descriptionsdelete" id="flocation_descriptionsdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<span id="el<?= $Page->RowCount ?>_location_descriptions_location_id" class="location_descriptions_location_id">
