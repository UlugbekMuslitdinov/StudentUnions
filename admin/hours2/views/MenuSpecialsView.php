...
loadjs.ready("head", function () {
    ...
    fmenu_specialsview = currentForm = new ew.Form("fmenu_specialsview", "view");
...
$Page->showMessage();
?>
<form name="fmenu_specialsview" id="fmenu_specialsview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->menu_special_startdate->Visible) { // menu_special_startdate ?>
    <tr id="r_menu_special_startdate">
...
<?php if ($Page->menu_special_replace_item->Visible) { // menu_special_replace_item ?>
    <tr id="r_menu_special_replace_item">
