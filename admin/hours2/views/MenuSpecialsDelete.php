...
loadjs.ready("head", function () {
    ...
    fmenu_specialsdelete = currentForm = new ew.Form("fmenu_specialsdelete", "delete");
...
$Page->showMessage();
?>
<form name="fmenu_specialsdelete" id="fmenu_specialsdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<span id="el<?= $Page->RowCount ?>_menu_specials_id" class="menu_specials_id">
...
<span id="el<?= $Page->RowCount ?>_menu_specials_menu_special_price" class="menu_specials_menu_special_price">
...
<span id="el<?= $Page->RowCount ?>_menu_specials_menu_restaurant" class="menu_specials_menu_restaurant">
...
<span id="el<?= $Page->RowCount ?>_menu_specials_menu_category" class="menu_specials_menu_category">
...
<span id="el<?= $Page->RowCount ?>_menu_specials_menu_special_startdate" class="menu_specials_menu_special_startdate">
...
<span id="el<?= $Page->RowCount ?>_menu_specials_menu_special_enddate" class="menu_specials_menu_special_enddate">
...
<span id="el<?= $Page->RowCount ?>_menu_specials_menu_special_replace_item" class="menu_specials_menu_special_replace_item">
