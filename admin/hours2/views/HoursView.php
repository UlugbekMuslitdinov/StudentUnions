...
loadjs.ready("head", function () {
    ...
    fhoursview = currentForm = new ew.Form("fhoursview", "view");
...
$Page->showMessage();
?>
<form name="fhoursview" id="fhoursview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
