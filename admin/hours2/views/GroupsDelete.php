...
loadjs.ready("head", function () {
    ...
    fgroupsdelete = currentForm = new ew.Form("fgroupsdelete", "delete");
...
$Page->showMessage();
?>
<form name="fgroupsdelete" id="fgroupsdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<span id="el<?= $Page->RowCount ?>_groups_group_id" class="groups_group_id">
...
<span id="el<?= $Page->RowCount ?>_groups_group_name" class="groups_group_name">
...
<span id="el<?= $Page->RowCount ?>_groups_active" class="groups_active">
...
<span id="el<?= $Page->RowCount ?>_groups_group_key" class="groups_group_key">
