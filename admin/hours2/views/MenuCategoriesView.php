...
loadjs.ready("head", function () {
    ...
    fmenu_categoriesview = currentForm = new ew.Form("fmenu_categoriesview", "view");
...
$Page->showMessage();
?>
<form name="fmenu_categoriesview" id="fmenu_categoriesview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
