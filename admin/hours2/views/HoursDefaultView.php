...
loadjs.ready("head", function () {
    ...
    fhours_defaultview = currentForm = new ew.Form("fhours_defaultview", "view");
...
$Page->showMessage();
?>
<form name="fhours_defaultview" id="fhours_defaultview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
