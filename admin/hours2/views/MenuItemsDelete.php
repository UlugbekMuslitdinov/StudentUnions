...
loadjs.ready("head", function () {
    ...
    fmenu_itemsdelete = currentForm = new ew.Form("fmenu_itemsdelete", "delete");
...
$Page->showMessage();
?>
<form name="fmenu_itemsdelete" id="fmenu_itemsdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<span id="el<?= $Page->RowCount ?>_menu_items_id" class="menu_items_id">
...
<span id="el<?= $Page->RowCount ?>_menu_items_menu_restaurant" class="menu_items_menu_restaurant">
...
<span id="el<?= $Page->RowCount ?>_menu_items_menu_category" class="menu_items_menu_category">
...
<span id="el<?= $Page->RowCount ?>_menu_items_meal_details_id" class="menu_items_meal_details_id">
