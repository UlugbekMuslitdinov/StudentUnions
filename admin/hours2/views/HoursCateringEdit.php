...
loadjs.ready("head", function () {
    ...
    fhours_cateringedit = currentForm = new ew.Form("fhours_cateringedit", "edit");
    ...
    // Validate form
    fhours_cateringedit.validate = function () {
    ...
    fhours_cateringedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fhours_cateringedit" id="fhours_cateringedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
