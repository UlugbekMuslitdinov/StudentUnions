...
loadjs.ready("head", function () {
    ...
    flocationdelete = currentForm = new ew.Form("flocationdelete", "delete");
...
$Page->showMessage();
?>
<form name="flocationdelete" id="flocationdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<span id="el<?= $Page->RowCount ?>_location_location_id" class="location_location_id">
...
<span id="el<?= $Page->RowCount ?>_location_group_id" class="location_group_id">
...
<span id="el<?= $Page->RowCount ?>_location_group_hours" class="location_group_hours">
...
<span id="el<?= $Page->RowCount ?>_location_old_id" class="location_old_id">
...
<span id="el<?= $Page->RowCount ?>_location_accept_plus_discount" class="location_accept_plus_discount">
...
<span id="el<?= $Page->RowCount ?>_location_breakfast" class="location_breakfast">
...
<span id="el<?= $Page->RowCount ?>_location_lunch" class="location_lunch">
...
<span id="el<?= $Page->RowCount ?>_location_dinner" class="location_dinner">
...
<span id="el<?= $Page->RowCount ?>_location_continuous" class="location_continuous">
