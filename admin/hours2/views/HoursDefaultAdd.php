...
loadjs.ready("head", function () {
    ...
    fhours_defaultadd = currentForm = new ew.Form("fhours_defaultadd", "add");
    ...
    // Validate form
    fhours_defaultadd.validate = function () {
    ...
    fhours_defaultadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fhours_defaultadd" id="fhours_defaultadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
