...
loadjs.ready("head", function () {
    ...
    flocation_descriptionsedit = currentForm = new ew.Form("flocation_descriptionsedit", "edit");
    ...
    // Set invalid fields
    $(function() {
        var f = flocation_descriptionsedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    flocation_descriptionsedit.validate = function () {
    ...
    flocation_descriptionsedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="flocation_descriptionsedit" id="flocation_descriptionsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
