...
loadjs.ready("head", function () {
    ...
    fhours_cateringdelete = currentForm = new ew.Form("fhours_cateringdelete", "delete");
...
$Page->showMessage();
?>
<form name="fhours_cateringdelete" id="fhours_cateringdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<span id="el<?= $Page->RowCount ?>_hours_catering_id" class="hours_catering_id">
...
<span id="el<?= $Page->RowCount ?>_hours_catering_location_id" class="hours_catering_location_id">
...
<span id="el<?= $Page->RowCount ?>_hours_catering_day_from" class="hours_catering_day_from">
...
<span id="el<?= $Page->RowCount ?>_hours_catering_day_to" class="hours_catering_day_to">
...
<span id="el<?= $Page->RowCount ?>_hours_catering_time_from" class="hours_catering_time_from">
...
<span id="el<?= $Page->RowCount ?>_hours_catering_time_to" class="hours_catering_time_to">
