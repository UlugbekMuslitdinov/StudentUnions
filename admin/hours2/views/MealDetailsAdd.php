...
loadjs.ready("head", function () {
    ...
    fmeal_detailsadd = currentForm = new ew.Form("fmeal_detailsadd", "add");
    ...
    // Validate form
    fmeal_detailsadd.validate = function () {
    ...
    fmeal_detailsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fmeal_detailsadd" id="fmeal_detailsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
