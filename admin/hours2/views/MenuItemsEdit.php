...
loadjs.ready("head", function () {
    ...
    fmenu_itemsedit = currentForm = new ew.Form("fmenu_itemsedit", "edit");
    ...
    // Validate form
    fmenu_itemsedit.validate = function () {
    ...
    fmenu_itemsedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fmenu_itemsedit" id="fmenu_itemsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
