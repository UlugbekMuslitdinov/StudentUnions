...
loadjs.ready("head", function () {
    ...
    fmeal_timesview = currentForm = new ew.Form("fmeal_timesview", "view");
...
$Page->showMessage();
?>
<form name="fmeal_timesview" id="fmeal_timesview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
