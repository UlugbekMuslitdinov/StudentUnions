...
loadjs.ready("head", function () {
    ...
    fmeal_detailsdelete = currentForm = new ew.Form("fmeal_detailsdelete", "delete");
...
$Page->showMessage();
?>
<form name="fmeal_detailsdelete" id="fmeal_detailsdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<span id="el<?= $Page->RowCount ?>_meal_details_id" class="meal_details_id">
...
<span id="el<?= $Page->RowCount ?>_meal_details_meal_name" class="meal_details_meal_name">
