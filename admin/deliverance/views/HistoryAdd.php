...
loadjs.ready("head", function () {
    ...
    fhistoryadd = currentForm = new ew.Form("fhistoryadd", "add");

    // Add fields
    var fields = ew.vars.tables.history.fields;
    fhistoryadd.addFields([
    ...
    // Form_CustomValidate
    fhistoryadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fhistoryadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fhistoryadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fhistoryadd" id="fhistoryadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
