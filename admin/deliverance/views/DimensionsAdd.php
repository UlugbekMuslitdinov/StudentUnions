...
loadjs.ready("head", function () {
    ...
    fdimensionsadd = currentForm = new ew.Form("fdimensionsadd", "add");

    // Add fields
    var fields = ew.vars.tables.dimensions.fields;
    fdimensionsadd.addFields([
    ...
    // Validate form
    fdimensionsadd.validate = function () {
    ...
    // Form_CustomValidate
    fdimensionsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fdimensionsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fdimensionsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fdimensionsadd" id="fdimensionsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
