...
loadjs.ready("head", function () {
    ...
    // Validate form
    fsequentialfeedadd.validate = function () {
    ...
    // Form_CustomValidate
    fsequentialfeedadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fsequentialfeedadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fsequentialfeedadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fsequentialfeedadd" id="fsequentialfeedadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fsequentialfeedadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fsequentialfeedadd", "x_startDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fsequentialfeedadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fsequentialfeedadd", "x_endDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
