 ...
 * Page class
 */
class DimensionsDelete extends Dimensions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DimensionsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DimensionsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("DimensionsList"); // Return to list
                return;
            }
        }
