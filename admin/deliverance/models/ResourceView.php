...
class ResourceView extends Resource
{
    ...
    // Page object name
    public $PageObjName = "ResourceView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ResourceList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ResourceList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "ResourceList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
