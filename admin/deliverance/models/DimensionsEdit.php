 ...
 * Page class
 */
class DimensionsEdit extends Dimensions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DimensionsEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("DimensionsList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "DimensionsList") {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // width
            $this->width->setDbValueDef($rsnew, $this->width->CurrentValue, 0, $this->width->ReadOnly);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("DimensionsList"), "", $this->TableVar, true);
        $pageId = "edit";
