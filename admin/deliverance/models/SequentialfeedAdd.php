 ...
 * Page class
 */
class SequentialfeedAdd extends Sequentialfeed
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SequentialfeedAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "SequentialfeedView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // resourceID
        $this->resourceID->setDbValueDef($rsnew, $this->resourceID->CurrentValue, 0, false);
