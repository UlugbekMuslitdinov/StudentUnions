 ...
 * Page class
 */
class ResourceEdit extends Resource
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ResourceEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // fileSize
            $this->fileSize->setDbValueDef($rsnew, $this->fileSize->CurrentValue, 0, $this->fileSize->ReadOnly);
            ...
            // resourceName
            $this->resourceName->setDbValueDef($rsnew, $this->resourceName->CurrentValue, "", $this->resourceName->ReadOnly);

            // resourceLink
            $this->resourceLink->setDbValueDef($rsnew, $this->resourceLink->CurrentValue, null, $this->resourceLink->ReadOnly);

            // headline
            $this->headline->setDbValueDef($rsnew, $this->headline->CurrentValue, null, $this->headline->ReadOnly);

            // subtext
            $this->subtext->setDbValueDef($rsnew, $this->subtext->CurrentValue, null, $this->subtext->ReadOnly);

            // site
            $this->site->setDbValueDef($rsnew, $this->site->CurrentValue, "", $this->site->ReadOnly);

            // altTxt
            $this->altTxt->setDbValueDef($rsnew, $this->altTxt->CurrentValue, "", $this->altTxt->ReadOnly);

            // description
            $this->description->setDbValueDef($rsnew, $this->description->CurrentValue, null, $this->description->ReadOnly);

            // uploadDate
            $this->uploadDate->setDbValueDef($rsnew, UnFormatDateTime($this->uploadDate->CurrentValue, 0), CurrentDate(), $this->uploadDate->ReadOnly);
