...
/**
 * Table class for dimensions
 */
class Dimensions extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'dimensions';
        $this->TableName = 'dimensions';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`dimensions`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('dimensions', 'dimensions', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // height
        $this->height = new DbField('dimensions', 'dimensions', 'x_height', 'height', '`height`', '`height`', 3, 11, -1, false, '`height`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // width
        $this->width = new DbField('dimensions', 'dimensions', 'x_width', 'width', '`width`', '`width`', 3, 11, -1, false, '`width`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`dimensions`";
    }
    ...
    {
        global $Language;
        if ($pageName == "DimensionsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "DimensionsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DimensionsAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DimensionsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("DimensionsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "DimensionsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "DimensionsAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("DimensionsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DimensionsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("DimensionsDelete", $this->getUrlParm());
    }
