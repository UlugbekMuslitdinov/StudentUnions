 ...
 * Page class
 */
class RandomfeedEdit extends Randomfeed
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'randomfeed';

    // Page object name
    public $PageObjName = "RandomfeedEdit";
    ...
    public function __construct()
    {
        ...
        // Table object (randomfeed)
        if (!isset($GLOBALS["randomfeed"]) || get_class($GLOBALS["randomfeed"]) == PROJECT_NAMESPACE . "randomfeed") {
            $GLOBALS["randomfeed"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'randomfeed');
        }
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("randomfeed"));
                $doc->Text = @$content;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("RandomfeedList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "RandomfeedList") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("RandomfeedList"), "", $this->TableVar, true);
        $pageId = "edit";
