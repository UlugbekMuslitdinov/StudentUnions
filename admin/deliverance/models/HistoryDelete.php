 ...
 * Page class
 */
class HistoryDelete extends History
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HistoryDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("HistoryList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("HistoryList"); // Return to list
                return;
            }
        }
