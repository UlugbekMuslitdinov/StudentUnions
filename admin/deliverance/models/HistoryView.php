...
class HistoryView extends History
{
    ...
    // Page object name
    public $PageObjName = "HistoryView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "HistoryList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "HistoryList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "HistoryList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
