 ...
 * Page class
 */
class ResourceDelete extends Resource
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ResourceDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ResourceList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ResourceList"); // Return to list
                return;
            }
        }
