...
$query = "SELECT * FROM Supervisors ORDER BY first_name, last_name, email LIMIT " . $starting_row . ", " . $rows_per_page;
$result = $db->query($query);
...
<div class="col-12 page_title">Supervisors 
...
<table width="100%" border="1" cellpadding="5">
	<tr id="tablehead">
		...
		<td class="headtitle" align="center"><button><a href="./supervisor_add.php"><b>ADD</b></a></button></td>
	</tr>
<?php   
...
?>
	<tr>
		...
		<td><?=$row['email']?></td>
		<td align="center">
			<a href="./supervisor_view.php?id=<?=$row['id']?>"><button><b>VIEW</b></a></button>
			<!-- <a href="./supervisor_delete.php?id=<?=$row['id']?>"><button class="deleteBTN"><b>DELETE</b></button></a> -->
		</td>
	</tr>
