 ...
 * Page class
 */
class MealpackageView extends Mealpackage
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MealpackageView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "MealpackageList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MealpackageList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "MealpackageList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
