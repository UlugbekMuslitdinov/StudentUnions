 ...
 * Page class
 */
class MealpackageEdit extends Mealpackage
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MealpackageEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // dorm
            $this->dorm->setDbValueDef($rsnew, $this->dorm->CurrentValue, null, $this->dorm->ReadOnly);

            // meal
            $this->meal->setDbValueDef($rsnew, $this->meal->CurrentValue, null, $this->meal->ReadOnly);

            // refrigerator
            $this->refrigerator->setDbValueDef($rsnew, $this->refrigerator->CurrentValue, null, $this->refrigerator->ReadOnly);

            // microwave
            $this->microwave->setDbValueDef($rsnew, $this->microwave->CurrentValue, null, $this->microwave->ReadOnly);
            ...
            $this->water->setDbValueDef($rsnew, $tmpBool, null, $this->water->ReadOnly);

            // requests
            $this->requests->setDbValueDef($rsnew, $this->requests->CurrentValue, null, $this->requests->ReadOnly);

            // room_number
            $this->room_number->setDbValueDef($rsnew, $this->room_number->CurrentValue, null, $this->room_number->ReadOnly);
