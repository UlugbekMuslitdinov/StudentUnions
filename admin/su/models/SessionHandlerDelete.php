 ...
 * Page class
 */
class SessionHandlerDelete extends SessionHandler
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SessionHandlerDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SessionHandlerList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("SessionHandlerList"); // Return to list
                return;
            }
        }
