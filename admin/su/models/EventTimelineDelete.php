 ...
 * Page class
 */
class EventTimelineDelete extends EventTimeline
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EventTimelineDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EventTimelineList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EventTimelineList"); // Return to list
                return;
            }
        }
