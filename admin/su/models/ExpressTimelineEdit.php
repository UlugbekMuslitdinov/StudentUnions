 ...
 * Page class
 */
class ExpressTimelineEdit extends ExpressTimeline
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ExpressTimelineEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // express_id
            $this->express_id->setDbValueDef($rsnew, $this->express_id->CurrentValue, null, $this->express_id->ReadOnly);

            // admin_id
            $this->admin_id->setDbValueDef($rsnew, $this->admin_id->CurrentValue, null, $this->admin_id->ReadOnly);
