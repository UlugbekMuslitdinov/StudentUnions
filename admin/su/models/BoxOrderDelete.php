 ...
 * Page class
 */
class BoxOrderDelete extends BoxOrder
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BoxOrderDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BoxOrderList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("BoxOrderList"); // Return to list
                return;
            }
        }
