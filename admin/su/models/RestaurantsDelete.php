 ...
 * Page class
 */
class RestaurantsDelete extends Restaurants
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RestaurantsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RestaurantsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RestaurantsList"); // Return to list
                return;
            }
        }
