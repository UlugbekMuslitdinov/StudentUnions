 ...
 * Page class
 */
class RotationView extends Rotation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RotationView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "RotationList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "RotationList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "RotationList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
