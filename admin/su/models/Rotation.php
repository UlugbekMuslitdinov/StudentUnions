...
/**
 * Table class for rotation
 */
class Rotation extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'rotation';
        $this->TableName = 'rotation';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`rotation`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('rotation', 'rotation', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // url
        $this->url = new DbField('rotation', 'rotation', 'x_url', 'url', '`url`', '`url`', 201, 65535, -1, false, '`url`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // file_name
        $this->file_name = new DbField('rotation', 'rotation', 'x_file_name', 'file_name', '`file_name`', '`file_name`', 200, 45, -1, false, '`file_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // file_path
        $this->file_path = new DbField('rotation', 'rotation', 'x_file_path', 'file_path', '`file_path`', '`file_path`', 200, 45, -1, false, '`file_path`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->file_path->Sortable = true; // Allow sort
        $this->Fields['file_path'] = &$this->file_path;

        // location
        $this->location = new DbField('rotation', 'rotation', 'x_location', 'location', '`location`', '`location`', 200, 45, -1, false, '`location`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->location->Sortable = true; // Allow sort
        $this->Fields['location'] = &$this->location;

        // active
        $this->active = new DbField('rotation', 'rotation', 'x_active', 'active', '`active`', '`active`', 16, 1, -1, false, '`active`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->active->Sortable = true; // Allow sort
        $this->active->DataType = DATATYPE_BOOLEAN;
        $this->active->Lookup = new Lookup('active', 'rotation', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        $this->active->OptionCount = 2;
        $this->active->DefaultErrorMessage = $Language->phrase("IncorrectField");
        $this->Fields['active'] = &$this->active;

        // timestamp
        $this->timestamp = new DbField('rotation', 'rotation', 'x_timestamp', 'timestamp', '`timestamp`', CastDateFieldForLike("`timestamp`", 0, "DB"), 135, 19, 0, false, '`timestamp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`rotation`";
    }
    ...
    {
        global $Language;
        if ($pageName == "RotationView") {
            return $Language->phrase("View");
        } elseif ($pageName == "RotationEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "RotationAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("RotationView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("RotationView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "RotationAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "RotationAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("RotationEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RotationAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("RotationDelete", $this->getUrlParm());
    }
