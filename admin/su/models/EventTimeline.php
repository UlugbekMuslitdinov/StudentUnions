...
/**
 * Table class for event_timeline
 */
class EventTimeline extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'event_timeline';
        $this->TableName = 'event_timeline';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`event_timeline`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('event_timeline', 'event_timeline', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // event_id
        $this->event_id = new DbField('event_timeline', 'event_timeline', 'x_event_id', 'event_id', '`event_id`', '`event_id`', 3, 11, -1, false, '`event_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // admin_id
        $this->admin_id = new DbField('event_timeline', 'event_timeline', 'x_admin_id', 'admin_id', '`admin_id`', '`admin_id`', 3, 11, -1, false, '`admin_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // action
        $this->_action = new DbField('event_timeline', 'event_timeline', 'x__action', 'action', '`action`', '`action`', 200, 45, -1, false, '`action`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->_action->Sortable = true; // Allow sort
        $this->Fields['action'] = &$this->_action;

        // detail
        $this->detail = new DbField('event_timeline', 'event_timeline', 'x_detail', 'detail', '`detail`', '`detail`', 201, -1, -1, false, '`detail`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->detail->Sortable = true; // Allow sort
        $this->Fields['detail'] = &$this->detail;

        // created_at
        $this->created_at = new DbField('event_timeline', 'event_timeline', 'x_created_at', 'created_at', '`created_at`', CastDateFieldForLike("`created_at`", 0, "DB"), 135, 19, 0, false, '`created_at`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->created_at->Sortable = true; // Allow sort
        $this->created_at->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->Fields['created_at'] = &$this->created_at;

        // updated_at
        $this->updated_at = new DbField('event_timeline', 'event_timeline', 'x_updated_at', 'updated_at', '`updated_at`', CastDateFieldForLike("`updated_at`", 0, "DB"), 135, 19, 0, false, '`updated_at`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`event_timeline`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("EventTimelineList");
        }
    }
    ...
    {
        global $Language;
        if ($pageName == "EventTimelineView") {
            return $Language->phrase("View");
        } elseif ($pageName == "EventTimelineEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "EventTimelineAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "EventTimelineAdd";
            case Config("API_EDIT_ACTION"):
                return "EventTimelineEdit";
            case Config("API_DELETE_ACTION"):
                return "EventTimelineDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EventTimelineView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("EventTimelineView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "EventTimelineAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "EventTimelineAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EventTimelineEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EventTimelineAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("EventTimelineDelete", $this->getUrlParm());
    }
