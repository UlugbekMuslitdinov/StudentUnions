 ...
 * Page class
 */
class BoxMenuView extends BoxMenu
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BoxMenuView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "BoxMenuList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "BoxMenuList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "BoxMenuList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
