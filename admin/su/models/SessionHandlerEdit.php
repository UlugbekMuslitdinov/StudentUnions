 ...
 * Page class
 */
class SessionHandlerEdit extends SessionHandler
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SessionHandlerEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // custnum
            $this->custnum->setDbValueDef($rsnew, $this->custnum->CurrentValue, null, $this->custnum->ReadOnly);

            // cust_id
            $this->cust_id->setDbValueDef($rsnew, $this->cust_id->CurrentValue, null, $this->cust_id->ReadOnly);
            ...
            // mp_state
            $this->mp_state->setDbValueDef($rsnew, $this->mp_state->CurrentValue, null, $this->mp_state->ReadOnly);
            ...
            $this->deposit_to->setDbValueDef($rsnew, $tmpBool, null, $this->deposit_to->ReadOnly);

            // iso
            $this->iso->setDbValueDef($rsnew, $this->iso->CurrentValue, null, $this->iso->ReadOnly);

            // activestudent
            $this->activestudent->setDbValueDef($rsnew, $this->activestudent->CurrentValue, null, $this->activestudent->ReadOnly);

            // activeemployee
            $this->activeemployee->setDbValueDef($rsnew, $this->activeemployee->CurrentValue, null, $this->activeemployee->ReadOnly);
