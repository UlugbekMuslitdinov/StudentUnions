...
class FeedbackView extends Feedback
{
    ...
    // Page object name
    public $PageObjName = "FeedbackView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "FeedbackList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "FeedbackList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "FeedbackList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
