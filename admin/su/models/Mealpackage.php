...
/**
 * Table class for mealpackage
 */
class Mealpackage extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'mealpackage';
        $this->TableName = 'mealpackage';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`mealpackage`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('mealpackage', 'mealpackage', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // netid
        $this->netid = new DbField('mealpackage', 'mealpackage', 'x_netid', 'netid', '`netid`', '`netid`', 200, 45, -1, false, '`netid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->netid->Sortable = true; // Allow sort
        $this->Fields['netid'] = &$this->netid;

        // sid
        $this->sid = new DbField('mealpackage', 'mealpackage', 'x_sid', 'sid', '`sid`', '`sid`', 200, 45, -1, false, '`sid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->sid->Sortable = true; // Allow sort
        $this->Fields['sid'] = &$this->sid;

        // email
        $this->_email = new DbField('mealpackage', 'mealpackage', 'x__email', 'email', '`email`', '`email`', 200, 45, -1, false, '`email`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->_email->Sortable = true; // Allow sort
        $this->Fields['email'] = &$this->_email;

        // firstname
        $this->firstname = new DbField('mealpackage', 'mealpackage', 'x_firstname', 'firstname', '`firstname`', '`firstname`', 200, 45, -1, false, '`firstname`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->firstname->Sortable = true; // Allow sort
        $this->Fields['firstname'] = &$this->firstname;

        // lastname
        $this->lastname = new DbField('mealpackage', 'mealpackage', 'x_lastname', 'lastname', '`lastname`', '`lastname`', 200, 45, -1, false, '`lastname`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->lastname->Sortable = true; // Allow sort
        $this->Fields['lastname'] = &$this->lastname;

        // phone
        $this->phone = new DbField('mealpackage', 'mealpackage', 'x_phone', 'phone', '`phone`', '`phone`', 200, 45, -1, false, '`phone`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->phone->Sortable = true; // Allow sort
        $this->Fields['phone'] = &$this->phone;

        // dorm
        $this->dorm = new DbField('mealpackage', 'mealpackage', 'x_dorm', 'dorm', '`dorm`', '`dorm`', 200, 45, -1, false, '`dorm`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->dorm->Sortable = true; // Allow sort
        $this->Fields['dorm'] = &$this->dorm;

        // meal
        $this->meal = new DbField('mealpackage', 'mealpackage', 'x_meal', 'meal', '`meal`', '`meal`', 200, 45, -1, false, '`meal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->meal->Sortable = true; // Allow sort
        $this->Fields['meal'] = &$this->meal;

        // refrigerator
        $this->refrigerator = new DbField('mealpackage', 'mealpackage', 'x_refrigerator', 'refrigerator', '`refrigerator`', '`refrigerator`', 200, 45, -1, false, '`refrigerator`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->refrigerator->Sortable = true; // Allow sort
        $this->Fields['refrigerator'] = &$this->refrigerator;

        // microwave
        $this->microwave = new DbField('mealpackage', 'mealpackage', 'x_microwave', 'microwave', '`microwave`', '`microwave`', 200, 45, -1, false, '`microwave`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->microwave->Sortable = true; // Allow sort
        $this->Fields['microwave'] = &$this->microwave;

        // water
        $this->water = new DbField('mealpackage', 'mealpackage', 'x_water', 'water', '`water`', '`water`', 16, 1, -1, false, '`water`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->water->Sortable = true; // Allow sort
        $this->water->DataType = DATATYPE_BOOLEAN;
        $this->water->Lookup = new Lookup('water', 'mealpackage', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        $this->water->OptionCount = 2;
        $this->water->DefaultErrorMessage = $Language->phrase("IncorrectField");
        $this->Fields['water'] = &$this->water;

        // requests
        $this->requests = new DbField('mealpackage', 'mealpackage', 'x_requests', 'requests', '`requests`', '`requests`', 201, 4000, -1, false, '`requests`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->requests->Sortable = true; // Allow sort
        $this->Fields['requests'] = &$this->requests;

        // room_number
        $this->room_number = new DbField('mealpackage', 'mealpackage', 'x_room_number', 'room_number', '`room_number`', '`room_number`', 200, 45, -1, false, '`room_number`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->room_number->Sortable = true; // Allow sort
        $this->Fields['room_number'] = &$this->room_number;

        // amount
        $this->amount = new DbField('mealpackage', 'mealpackage', 'x_amount', 'amount', '`amount`', '`amount`', 16, 2, -1, false, '`amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->amount->Sortable = true; // Allow sort
        $this->amount->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['amount'] = &$this->amount;

        // payment
        $this->payment = new DbField('mealpackage', 'mealpackage', 'x_payment', 'payment', '`payment`', '`payment`', 200, 45, -1, false, '`payment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->payment->Sortable = true; // Allow sort
        $this->Fields['payment'] = &$this->payment;

        // status
        $this->status = new DbField('mealpackage', 'mealpackage', 'x_status', 'status', '`status`', '`status`', 200, 45, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->status->Sortable = true; // Allow sort
        $this->Fields['status'] = &$this->status;

        // timestamp
        $this->timestamp = new DbField('mealpackage', 'mealpackage', 'x_timestamp', 'timestamp', '`timestamp`', CastDateFieldForLike("`timestamp`", 0, "DB"), 135, 19, 0, false, '`timestamp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // type
        $this->type = new DbField('mealpackage', 'mealpackage', 'x_type', 'type', '`type`', '`type`', 200, 45, -1, false, '`type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`mealpackage`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->dorm->DbValue = $row['dorm'];
        $this->meal->DbValue = $row['meal'];
        $this->refrigerator->DbValue = $row['refrigerator'];
        $this->microwave->DbValue = $row['microwave'];
        $this->water->DbValue = $row['water'];
        $this->requests->DbValue = $row['requests'];
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "MealpackageEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "MealpackageAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MealpackageView";
            case Config("API_ADD_ACTION"):
                return "MealpackageAdd";
            case Config("API_EDIT_ACTION"):
                return "MealpackageEdit";
            case Config("API_DELETE_ACTION"):
                return "MealpackageDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MealpackageView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("MealpackageView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "MealpackageAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "MealpackageAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("MealpackageEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MealpackageAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("MealpackageDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->dorm->EditValue = $this->dorm->CurrentValue;
        ...
        $this->meal->EditValue = $this->meal->CurrentValue;
        ...
        $this->refrigerator->EditValue = $this->refrigerator->CurrentValue;
        ...
        $this->microwave->EditValue = $this->microwave->CurrentValue;
        ...
        $this->requests->EditValue = $this->requests->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->dorm);
                    $doc->exportCaption($this->meal);
                    $doc->exportCaption($this->refrigerator);
                    $doc->exportCaption($this->microwave);
                    $doc->exportCaption($this->water);
                    $doc->exportCaption($this->requests);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->dorm);
                        $doc->exportField($this->meal);
                        $doc->exportField($this->refrigerator);
                        $doc->exportField($this->microwave);
                        $doc->exportField($this->water);
                        $doc->exportField($this->requests);
