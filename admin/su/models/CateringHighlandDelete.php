 ...
 * Page class
 */
class CateringHighlandDelete extends CateringHighland
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CateringHighlandDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CateringHighlandList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CateringHighlandList"); // Return to list
                return;
            }
        }
