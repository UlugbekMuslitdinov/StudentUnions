 ...
 * Page class
 */
class CateringHighlandList extends CateringHighland
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CateringHighlandList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fcatering_highlandlist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "CateringHighlandAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "CateringHighlandDelete";
        $this->MultiUpdateUrl = "CateringHighlandUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fcatering_highlandlistsrch";
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->burrito_12); // burrito_12
            $this->updateSort($this->burrito_8); // burrito_8
            $this->updateSort($this->extra_chips); // extra_chips
            $this->updateSort($this->extra_salsa); // extra_salsa
            $this->updateSort($this->extra_sourcream); // extra_sourcream
            $this->updateSort($this->extra_guacamole); // extra_guacamole
            $this->updateSort($this->upgrade); // upgrade
            $this->updateSort($this->coke); // coke
            $this->updateSort($this->diet_coke); // diet_coke
            $this->updateSort($this->sprite); // sprite
            $this->updateSort($this->fanta); // fanta
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->burrito_12->setSort("");
                $this->burrito_8->setSort("");
                $this->extra_chips->setSort("");
                $this->extra_salsa->setSort("");
                $this->extra_sourcream->setSort("");
                $this->extra_guacamole->setSort("");
                $this->upgrade->setSort("");
                $this->coke->setSort("");
                $this->diet_coke->setSort("");
                $this->sprite->setSort("");
                $this->fanta->setSort("");
                $this->water->setSort("");
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fcatering_highlandlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fcatering_highlandlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fcatering_highlandlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
