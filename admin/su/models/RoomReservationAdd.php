 ...
 * Page class
 */
class RoomReservationAdd extends RoomReservation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RoomReservationAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "RoomReservationView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->contact_org->CurrentValue = null;
        $this->contact_org->OldValue = $this->contact_org->CurrentValue;
        ...
        $this->contact_city->CurrentValue = null;
        $this->contact_city->OldValue = $this->contact_city->CurrentValue;
        $this->contact_state->CurrentValue = null;
        $this->contact_state->OldValue = $this->contact_state->CurrentValue;
        $this->contact_zip->CurrentValue = null;
        $this->contact_zip->OldValue = $this->contact_zip->CurrentValue;
        $this->contact_advisor->CurrentValue = null;
        $this->contact_advisor->OldValue = $this->contact_advisor->CurrentValue;
        $this->contact_advisor_phone->CurrentValue = null;
        $this->contact_advisor_phone->OldValue = $this->contact_advisor_phone->CurrentValue;
        $this->contact_advisor_email->CurrentValue = null;
        $this->contact_advisor_email->OldValue = $this->contact_advisor_email->CurrentValue;
        $this->billing_org->CurrentValue = null;
        $this->billing_org->OldValue = $this->billing_org->CurrentValue;
        ...
        $this->billing_phone->CurrentValue = null;
        $this->billing_phone->OldValue = $this->billing_phone->CurrentValue;
        $this->billing_fax->CurrentValue = null;
        $this->billing_fax->OldValue = $this->billing_fax->CurrentValue;
        ...
        $this->billing_method->CurrentValue = null;
        $this->billing_method->OldValue = $this->billing_method->CurrentValue;
        $this->billing_frs->CurrentValue = null;
        $this->billing_frs->OldValue = $this->billing_frs->CurrentValue;
        $this->event_title->CurrentValue = null;
        $this->event_title->OldValue = $this->event_title->CurrentValue;
        $this->event_type->CurrentValue = null;
        $this->event_type->OldValue = $this->event_type->CurrentValue;
        $this->event_date->CurrentValue = null;
        $this->event_date->OldValue = $this->event_date->CurrentValue;
        $this->event_time_start->CurrentValue = null;
        $this->event_time_start->OldValue = $this->event_time_start->CurrentValue;
        $this->event_time_end->CurrentValue = null;
        $this->event_time_end->OldValue = $this->event_time_end->CurrentValue;
        $this->event_num_people->CurrentValue = null;
        $this->event_num_people->OldValue = $this->event_num_people->CurrentValue;
        $this->event_room_preference->CurrentValue = null;
        $this->event_room_preference->OldValue = $this->event_room_preference->CurrentValue;
        $this->recurring_jan->CurrentValue = null;
        $this->recurring_jan->OldValue = $this->recurring_jan->CurrentValue;
        $this->recurring_feb->CurrentValue = null;
        $this->recurring_feb->OldValue = $this->recurring_feb->CurrentValue;
        $this->recurring_mar->CurrentValue = null;
        $this->recurring_mar->OldValue = $this->recurring_mar->CurrentValue;
        $this->recurring_apr->CurrentValue = null;
        $this->recurring_apr->OldValue = $this->recurring_apr->CurrentValue;
        $this->recurring_may->CurrentValue = null;
        $this->recurring_may->OldValue = $this->recurring_may->CurrentValue;
        $this->recurring_jun->CurrentValue = null;
        $this->recurring_jun->OldValue = $this->recurring_jun->CurrentValue;
        $this->recurring_jul->CurrentValue = null;
        $this->recurring_jul->OldValue = $this->recurring_jul->CurrentValue;
        $this->recurring_aug->CurrentValue = null;
        $this->recurring_aug->OldValue = $this->recurring_aug->CurrentValue;
        $this->recurring_sep->CurrentValue = null;
        $this->recurring_sep->OldValue = $this->recurring_sep->CurrentValue;
        $this->recurring_oct->CurrentValue = null;
        $this->recurring_oct->OldValue = $this->recurring_oct->CurrentValue;
        $this->recurring_nov->CurrentValue = null;
        $this->recurring_nov->OldValue = $this->recurring_nov->CurrentValue;
        $this->recurring_dec->CurrentValue = null;
        $this->recurring_dec->OldValue = $this->recurring_dec->CurrentValue;
        $this->setup_shape->CurrentValue = null;
        $this->setup_shape->OldValue = $this->setup_shape->CurrentValue;
        $this->certification_name->CurrentValue = null;
        $this->certification_name->OldValue = $this->certification_name->CurrentValue;
        $this->certification_date->CurrentValue = null;
        $this->certification_date->OldValue = $this->certification_date->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['contact_org'] = $this->contact_org->CurrentValue;
        ...
        $row['contact_fax'] = $this->contact_fax->CurrentValue;
        $row['contact_address'] = $this->contact_address->CurrentValue;
        $row['contact_city'] = $this->contact_city->CurrentValue;
        $row['contact_state'] = $this->contact_state->CurrentValue;
        $row['contact_zip'] = $this->contact_zip->CurrentValue;
        $row['contact_advisor'] = $this->contact_advisor->CurrentValue;
        $row['contact_advisor_phone'] = $this->contact_advisor_phone->CurrentValue;
        $row['contact_advisor_email'] = $this->contact_advisor_email->CurrentValue;
        $row['billing_org'] = $this->billing_org->CurrentValue;
        $row['billing_name'] = $this->billing_name->CurrentValue;
        $row['billing_email'] = $this->billing_email->CurrentValue;
        $row['billing_phone'] = $this->billing_phone->CurrentValue;
        $row['billing_fax'] = $this->billing_fax->CurrentValue;
        ...
        $row['billing_method'] = $this->billing_method->CurrentValue;
        $row['billing_frs'] = $this->billing_frs->CurrentValue;
        $row['event_title'] = $this->event_title->CurrentValue;
        $row['event_type'] = $this->event_type->CurrentValue;
        $row['event_date'] = $this->event_date->CurrentValue;
        $row['event_time_start'] = $this->event_time_start->CurrentValue;
        $row['event_time_end'] = $this->event_time_end->CurrentValue;
        $row['event_num_people'] = $this->event_num_people->CurrentValue;
        $row['event_room_preference'] = $this->event_room_preference->CurrentValue;
        $row['recurring_jan'] = $this->recurring_jan->CurrentValue;
        $row['recurring_feb'] = $this->recurring_feb->CurrentValue;
        $row['recurring_mar'] = $this->recurring_mar->CurrentValue;
        $row['recurring_apr'] = $this->recurring_apr->CurrentValue;
        $row['recurring_may'] = $this->recurring_may->CurrentValue;
        $row['recurring_jun'] = $this->recurring_jun->CurrentValue;
        $row['recurring_jul'] = $this->recurring_jul->CurrentValue;
        $row['recurring_aug'] = $this->recurring_aug->CurrentValue;
        $row['recurring_sep'] = $this->recurring_sep->CurrentValue;
        $row['recurring_oct'] = $this->recurring_oct->CurrentValue;
        $row['recurring_nov'] = $this->recurring_nov->CurrentValue;
        $row['recurring_dec'] = $this->recurring_dec->CurrentValue;
        $row['setup_shape'] = $this->setup_shape->CurrentValue;
        $row['certification_name'] = $this->certification_name->CurrentValue;
        $row['certification_date'] = $this->certification_date->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // contact_org
        $this->contact_org->setDbValueDef($rsnew, $this->contact_org->CurrentValue, null, false);
        ...
        // contact_city
        $this->contact_city->setDbValueDef($rsnew, $this->contact_city->CurrentValue, null, false);

        // contact_state
        $this->contact_state->setDbValueDef($rsnew, $this->contact_state->CurrentValue, null, false);

        // contact_zip
        $this->contact_zip->setDbValueDef($rsnew, $this->contact_zip->CurrentValue, null, false);

        // contact_advisor
        $this->contact_advisor->setDbValueDef($rsnew, $this->contact_advisor->CurrentValue, null, false);

        // contact_advisor_phone
        $this->contact_advisor_phone->setDbValueDef($rsnew, $this->contact_advisor_phone->CurrentValue, null, false);

        // contact_advisor_email
        $this->contact_advisor_email->setDbValueDef($rsnew, $this->contact_advisor_email->CurrentValue, null, false);

        // billing_org
        $this->billing_org->setDbValueDef($rsnew, $this->billing_org->CurrentValue, null, false);

        // billing_name
        $this->billing_name->setDbValueDef($rsnew, $this->billing_name->CurrentValue, "", false);

        // billing_email
        $this->billing_email->setDbValueDef($rsnew, $this->billing_email->CurrentValue, "", false);

        // billing_phone
        $this->billing_phone->setDbValueDef($rsnew, $this->billing_phone->CurrentValue, "", false);

        // billing_fax
        $this->billing_fax->setDbValueDef($rsnew, $this->billing_fax->CurrentValue, null, false);
        ...
        // billing_method
        $this->billing_method->setDbValueDef($rsnew, $this->billing_method->CurrentValue, "", false);

        // billing_frs
        $this->billing_frs->setDbValueDef($rsnew, $this->billing_frs->CurrentValue, null, false);

        // event_title
        $this->event_title->setDbValueDef($rsnew, $this->event_title->CurrentValue, null, false);

        // event_type
        $this->event_type->setDbValueDef($rsnew, $this->event_type->CurrentValue, null, false);

        // event_date
        $this->event_date->setDbValueDef($rsnew, UnFormatDateTime($this->event_date->CurrentValue, 0), CurrentDate(), false);

        // event_time_start
        $this->event_time_start->setDbValueDef($rsnew, $this->event_time_start->CurrentValue, "", false);

        // event_time_end
        $this->event_time_end->setDbValueDef($rsnew, $this->event_time_end->CurrentValue, "", false);

        // event_num_people
        $this->event_num_people->setDbValueDef($rsnew, $this->event_num_people->CurrentValue, 0, false);

        // event_room_preference
        $this->event_room_preference->setDbValueDef($rsnew, $this->event_room_preference->CurrentValue, null, false);

        // recurring_jan
        $this->recurring_jan->setDbValueDef($rsnew, $this->recurring_jan->CurrentValue, null, false);

        // recurring_feb
        $this->recurring_feb->setDbValueDef($rsnew, $this->recurring_feb->CurrentValue, null, false);

        // recurring_mar
        $this->recurring_mar->setDbValueDef($rsnew, $this->recurring_mar->CurrentValue, null, false);

        // recurring_apr
        $this->recurring_apr->setDbValueDef($rsnew, $this->recurring_apr->CurrentValue, null, false);

        // recurring_may
        $this->recurring_may->setDbValueDef($rsnew, $this->recurring_may->CurrentValue, null, false);

        // recurring_jun
        $this->recurring_jun->setDbValueDef($rsnew, $this->recurring_jun->CurrentValue, null, false);

        // recurring_jul
        $this->recurring_jul->setDbValueDef($rsnew, $this->recurring_jul->CurrentValue, null, false);

        // recurring_aug
        $this->recurring_aug->setDbValueDef($rsnew, $this->recurring_aug->CurrentValue, null, false);

        // recurring_sep
        $this->recurring_sep->setDbValueDef($rsnew, $this->recurring_sep->CurrentValue, null, false);

        // recurring_oct
        $this->recurring_oct->setDbValueDef($rsnew, $this->recurring_oct->CurrentValue, null, false);

        // recurring_nov
        $this->recurring_nov->setDbValueDef($rsnew, $this->recurring_nov->CurrentValue, null, false);

        // recurring_dec
        $this->recurring_dec->setDbValueDef($rsnew, $this->recurring_dec->CurrentValue, null, false);

        // setup_shape
        $this->setup_shape->setDbValueDef($rsnew, $this->setup_shape->CurrentValue, null, false);

        // certification_name
        $this->certification_name->setDbValueDef($rsnew, $this->certification_name->CurrentValue, "", false);

        // certification_date
        $this->certification_date->setDbValueDef($rsnew, UnFormatDateTime($this->certification_date->CurrentValue, 0), CurrentDate(), false);
