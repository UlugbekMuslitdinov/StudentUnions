 ...
 * Page class
 */
class RotationEdit extends Rotation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RotationEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // file_path
            $this->file_path->setDbValueDef($rsnew, $this->file_path->CurrentValue, null, $this->file_path->ReadOnly);
