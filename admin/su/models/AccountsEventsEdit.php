 ...
 * Page class
 */
class AccountsEventsEdit extends AccountsEvents
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AccountsEventsEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("AccountsEventsList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "AccountsEventsList") {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // account_id
            $this->account_id->setDbValueDef($rsnew, $this->account_id->CurrentValue, 0, $this->account_id->ReadOnly);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("AccountsEventsList"), "", $this->TableVar, true);
        $pageId = "edit";
