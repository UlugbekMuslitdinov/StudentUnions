 ...
 * Page class
 */
class CateringHighlandBurritoDelete extends CateringHighlandBurrito
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CateringHighlandBurritoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CateringHighlandBurritoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CateringHighlandBurritoList"); // Return to list
                return;
            }
        }
