 ...
 * Page class
 */
class MealpackageDelete extends Mealpackage
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MealpackageDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MealpackageList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MealpackageList"); // Return to list
                return;
            }
        }
