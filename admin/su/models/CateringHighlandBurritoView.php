 ...
 * Page class
 */
class CateringHighlandBurritoView extends CateringHighlandBurrito
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CateringHighlandBurritoView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "CateringHighlandBurritoList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "CateringHighlandBurritoList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "CateringHighlandBurritoList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
