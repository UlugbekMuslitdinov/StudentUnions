 ...
 * Page class
 */
class AdminRoutesView extends AdminRoutes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AdminRoutesView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "AdminRoutesList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AdminRoutesList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "AdminRoutesList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
