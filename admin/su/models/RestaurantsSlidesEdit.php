 ...
 * Page class
 */
class RestaurantsSlidesEdit extends RestaurantsSlides
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RestaurantsSlidesEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // restaurant_id
            $this->restaurant_id->setDbValueDef($rsnew, $this->restaurant_id->CurrentValue, 0, $this->restaurant_id->ReadOnly);
