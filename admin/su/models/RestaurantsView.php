 ...
 * Page class
 */
class RestaurantsView extends Restaurants
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RestaurantsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "RestaurantsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "RestaurantsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "RestaurantsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
