...
class Accounts extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('accounts', 'accounts', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // name
        $this->name = new DbField('accounts', 'accounts', 'x_name', 'name', '`name`', '`name`', 200, 45, -1, false, '`name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->name->Sortable = true; // Allow sort
        $this->Fields['name'] = &$this->name;

        // email
        $this->_email = new DbField('accounts', 'accounts', 'x__email', 'email', '`email`', '`email`', 200, 45, -1, false, '`email`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // department
        $this->department = new DbField('accounts', 'accounts', 'x_department', 'department', '`department`', '`department`', 200, 255, -1, false, '`department`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "AccountsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "AccountsAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AccountsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("AccountsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "AccountsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "AccountsAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("AccountsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AccountsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("AccountsDelete", $this->getUrlParm());
    }
