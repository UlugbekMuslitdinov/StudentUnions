 ...
 * Page class
 */
class FeedbackEdit extends Feedback
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FeedbackEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // time
            $this->time->setDbValueDef($rsnew, UnFormatDateTime($this->time->CurrentValue, 0), null, $this->time->ReadOnly);
