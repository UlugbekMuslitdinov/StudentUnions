...
/**
 * Table class for accounts_events
 */
class AccountsEvents extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'accounts_events';
        $this->TableName = 'accounts_events';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`accounts_events`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('accounts_events', 'accounts_events', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // account_id
        $this->account_id = new DbField('accounts_events', 'accounts_events', 'x_account_id', 'account_id', '`account_id`', '`account_id`', 3, 11, -1, false, '`account_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // event_id
        $this->event_id = new DbField('accounts_events', 'accounts_events', 'x_event_id', 'event_id', '`event_id`', '`event_id`', 3, 11, -1, false, '`event_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`accounts_events`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("AccountsEventsList");
        }
    }
    ...
    {
        global $Language;
        if ($pageName == "AccountsEventsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "AccountsEventsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "AccountsEventsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "AccountsEventsView";
            case Config("API_ADD_ACTION"):
                return "AccountsEventsAdd";
            case Config("API_EDIT_ACTION"):
                return "AccountsEventsEdit";
            case Config("API_DELETE_ACTION"):
                return "AccountsEventsDelete";
            case Config("API_LIST_ACTION"):
                return "AccountsEventsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AccountsEventsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("AccountsEventsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "AccountsEventsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "AccountsEventsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AccountsEventsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AccountsEventsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("AccountsEventsDelete", $this->getUrlParm());
    }
