 ...
 * Page class
 */
class CateringAdd extends Catering
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CateringAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "CateringView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->delivery_time->CurrentValue = null;
        $this->delivery_time->OldValue = $this->delivery_time->CurrentValue;
        $this->delivery_building->CurrentValue = null;
        $this->delivery_building->OldValue = $this->delivery_building->CurrentValue;
        $this->delivery_room->CurrentValue = null;
        $this->delivery_room->OldValue = $this->delivery_room->CurrentValue;
        $this->delivery_notes->CurrentValue = null;
        $this->delivery_notes->OldValue = $this->delivery_notes->CurrentValue;
        $this->onsite_name->CurrentValue = null;
        $this->onsite_name->OldValue = $this->onsite_name->CurrentValue;
        $this->onsite_email->CurrentValue = null;
        $this->onsite_email->OldValue = $this->onsite_email->CurrentValue;
        $this->onsite_phone->CurrentValue = null;
        $this->onsite_phone->OldValue = $this->onsite_phone->CurrentValue;
        ...
        $this->account_num->CurrentValue = null;
        $this->account_num->OldValue = $this->account_num->CurrentValue;
        $this->sub_code->CurrentValue = null;
        $this->sub_code->OldValue = $this->sub_code->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['delivery_time'] = $this->delivery_time->CurrentValue;
        $row['delivery_building'] = $this->delivery_building->CurrentValue;
        $row['delivery_room'] = $this->delivery_room->CurrentValue;
        $row['delivery_notes'] = $this->delivery_notes->CurrentValue;
        $row['onsite_name'] = $this->onsite_name->CurrentValue;
        $row['onsite_email'] = $this->onsite_email->CurrentValue;
        $row['onsite_phone'] = $this->onsite_phone->CurrentValue;
        $row['customer_name'] = $this->customer_name->CurrentValue;
        $row['customer_phone'] = $this->customer_phone->CurrentValue;
        $row['customer_email'] = $this->customer_email->CurrentValue;
        $row['payment_method'] = $this->payment_method->CurrentValue;
        $row['account_num'] = $this->account_num->CurrentValue;
        $row['sub_code'] = $this->sub_code->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // delivery_time
        $this->delivery_time->setDbValueDef($rsnew, $this->delivery_time->CurrentValue, null, false);

        // delivery_building
        $this->delivery_building->setDbValueDef($rsnew, $this->delivery_building->CurrentValue, null, false);

        // delivery_room
        $this->delivery_room->setDbValueDef($rsnew, $this->delivery_room->CurrentValue, null, false);

        // delivery_notes
        $this->delivery_notes->setDbValueDef($rsnew, $this->delivery_notes->CurrentValue, null, false);

        // onsite_name
        $this->onsite_name->setDbValueDef($rsnew, $this->onsite_name->CurrentValue, null, false);

        // onsite_email
        $this->onsite_email->setDbValueDef($rsnew, $this->onsite_email->CurrentValue, null, false);

        // onsite_phone
        $this->onsite_phone->setDbValueDef($rsnew, $this->onsite_phone->CurrentValue, null, false);

        // customer_name
        $this->customer_name->setDbValueDef($rsnew, $this->customer_name->CurrentValue, null, false);

        // customer_phone
        $this->customer_phone->setDbValueDef($rsnew, $this->customer_phone->CurrentValue, null, false);

        // customer_email
        $this->customer_email->setDbValueDef($rsnew, $this->customer_email->CurrentValue, null, false);

        // payment_method
        $this->payment_method->setDbValueDef($rsnew, $this->payment_method->CurrentValue, null, false);

        // account_num
        $this->account_num->setDbValueDef($rsnew, $this->account_num->CurrentValue, null, false);

        // sub_code
        $this->sub_code->setDbValueDef($rsnew, $this->sub_code->CurrentValue, null, false);
