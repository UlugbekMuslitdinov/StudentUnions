 ...
 * Page class
 */
class AdminRoutesDelete extends AdminRoutes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AdminRoutesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AdminRoutesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AdminRoutesList"); // Return to list
                return;
            }
        }
