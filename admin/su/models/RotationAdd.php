 ...
 * Page class
 */
class RotationAdd extends Rotation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RotationAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("RotationList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "RotationList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "RotationView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // file_path
        $this->file_path->setDbValueDef($rsnew, $this->file_path->CurrentValue, null, false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("RotationList"), "", $this->TableVar, true);
