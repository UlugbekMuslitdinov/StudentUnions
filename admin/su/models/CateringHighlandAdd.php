 ...
 * Page class
 */
class CateringHighlandAdd extends CateringHighland
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CateringHighlandAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "CateringHighlandView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->burrito_12->CurrentValue = 0;
        $this->burrito_8->CurrentValue = 0;
        $this->extra_chips->CurrentValue = 0;
        $this->extra_salsa->CurrentValue = 0;
        $this->extra_sourcream->CurrentValue = 0;
        $this->extra_guacamole->CurrentValue = 0;
        $this->upgrade->CurrentValue = 0;
        $this->coke->CurrentValue = 0;
        $this->diet_coke->CurrentValue = 0;
        $this->sprite->CurrentValue = 0;
        $this->fanta->CurrentValue = 0;
        $this->water->CurrentValue = 0;
    }
    ...
    protected function newRow()
    {
        ...
        $row['burrito_12'] = $this->burrito_12->CurrentValue;
        $row['burrito_8'] = $this->burrito_8->CurrentValue;
        $row['extra_chips'] = $this->extra_chips->CurrentValue;
        $row['extra_salsa'] = $this->extra_salsa->CurrentValue;
        $row['extra_sourcream'] = $this->extra_sourcream->CurrentValue;
        $row['extra_guacamole'] = $this->extra_guacamole->CurrentValue;
        $row['upgrade'] = $this->upgrade->CurrentValue;
        $row['coke'] = $this->coke->CurrentValue;
        $row['diet_coke'] = $this->diet_coke->CurrentValue;
        $row['sprite'] = $this->sprite->CurrentValue;
        $row['fanta'] = $this->fanta->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // burrito_12
        $this->burrito_12->setDbValueDef($rsnew, $this->burrito_12->CurrentValue, null, strval($this->burrito_12->CurrentValue) == "");

        // burrito_8
        $this->burrito_8->setDbValueDef($rsnew, $this->burrito_8->CurrentValue, null, strval($this->burrito_8->CurrentValue) == "");

        // extra_chips
        $this->extra_chips->setDbValueDef($rsnew, $this->extra_chips->CurrentValue, null, strval($this->extra_chips->CurrentValue) == "");

        // extra_salsa
        $this->extra_salsa->setDbValueDef($rsnew, $this->extra_salsa->CurrentValue, null, strval($this->extra_salsa->CurrentValue) == "");

        // extra_sourcream
        $this->extra_sourcream->setDbValueDef($rsnew, $this->extra_sourcream->CurrentValue, null, strval($this->extra_sourcream->CurrentValue) == "");

        // extra_guacamole
        $this->extra_guacamole->setDbValueDef($rsnew, $this->extra_guacamole->CurrentValue, null, strval($this->extra_guacamole->CurrentValue) == "");

        // upgrade
        $this->upgrade->setDbValueDef($rsnew, $this->upgrade->CurrentValue, null, strval($this->upgrade->CurrentValue) == "");

        // coke
        $this->coke->setDbValueDef($rsnew, $this->coke->CurrentValue, null, strval($this->coke->CurrentValue) == "");

        // diet_coke
        $this->diet_coke->setDbValueDef($rsnew, $this->diet_coke->CurrentValue, null, strval($this->diet_coke->CurrentValue) == "");

        // sprite
        $this->sprite->setDbValueDef($rsnew, $this->sprite->CurrentValue, null, strval($this->sprite->CurrentValue) == "");

        // fanta
        $this->fanta->setDbValueDef($rsnew, $this->fanta->CurrentValue, null, strval($this->fanta->CurrentValue) == "");

        // water
        $this->water->setDbValueDef($rsnew, $this->water->CurrentValue, null, strval($this->water->CurrentValue) == "");
