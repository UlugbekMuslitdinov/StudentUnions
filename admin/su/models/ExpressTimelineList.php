 ...
 * Page class
 */
class ExpressTimelineList extends ExpressTimeline
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ExpressTimelineList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fexpress_timelinelist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ExpressTimelineAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ExpressTimelineDelete";
        $this->MultiUpdateUrl = "ExpressTimelineUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fexpress_timelinelistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->express_id->AdvancedSearch->toJson(), ","); // Field express_id
        $filterList = Concat($filterList, $this->admin_id->AdvancedSearch->toJson(), ","); // Field admin_id
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fexpress_timelinelistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field express_id
        $this->express_id->AdvancedSearch->SearchValue = @$filter["x_express_id"];
        $this->express_id->AdvancedSearch->SearchOperator = @$filter["z_express_id"];
        $this->express_id->AdvancedSearch->SearchCondition = @$filter["v_express_id"];
        $this->express_id->AdvancedSearch->SearchValue2 = @$filter["y_express_id"];
        $this->express_id->AdvancedSearch->SearchOperator2 = @$filter["w_express_id"];
        $this->express_id->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->detail, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->express_id); // express_id
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fexpress_timelinelistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fexpress_timelinelistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fexpress_timelinelist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchSortOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fexpress_timelinelistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
