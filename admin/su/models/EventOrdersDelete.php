 ...
 * Page class
 */
class EventOrdersDelete extends EventOrders
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EventOrdersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EventOrdersList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EventOrdersList"); // Return to list
                return;
            }
        }
