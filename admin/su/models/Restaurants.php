...
/**
 * Table class for restaurants
 */
class Restaurants extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'restaurants';
        $this->TableName = 'restaurants';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`restaurants`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('restaurants', 'restaurants', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // location_id
        $this->location_id = new DbField('restaurants', 'restaurants', 'x_location_id', 'location_id', '`location_id`', '`location_id`', 2, 4, -1, false, '`location_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // banner
        $this->banner = new DbField('restaurants', 'restaurants', 'x_banner', 'banner', '`banner`', '`banner`', 200, 255, -1, false, '`banner`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->banner->Sortable = true; // Allow sort
        $this->Fields['banner'] = &$this->banner;

        // button_menu
        $this->button_menu = new DbField('restaurants', 'restaurants', 'x_button_menu', 'button_menu', '`button_menu`', '`button_menu`', 200, 255, -1, false, '`button_menu`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->button_menu->Sortable = true; // Allow sort
        $this->Fields['button_menu'] = &$this->button_menu;

        // button_pdf
        $this->button_pdf = new DbField('restaurants', 'restaurants', 'x_button_pdf', 'button_pdf', '`button_pdf`', '`button_pdf`', 200, 255, -1, false, '`button_pdf`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->button_pdf->Sortable = true; // Allow sort
        $this->Fields['button_pdf'] = &$this->button_pdf;

        // button_catering
        $this->button_catering = new DbField('restaurants', 'restaurants', 'x_button_catering', 'button_catering', '`button_catering`', '`button_catering`', 200, 255, -1, false, '`button_catering`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->button_catering->Sortable = true; // Allow sort
        $this->Fields['button_catering'] = &$this->button_catering;

        // button_form
        $this->button_form = new DbField('restaurants', 'restaurants', 'x_button_form', 'button_form', '`button_form`', '`button_form`', 200, 255, -1, false, '`button_form`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->button_form->Sortable = true; // Allow sort
        $this->Fields['button_form'] = &$this->button_form;

        // slides
        $this->slides = new DbField('restaurants', 'restaurants', 'x_slides', 'slides', '`slides`', '`slides`', 16, 45, -1, false, '`slides`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->slides->Sortable = true; // Allow sort
        $this->slides->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['slides'] = &$this->slides;

        // timestamp
        $this->timestamp = new DbField('restaurants', 'restaurants', 'x_timestamp', 'timestamp', '`timestamp`', CastDateFieldForLike("`timestamp`", 0, "DB"), 135, 19, 0, false, '`timestamp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`restaurants`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->banner->DbValue = $row['banner'];
        $this->button_menu->DbValue = $row['button_menu'];
        $this->button_pdf->DbValue = $row['button_pdf'];
        $this->button_catering->DbValue = $row['button_catering'];
        $this->button_form->DbValue = $row['button_form'];
        $this->slides->DbValue = $row['slides'];
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "RestaurantsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "RestaurantsAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("RestaurantsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("RestaurantsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "RestaurantsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "RestaurantsAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("RestaurantsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RestaurantsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("RestaurantsDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->banner->EditValue = $this->banner->CurrentValue;
        ...
        $this->button_menu->EditValue = $this->button_menu->CurrentValue;
        ...
        $this->button_pdf->EditValue = $this->button_pdf->CurrentValue;
        ...
        $this->button_catering->EditValue = $this->button_catering->CurrentValue;
        ...
        $this->button_form->EditValue = $this->button_form->CurrentValue;
        ...
        $this->slides->EditValue = $this->slides->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->banner);
                    $doc->exportCaption($this->button_menu);
                    $doc->exportCaption($this->button_pdf);
                    $doc->exportCaption($this->button_catering);
                    $doc->exportCaption($this->button_form);
                    $doc->exportCaption($this->slides);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->banner);
                        $doc->exportField($this->button_menu);
                        $doc->exportField($this->button_pdf);
                        $doc->exportField($this->button_catering);
                        $doc->exportField($this->button_form);
                        $doc->exportField($this->slides);
