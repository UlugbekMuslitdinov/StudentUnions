 ...
 * Page class
 */
class MealpackageList extends Mealpackage
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MealpackageList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fmealpackagelist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "MealpackageAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "MealpackageDelete";
        $this->MultiUpdateUrl = "MealpackageUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fmealpackagelistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->netid->AdvancedSearch->toJson(), ","); // Field netid
        ...
        $filterList = Concat($filterList, $this->dorm->AdvancedSearch->toJson(), ","); // Field dorm
        $filterList = Concat($filterList, $this->meal->AdvancedSearch->toJson(), ","); // Field meal
        $filterList = Concat($filterList, $this->refrigerator->AdvancedSearch->toJson(), ","); // Field refrigerator
        $filterList = Concat($filterList, $this->microwave->AdvancedSearch->toJson(), ","); // Field microwave
        $filterList = Concat($filterList, $this->water->AdvancedSearch->toJson(), ","); // Field water
        $filterList = Concat($filterList, $this->requests->AdvancedSearch->toJson(), ","); // Field requests
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fmealpackagelistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field netid
        $this->netid->AdvancedSearch->SearchValue = @$filter["x_netid"];
        $this->netid->AdvancedSearch->SearchOperator = @$filter["z_netid"];
        $this->netid->AdvancedSearch->SearchCondition = @$filter["v_netid"];
        $this->netid->AdvancedSearch->SearchValue2 = @$filter["y_netid"];
        $this->netid->AdvancedSearch->SearchOperator2 = @$filter["w_netid"];
        $this->netid->AdvancedSearch->save();
        ...
        // Field dorm
        $this->dorm->AdvancedSearch->SearchValue = @$filter["x_dorm"];
        $this->dorm->AdvancedSearch->SearchOperator = @$filter["z_dorm"];
        $this->dorm->AdvancedSearch->SearchCondition = @$filter["v_dorm"];
        $this->dorm->AdvancedSearch->SearchValue2 = @$filter["y_dorm"];
        $this->dorm->AdvancedSearch->SearchOperator2 = @$filter["w_dorm"];
        $this->dorm->AdvancedSearch->save();

        // Field meal
        $this->meal->AdvancedSearch->SearchValue = @$filter["x_meal"];
        $this->meal->AdvancedSearch->SearchOperator = @$filter["z_meal"];
        $this->meal->AdvancedSearch->SearchCondition = @$filter["v_meal"];
        $this->meal->AdvancedSearch->SearchValue2 = @$filter["y_meal"];
        $this->meal->AdvancedSearch->SearchOperator2 = @$filter["w_meal"];
        $this->meal->AdvancedSearch->save();

        // Field refrigerator
        $this->refrigerator->AdvancedSearch->SearchValue = @$filter["x_refrigerator"];
        $this->refrigerator->AdvancedSearch->SearchOperator = @$filter["z_refrigerator"];
        $this->refrigerator->AdvancedSearch->SearchCondition = @$filter["v_refrigerator"];
        $this->refrigerator->AdvancedSearch->SearchValue2 = @$filter["y_refrigerator"];
        $this->refrigerator->AdvancedSearch->SearchOperator2 = @$filter["w_refrigerator"];
        $this->refrigerator->AdvancedSearch->save();

        // Field microwave
        $this->microwave->AdvancedSearch->SearchValue = @$filter["x_microwave"];
        $this->microwave->AdvancedSearch->SearchOperator = @$filter["z_microwave"];
        $this->microwave->AdvancedSearch->SearchCondition = @$filter["v_microwave"];
        $this->microwave->AdvancedSearch->SearchValue2 = @$filter["y_microwave"];
        $this->microwave->AdvancedSearch->SearchOperator2 = @$filter["w_microwave"];
        $this->microwave->AdvancedSearch->save();

        // Field water
        $this->water->AdvancedSearch->SearchValue = @$filter["x_water"];
        $this->water->AdvancedSearch->SearchOperator = @$filter["z_water"];
        $this->water->AdvancedSearch->SearchCondition = @$filter["v_water"];
        $this->water->AdvancedSearch->SearchValue2 = @$filter["y_water"];
        $this->water->AdvancedSearch->SearchOperator2 = @$filter["w_water"];
        $this->water->AdvancedSearch->save();

        // Field requests
        $this->requests->AdvancedSearch->SearchValue = @$filter["x_requests"];
        $this->requests->AdvancedSearch->SearchOperator = @$filter["z_requests"];
        $this->requests->AdvancedSearch->SearchCondition = @$filter["v_requests"];
        $this->requests->AdvancedSearch->SearchValue2 = @$filter["y_requests"];
        $this->requests->AdvancedSearch->SearchOperator2 = @$filter["w_requests"];
        $this->requests->AdvancedSearch->save();
    ...
    {
        $where = "";
        $this->buildBasicSearchSql($where, $this->netid, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->sid, $arKeywords, $type);
        ...
        $this->buildBasicSearchSql($where, $this->dorm, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->meal, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->refrigerator, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->microwave, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->requests, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->netid); // netid
            $this->updateSort($this->sid); // sid
            $this->updateSort($this->_email); // email
            $this->updateSort($this->firstname); // firstname
            $this->updateSort($this->lastname); // lastname
            $this->updateSort($this->phone); // phone
            $this->updateSort($this->dorm); // dorm
            $this->updateSort($this->meal); // meal
            $this->updateSort($this->refrigerator); // refrigerator
            $this->updateSort($this->microwave); // microwave
            $this->updateSort($this->water); // water
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->dorm->setSort("");
                $this->meal->setSort("");
                $this->refrigerator->setSort("");
                $this->microwave->setSort("");
                $this->water->setSort("");
                $this->requests->setSort("");
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fmealpackagelistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fmealpackagelistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fmealpackagelist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchSortOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fmealpackagelistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
