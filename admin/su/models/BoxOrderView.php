 ...
 * Page class
 */
class BoxOrderView extends BoxOrder
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BoxOrderView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "BoxOrderList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "BoxOrderList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "BoxOrderList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
