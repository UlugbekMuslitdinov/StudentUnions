 ...
 * Page class
 */
class RotationDelete extends Rotation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RotationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RotationList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RotationList"); // Return to list
                return;
            }
        }
