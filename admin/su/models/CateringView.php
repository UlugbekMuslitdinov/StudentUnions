 ...
 * Page class
 */
class CateringView extends Catering
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CateringView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "CateringList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "CateringList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "CateringList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
