 ...
 * Page class
 */
class CateringHighlandView extends CateringHighland
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CateringHighlandView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "CateringHighlandList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "CateringHighlandList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "CateringHighlandList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
