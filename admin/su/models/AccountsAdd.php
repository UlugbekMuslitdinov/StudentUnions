 ...
 * Page class
 */
class AccountsAdd extends Accounts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AccountsAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("AccountsList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "AccountsView") {
