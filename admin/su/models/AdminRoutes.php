...
/**
 * Table class for admin_routes
 */
class AdminRoutes extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'admin_routes';
        $this->TableName = 'admin_routes';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`admin_routes`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('admin_routes', 'admin_routes', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // group_id
        $this->group_id = new DbField('admin_routes', 'admin_routes', 'x_group_id', 'group_id', '`group_id`', '`group_id`', 3, 11, -1, false, '`group_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // title
        $this->title = new DbField('admin_routes', 'admin_routes', 'x_title', 'title', '`title`', '`title`', 200, 45, -1, false, '`title`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->title->Sortable = true; // Allow sort
        $this->Fields['title'] = &$this->title;

        // icon
        $this->icon = new DbField('admin_routes', 'admin_routes', 'x_icon', 'icon', '`icon`', '`icon`', 200, 45, -1, false, '`icon`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->icon->Sortable = true; // Allow sort
        $this->Fields['icon'] = &$this->icon;

        // url
        $this->url = new DbField('admin_routes', 'admin_routes', 'x_url', 'url', '`url`', '`url`', 200, 100, -1, false, '`url`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`admin_routes`";
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "AdminRoutesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "AdminRoutesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "AdminRoutesAdd";
            case Config("API_EDIT_ACTION"):
                return "AdminRoutesEdit";
            case Config("API_DELETE_ACTION"):
                return "AdminRoutesDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AdminRoutesView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("AdminRoutesView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "AdminRoutesAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "AdminRoutesAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("AdminRoutesEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AdminRoutesAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("AdminRoutesDelete", $this->getUrlParm());
    }
