 ...
 * Page class
 */
class EventTimelineView extends EventTimeline
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EventTimelineView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "EventTimelineList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "EventTimelineList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "EventTimelineList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
