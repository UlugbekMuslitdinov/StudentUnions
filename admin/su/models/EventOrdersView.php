 ...
 * Page class
 */
class EventOrdersView extends EventOrders
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EventOrdersView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "EventOrdersList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "EventOrdersList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "EventOrdersList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
