 ...
 * Page class
 */
class CateringHighlandBurritoEdit extends CateringHighlandBurrito
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CateringHighlandBurritoEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // pack_num
            $this->pack_num->setDbValueDef($rsnew, $this->pack_num->CurrentValue, null, $this->pack_num->ReadOnly);

            // burrito_num
            $this->burrito_num->setDbValueDef($rsnew, $this->burrito_num->CurrentValue, null, $this->burrito_num->ReadOnly);

            // meat_1
            $this->meat_1->setDbValueDef($rsnew, $this->meat_1->CurrentValue, null, $this->meat_1->ReadOnly);

            // meat_2
            $this->meat_2->setDbValueDef($rsnew, $this->meat_2->CurrentValue, null, $this->meat_2->ReadOnly);

            // meat_3
            $this->meat_3->setDbValueDef($rsnew, $this->meat_3->CurrentValue, null, $this->meat_3->ReadOnly);

            // meat_4
            $this->meat_4->setDbValueDef($rsnew, $this->meat_4->CurrentValue, null, $this->meat_4->ReadOnly);

            // vege_1
            $this->vege_1->setDbValueDef($rsnew, $this->vege_1->CurrentValue, null, $this->vege_1->ReadOnly);

            // vege_2
            $this->vege_2->setDbValueDef($rsnew, $this->vege_2->CurrentValue, null, $this->vege_2->ReadOnly);

            // vege_3
            $this->vege_3->setDbValueDef($rsnew, $this->vege_3->CurrentValue, null, $this->vege_3->ReadOnly);

            // vege_4
            $this->vege_4->setDbValueDef($rsnew, $this->vege_4->CurrentValue, null, $this->vege_4->ReadOnly);
