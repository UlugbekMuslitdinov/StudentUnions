 ...
 * Page class
 */
class SessionHandlerView extends SessionHandler
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SessionHandlerView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "SessionHandlerList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "SessionHandlerList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "SessionHandlerList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
