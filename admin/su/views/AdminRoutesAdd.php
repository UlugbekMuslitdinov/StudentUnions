...
var fadmin_routesadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fadmin_routesadd = currentForm = new ew.Form("fadmin_routesadd", "add");

    // Add fields
    var fields = ew.vars.tables.admin_routes.fields;
    fadmin_routesadd.addFields([
    ...
    // Validate form
    fadmin_routesadd.validate = function () {
    ...
    // Form_CustomValidate
    fadmin_routesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fadmin_routesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fadmin_routesadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fadmin_routesadd" id="fadmin_routesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
