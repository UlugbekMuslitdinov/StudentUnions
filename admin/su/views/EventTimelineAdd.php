...
loadjs.ready("head", function () {
    ...
    // Validate form
    fevent_timelineadd.validate = function () {
    ...
    // Form_CustomValidate
    fevent_timelineadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fevent_timelineadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fevent_timelineadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fevent_timelineadd" id="fevent_timelineadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fevent_timelineadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fevent_timelineadd", "x_created_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fevent_timelineadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fevent_timelineadd", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
