...
loadjs.ready("head", function () {
    ...
    fbox_menuadd = currentForm = new ew.Form("fbox_menuadd", "add");

    // Add fields
    var fields = ew.vars.tables.box_menu.fields;
    fbox_menuadd.addFields([
    ...
    // Validate form
    fbox_menuadd.validate = function () {
    ...
    // Form_CustomValidate
    fbox_menuadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fbox_menuadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fbox_menuadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fbox_menuadd" id="fbox_menuadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
