...
loadjs.ready("head", function () {
    ...
    fcateringadd = currentForm = new ew.Form("fcateringadd", "add");

    // Add fields
    var fields = ew.vars.tables.catering.fields;
    fcateringadd.addFields([
    ...
    // Validate form
    fcateringadd.validate = function () {
    ...
    // Form_CustomValidate
    fcateringadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcateringadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcateringadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcateringadd" id="fcateringadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fcateringadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fcateringadd", "x_delivery_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fcateringadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fcateringadd", "x_timestamp", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
