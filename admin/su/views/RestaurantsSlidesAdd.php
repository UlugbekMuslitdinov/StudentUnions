...
var frestaurants_slidesadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    frestaurants_slidesadd = currentForm = new ew.Form("frestaurants_slidesadd", "add");

    // Add fields
    var fields = ew.vars.tables.restaurants_slides.fields;
    frestaurants_slidesadd.addFields([
    ...
    // Validate form
    frestaurants_slidesadd.validate = function () {
    ...
    // Form_CustomValidate
    frestaurants_slidesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    frestaurants_slidesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("frestaurants_slidesadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="frestaurants_slidesadd" id="frestaurants_slidesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["frestaurants_slidesadd", "datetimepicker"], function() {
    ew.createDateTimePicker("frestaurants_slidesadd", "x_timestamp", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
