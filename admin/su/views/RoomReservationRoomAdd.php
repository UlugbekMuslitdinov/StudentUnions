...
var froom_reservation_roomadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    froom_reservation_roomadd = currentForm = new ew.Form("froom_reservation_roomadd", "add");

    // Add fields
    var fields = ew.vars.tables.room_reservation_room.fields;
    froom_reservation_roomadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = froom_reservation_roomadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    froom_reservation_roomadd.validate = function () {
    ...
    // Form_CustomValidate
    froom_reservation_roomadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    froom_reservation_roomadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("froom_reservation_roomadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="froom_reservation_roomadd" id="froom_reservation_roomadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
