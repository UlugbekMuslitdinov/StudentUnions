...
// Page object
$CateringHighlandBurritoAdd = &$Page;
?>
<script>
...
var fcatering_highland_burritoadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fcatering_highland_burritoadd = currentForm = new ew.Form("fcatering_highland_burritoadd", "add");

    // Add fields
    var fields = ew.vars.tables.catering_highland_burrito.fields;
    fcatering_highland_burritoadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fcatering_highland_burritoadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fcatering_highland_burritoadd.validate = function () {
    ...
    // Form_CustomValidate
    fcatering_highland_burritoadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcatering_highland_burritoadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcatering_highland_burritoadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcatering_highland_burritoadd" id="fcatering_highland_burritoadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
