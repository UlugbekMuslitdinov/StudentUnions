...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "18.1.0");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "mealplans"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{53D4394F-93E8-4304-8038-0F377D6B437A}"); // Project ID
