...
return [
    ...
    // Tables
    "bursar_payment" => \DI\create(BursarPayment::class),
    "card_info" => \DI\create(CardInfo::class),
    "cashier_access" => \DI\create(CashierAccess::class),
    "charge_payment" => \DI\create(ChargePayment::class),
    "config2" => \DI\create(Config2::class),
    "control" => \DI\create(Control::class),
];
