...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fcard_infoadd = new ew.Form("fcard_infoadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fcard_infoadd;

    // Add fields
    var fields = currentTable.fields;
    fcard_infoadd.addFields([
    ...
    // Form_CustomValidate
    fcard_infoadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcard_infoadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fcard_infoadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fcard_infoadd" id="fcard_infoadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
