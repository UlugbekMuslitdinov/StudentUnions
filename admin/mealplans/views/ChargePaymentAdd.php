...
// Page object
$ChargePaymentAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { charge_payment: currentTable } });
var currentForm, currentPageID;
var fcharge_paymentadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fcharge_paymentadd = new ew.Form("fcharge_paymentadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fcharge_paymentadd;

    // Add fields
    var fields = currentTable.fields;
    fcharge_paymentadd.addFields([
    ...
    // Form_CustomValidate
    fcharge_paymentadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcharge_paymentadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fcharge_paymentadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fcharge_paymentadd" id="fcharge_paymentadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fcharge_paymentadd", "datetimepicker"], function () {
    let options = {
        localization: {
    ...
    ew.createDateTimePicker("fcharge_paymentadd", "x_transaction_time", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
