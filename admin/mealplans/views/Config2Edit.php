...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fconfig2edit = new ew.Form("fconfig2edit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fconfig2edit;

    // Add fields
    var fields = currentTable.fields;
    fconfig2edit.addFields([
    ...
    // Form_CustomValidate
    fconfig2edit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fconfig2edit.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fconfig2edit.lists.plus_signup_full = <?= $Page->plus_signup_full->toClientList($Page) ?>;
    fconfig2edit.lists.plus_signup_half = <?= $Page->plus_signup_half->toClientList($Page) ?>;
    loadjs.done("fconfig2edit");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fconfig2edit" id="fconfig2edit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="config2" data-field="x_id" data-hidden="1" name="o_id" id="o_id" value="<?= HtmlEncode($Page->id->OldValue ?? $Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fconfig2edit", "datetimepicker"], function () {
    let options = {
        localization: {
    ...
    ew.createDateTimePicker("fconfig2edit", "x_full_year_begin", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fconfig2edit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fconfig2edit", "x_half_year_begin", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fconfig2edit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fconfig2edit", "x_year_end", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->plus_signup_full->isInvalidClass() ?>" data-table="config2" data-field="x_plus_signup_full" name="x_plus_signup_full[]" id="x_plus_signup_full_662378" value="1"<?= ConvertToBool($Page->plus_signup_full->CurrentValue) ? " checked" : "" ?><?= $Page->plus_signup_full->editAttributes() ?> aria-describedby="x_plus_signup_full_help">
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->plus_signup_half->isInvalidClass() ?>" data-table="config2" data-field="x_plus_signup_half" name="x_plus_signup_half[]" id="x_plus_signup_half_847943" value="1"<?= ConvertToBool($Page->plus_signup_half->CurrentValue) ? " checked" : "" ?><?= $Page->plus_signup_half->editAttributes() ?> aria-describedby="x_plus_signup_half_help">
...
loadjs.ready(["fconfig2edit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fconfig2edit", "x_bursar_deposit_deadline", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
