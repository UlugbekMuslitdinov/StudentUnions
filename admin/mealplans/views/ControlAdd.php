...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fcontroladd = new ew.Form("fcontroladd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fcontroladd;

    // Add fields
    var fields = currentTable.fields;
    fcontroladd.addFields([
    ...
    // Form_CustomValidate
    fcontroladd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcontroladd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fcontroladd.lists.online = <?= $Page->online->toClientList($Page) ?>;
    fcontroladd.lists.signup_bursars = <?= $Page->signup_bursars->toClientList($Page) ?>;
    fcontroladd.lists.signup_cc = <?= $Page->signup_cc->toClientList($Page) ?>;
    fcontroladd.lists.deposit_bursars = <?= $Page->deposit_bursars->toClientList($Page) ?>;
    fcontroladd.lists.deposit_cc = <?= $Page->deposit_cc->toClientList($Page) ?>;
    fcontroladd.lists.exporter = <?= $Page->exporter->toClientList($Page) ?>;
    fcontroladd.lists.signup = <?= $Page->signup->toClientList($Page) ?>;
    loadjs.done("fcontroladd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fcontroladd" id="fcontroladd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->online->isInvalidClass() ?>" data-table="control" data-field="x_online" name="x_online[]" id="x_online_320007" value="1"<?= ConvertToBool($Page->online->CurrentValue) ? " checked" : "" ?><?= $Page->online->editAttributes() ?> aria-describedby="x_online_help">
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->signup_bursars->isInvalidClass() ?>" data-table="control" data-field="x_signup_bursars" name="x_signup_bursars[]" id="x_signup_bursars_786959" value="1"<?= ConvertToBool($Page->signup_bursars->CurrentValue) ? " checked" : "" ?><?= $Page->signup_bursars->editAttributes() ?> aria-describedby="x_signup_bursars_help">
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->signup_cc->isInvalidClass() ?>" data-table="control" data-field="x_signup_cc" name="x_signup_cc[]" id="x_signup_cc_342474" value="1"<?= ConvertToBool($Page->signup_cc->CurrentValue) ? " checked" : "" ?><?= $Page->signup_cc->editAttributes() ?> aria-describedby="x_signup_cc_help">
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->deposit_bursars->isInvalidClass() ?>" data-table="control" data-field="x_deposit_bursars" name="x_deposit_bursars[]" id="x_deposit_bursars_897491" value="1"<?= ConvertToBool($Page->deposit_bursars->CurrentValue) ? " checked" : "" ?><?= $Page->deposit_bursars->editAttributes() ?> aria-describedby="x_deposit_bursars_help">
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->deposit_cc->isInvalidClass() ?>" data-table="control" data-field="x_deposit_cc" name="x_deposit_cc[]" id="x_deposit_cc_459805" value="1"<?= ConvertToBool($Page->deposit_cc->CurrentValue) ? " checked" : "" ?><?= $Page->deposit_cc->editAttributes() ?> aria-describedby="x_deposit_cc_help">
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->exporter->isInvalidClass() ?>" data-table="control" data-field="x_exporter" name="x_exporter[]" id="x_exporter_680682" value="1"<?= ConvertToBool($Page->exporter->CurrentValue) ? " checked" : "" ?><?= $Page->exporter->editAttributes() ?> aria-describedby="x_exporter_help">
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->signup->isInvalidClass() ?>" data-table="control" data-field="x_signup" name="x_signup[]" id="x_signup_132685" value="1"<?= ConvertToBool($Page->signup->CurrentValue) ? " checked" : "" ?><?= $Page->signup->editAttributes() ?> aria-describedby="x_signup_help">
