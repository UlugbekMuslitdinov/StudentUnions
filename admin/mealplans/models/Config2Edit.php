 ...
 * Page class
 */
class Config2Edit extends Config2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Config2Edit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // min_deposit
            $this->min_deposit->setDbValueDef($rsnew, $this->min_deposit->CurrentValue, 0, $this->min_deposit->ReadOnly);

            // max_deposit
            $this->max_deposit->setDbValueDef($rsnew, $this->max_deposit->CurrentValue, 0, $this->max_deposit->ReadOnly);

            // current_term_code
            $this->current_term_code->setDbValueDef($rsnew, $this->current_term_code->CurrentValue, 0, $this->current_term_code->ReadOnly);

            // fall_term_code
            $this->fall_term_code->setDbValueDef($rsnew, $this->fall_term_code->CurrentValue, 0, $this->fall_term_code->ReadOnly);

            // spring_term_code
            $this->spring_term_code->setDbValueDef($rsnew, $this->spring_term_code->CurrentValue, 0, $this->spring_term_code->ReadOnly);

            // full_year_begin
            $this->full_year_begin->setDbValueDef($rsnew, UnFormatDateTime($this->full_year_begin->CurrentValue, $this->full_year_begin->formatPattern()), CurrentDate(), $this->full_year_begin->ReadOnly);

            // half_year_begin
            $this->half_year_begin->setDbValueDef($rsnew, UnFormatDateTime($this->half_year_begin->CurrentValue, $this->half_year_begin->formatPattern()), CurrentDate(), $this->half_year_begin->ReadOnly);

            // year_end
            $this->year_end->setDbValueDef($rsnew, UnFormatDateTime($this->year_end->CurrentValue, $this->year_end->formatPattern()), CurrentDate(), $this->year_end->ReadOnly);
            ...
            $this->plus_signup_full->setDbValueDef($rsnew, $tmpBool, 0, $this->plus_signup_full->ReadOnly);
            ...
            $this->plus_signup_half->setDbValueDef($rsnew, $tmpBool, 0, $this->plus_signup_half->ReadOnly);

            // bursar_deposit_deadline
            $this->bursar_deposit_deadline->setDbValueDef($rsnew, UnFormatDateTime($this->bursar_deposit_deadline->CurrentValue, $this->bursar_deposit_deadline->formatPattern()), CurrentDate(), $this->bursar_deposit_deadline->ReadOnly);
