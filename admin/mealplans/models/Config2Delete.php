 ...
 * Page class
 */
class Config2Delete extends Config2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Config2Delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("Config2List"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("Config2List"); // Return to list
                return;
            }
        }
