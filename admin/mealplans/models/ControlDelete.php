 ...
 * Page class
 */
class ControlDelete extends Control
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ControlDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ControlList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ControlList"); // Return to list
                return;
            }
        }
