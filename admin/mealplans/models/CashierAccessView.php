 ...
 * Page class
 */
class CashierAccessView extends CashierAccess
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CashierAccessView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "CashierAccessList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "CashierAccessList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "CashierAccessList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("CashierAccessList"), "", $this->TableVar, true);
        $pageId = "view";
