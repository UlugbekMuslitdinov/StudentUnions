 ...
 * Page class
 */
class CardInfoDelete extends CardInfo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CardInfoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CardInfoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CardInfoList"); // Return to list
                return;
            }
        }
