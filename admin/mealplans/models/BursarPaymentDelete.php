 ...
 * Page class
 */
class BursarPaymentDelete extends BursarPayment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BursarPaymentDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BursarPaymentList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("BursarPaymentList"); // Return to list
                return;
            }
        }
