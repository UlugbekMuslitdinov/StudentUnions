 ...
 * Page class
 */
class ControlAdd extends Control
{
    use MessagesTrait;
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ControlView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->online->CurrentValue = null;
        $this->online->OldValue = $this->online->CurrentValue;
        $this->online_message->CurrentValue = null;
        $this->online_message->OldValue = $this->online_message->CurrentValue;
        $this->signup_bursars->CurrentValue = null;
        $this->signup_bursars->OldValue = $this->signup_bursars->CurrentValue;
        $this->signup_bursars_message->CurrentValue = null;
        $this->signup_bursars_message->OldValue = $this->signup_bursars_message->CurrentValue;
        $this->signup_cc->CurrentValue = null;
        $this->signup_cc->OldValue = $this->signup_cc->CurrentValue;
        $this->signup_cc_message->CurrentValue = null;
        $this->signup_cc_message->OldValue = $this->signup_cc_message->CurrentValue;
        $this->deposit_bursars->CurrentValue = null;
        $this->deposit_bursars->OldValue = $this->deposit_bursars->CurrentValue;
        $this->deposit_bursars_message->CurrentValue = null;
        $this->deposit_bursars_message->OldValue = $this->deposit_bursars_message->CurrentValue;
        $this->deposit_cc->CurrentValue = null;
        $this->deposit_cc->OldValue = $this->deposit_cc->CurrentValue;
        $this->deposit_cc_message->CurrentValue = null;
        $this->deposit_cc_message->OldValue = $this->deposit_cc_message->CurrentValue;
        $this->exporter->CurrentValue = null;
        $this->exporter->OldValue = $this->exporter->CurrentValue;
        $this->signup->CurrentValue = 1;
        $this->signup_message->CurrentValue = null;
        $this->signup_message->OldValue = $this->signup_message->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row['online'] = $this->online->CurrentValue;
        $row['online_message'] = $this->online_message->CurrentValue;
        $row['signup_bursars'] = $this->signup_bursars->CurrentValue;
        $row['signup_bursars_message'] = $this->signup_bursars_message->CurrentValue;
        $row['signup_cc'] = $this->signup_cc->CurrentValue;
        $row['signup_cc_message'] = $this->signup_cc_message->CurrentValue;
        $row['deposit_bursars'] = $this->deposit_bursars->CurrentValue;
        $row['deposit_bursars_message'] = $this->deposit_bursars_message->CurrentValue;
        $row['deposit_cc'] = $this->deposit_cc->CurrentValue;
        $row['deposit_cc_message'] = $this->deposit_cc_message->CurrentValue;
        $row['exporter'] = $this->exporter->CurrentValue;
        $row['signup'] = $this->signup->CurrentValue;
        $row['signup_message'] = $this->signup_message->CurrentValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        $this->online->setDbValueDef($rsnew, $tmpBool, 0, false);

        // online_message
        $this->online_message->setDbValueDef($rsnew, $this->online_message->CurrentValue, "", false);
        ...
        $this->signup_bursars->setDbValueDef($rsnew, $tmpBool, 0, false);

        // signup_bursars_message
        $this->signup_bursars_message->setDbValueDef($rsnew, $this->signup_bursars_message->CurrentValue, "", false);
        ...
        $this->signup_cc->setDbValueDef($rsnew, $tmpBool, 0, false);

        // signup_cc_message
        $this->signup_cc_message->setDbValueDef($rsnew, $this->signup_cc_message->CurrentValue, "", false);
        ...
        $this->deposit_bursars->setDbValueDef($rsnew, $tmpBool, 0, false);

        // deposit_bursars_message
        $this->deposit_bursars_message->setDbValueDef($rsnew, $this->deposit_bursars_message->CurrentValue, "", false);
        ...
        $this->deposit_cc->setDbValueDef($rsnew, $tmpBool, 0, false);

        // deposit_cc_message
        $this->deposit_cc_message->setDbValueDef($rsnew, $this->deposit_cc_message->CurrentValue, "", false);
        ...
        $this->exporter->setDbValueDef($rsnew, $tmpBool, 0, false);
        ...
        $this->signup->setDbValueDef($rsnew, $tmpBool, 0, strval($this->signup->CurrentValue) == "");

        // signup_message
        $this->signup_message->setDbValueDef($rsnew, $this->signup_message->CurrentValue, null, false);
