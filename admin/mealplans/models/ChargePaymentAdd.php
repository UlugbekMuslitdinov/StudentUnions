 ...
 * Page class
 */
class ChargePaymentAdd extends ChargePayment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ChargePaymentAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ChargePaymentView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->charge_id->OldValue = $this->charge_id->CurrentValue;
        $this->ch_first_name->CurrentValue = null;
        $this->ch_first_name->OldValue = $this->ch_first_name->CurrentValue;
        $this->ch_last_name->CurrentValue = null;
        $this->ch_last_name->OldValue = $this->ch_last_name->CurrentValue;
        ...
        $this->expiration_month->CurrentValue = 1;
        $this->expiration_year->CurrentValue = 2010;
        $this->cv_reply->CurrentValue = null;
        $this->cv_reply->OldValue = $this->cv_reply->CurrentValue;
        $this->charge_amount->CurrentValue = null;
        $this->charge_amount->OldValue = $this->charge_amount->CurrentValue;
        ...
        $this->decision->CurrentValue = null;
        $this->decision->OldValue = $this->decision->CurrentValue;
        $this->reason_code->CurrentValue = 0;
        $this->transaction_time->CurrentValue = null;
        $this->transaction_time->OldValue = $this->transaction_time->CurrentValue;
        $this->ch_email->CurrentValue = null;
        $this->ch_email->OldValue = $this->ch_email->CurrentValue;
        $this->ch_phone->CurrentValue = null;
        $this->ch_phone->OldValue = $this->ch_phone->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['charge_id'] = $this->charge_id->CurrentValue;
        $row['ch_first_name'] = $this->ch_first_name->CurrentValue;
        $row['ch_last_name'] = $this->ch_last_name->CurrentValue;
        ...
        $row['cv_reply'] = $this->cv_reply->CurrentValue;
        $row['charge_amount'] = $this->charge_amount->CurrentValue;
        $row['order_number'] = $this->order_number->CurrentValue;
        $row['account_number'] = $this->account_number->CurrentValue;
        $row['decision'] = $this->decision->CurrentValue;
        $row['reason_code'] = $this->reason_code->CurrentValue;
        $row['transaction_time'] = $this->transaction_time->CurrentValue;
        $row['ch_email'] = $this->ch_email->CurrentValue;
        $row['ch_phone'] = $this->ch_phone->CurrentValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // ch_first_name
        $this->ch_first_name->setDbValueDef($rsnew, $this->ch_first_name->CurrentValue, "", false);

        // ch_last_name
        $this->ch_last_name->setDbValueDef($rsnew, $this->ch_last_name->CurrentValue, "", false);
        ...
        // expiration_month
        $this->expiration_month->setDbValueDef($rsnew, $this->expiration_month->CurrentValue, 0, strval($this->expiration_month->CurrentValue) == "");

        // expiration_year
        $this->expiration_year->setDbValueDef($rsnew, $this->expiration_year->CurrentValue, 0, strval($this->expiration_year->CurrentValue) == "");

        // cv_reply
        $this->cv_reply->setDbValueDef($rsnew, $this->cv_reply->CurrentValue, "", false);

        // charge_amount
        $this->charge_amount->setDbValueDef($rsnew, $this->charge_amount->CurrentValue, 0, false);
        ...
        // decision
        $this->decision->setDbValueDef($rsnew, $this->decision->CurrentValue, "", false);

        // reason_code
        $this->reason_code->setDbValueDef($rsnew, $this->reason_code->CurrentValue, 0, strval($this->reason_code->CurrentValue) == "");

        // transaction_time
        $this->transaction_time->setDbValueDef($rsnew, UnFormatDateTime($this->transaction_time->CurrentValue, $this->transaction_time->formatPattern()), null, false);

        // ch_email
        $this->ch_email->setDbValueDef($rsnew, $this->ch_email->CurrentValue, "", false);

        // ch_phone
        $this->ch_phone->setDbValueDef($rsnew, $this->ch_phone->CurrentValue, "", false);
