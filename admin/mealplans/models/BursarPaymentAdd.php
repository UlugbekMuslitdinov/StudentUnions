 ...
 * Page class
 */
class BursarPaymentAdd extends BursarPayment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BursarPaymentAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "BursarPaymentView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->bursar_id->OldValue = $this->bursar_id->CurrentValue;
        $this->emplid->CurrentValue = null;
        $this->emplid->OldValue = $this->emplid->CurrentValue;
        $this->subcode->CurrentValue = null;
        $this->subcode->OldValue = $this->subcode->CurrentValue;
        $this->term->CurrentValue = null;
        $this->term->OldValue = $this->term->CurrentValue;
        $this->bursars_amount->CurrentValue = null;
        $this->bursars_amount->OldValue = $this->bursars_amount->CurrentValue;
        $this->_response->CurrentValue = null;
        $this->_response->OldValue = $this->_response->CurrentValue;
        $this->item_nbr->CurrentValue = null;
        $this->item_nbr->OldValue = $this->item_nbr->CurrentValue;
        $this->line_seq_no->CurrentValue = null;
        $this->line_seq_no->OldValue = $this->line_seq_no->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['bursar_id'] = $this->bursar_id->CurrentValue;
        $row['emplid'] = $this->emplid->CurrentValue;
        $row['subcode'] = $this->subcode->CurrentValue;
        $row['term'] = $this->term->CurrentValue;
        $row['bursars_amount'] = $this->bursars_amount->CurrentValue;
        $row['response'] = $this->_response->CurrentValue;
        $row['item_nbr'] = $this->item_nbr->CurrentValue;
        $row['line_seq_no'] = $this->line_seq_no->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // emplid
        $this->emplid->setDbValueDef($rsnew, $this->emplid->CurrentValue, null, false);

        // subcode
        $this->subcode->setDbValueDef($rsnew, $this->subcode->CurrentValue, null, false);

        // term
        $this->term->setDbValueDef($rsnew, $this->term->CurrentValue, 0, false);

        // bursars_amount
        $this->bursars_amount->setDbValueDef($rsnew, $this->bursars_amount->CurrentValue, 0, false);

        // response
        $this->_response->setDbValueDef($rsnew, $this->_response->CurrentValue, null, false);

        // item_nbr
        $this->item_nbr->setDbValueDef($rsnew, $this->item_nbr->CurrentValue, null, false);

        // line_seq_no
        $this->line_seq_no->setDbValueDef($rsnew, $this->line_seq_no->CurrentValue, null, false);
