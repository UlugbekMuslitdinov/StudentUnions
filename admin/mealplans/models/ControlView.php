 ...
 * Page class
 */
class ControlView extends Control
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ControlView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID") ?? Route("ID")) !== null) {
                ...
                $returnUrl = "ControlList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ControlList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "ControlList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
