 ...
 * Page class
 */
class Config2View extends Config2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Config2View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "Config2List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "Config2List"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "Config2List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
