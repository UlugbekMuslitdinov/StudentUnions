...
class ControlList extends Control
{
    ...
    // Page object name
    public $PageObjName = "ControlList";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "ControlAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ControlDelete";
        $this->MultiUpdateUrl = "ControlUpdate";
    ...
    public function run()
    {
        ...
        $this->online_message->Visible = false;
        $this->signup_bursars->setVisibility();
        $this->signup_bursars_message->Visible = false;
        $this->signup_cc->setVisibility();
        $this->signup_cc_message->Visible = false;
        $this->deposit_bursars->setVisibility();
        $this->deposit_bursars_message->Visible = false;
        $this->deposit_cc->setVisibility();
        $this->deposit_cc_message->Visible = false;
        $this->exporter->setVisibility();
        $this->signup->setVisibility();
        $this->signup_message->Visible = false;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->signup_bursars); // signup_bursars
            $this->updateSort($this->signup_cc); // signup_cc
            $this->updateSort($this->deposit_bursars); // deposit_bursars
            $this->updateSort($this->deposit_cc); // deposit_cc
            $this->updateSort($this->exporter); // exporter
            $this->updateSort($this->signup); // signup
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->ID->setSort("");
                $this->online->setSort("");
                $this->online_message->setSort("");
                $this->signup_bursars->setSort("");
                $this->signup_bursars_message->setSort("");
                $this->signup_cc->setSort("");
                $this->signup_cc_message->setSort("");
                $this->deposit_bursars->setSort("");
                $this->deposit_bursars_message->setSort("");
                $this->deposit_cc->setSort("");
                $this->deposit_cc_message->setSort("");
                $this->exporter->setSort("");
                $this->signup->setSort("");
                $this->signup_message->setSort("");
            }
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fcontrollist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fcontrollist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("online", $this->createColumnOption("online"));
            $option->add("signup_bursars", $this->createColumnOption("signup_bursars"));
            $option->add("signup_cc", $this->createColumnOption("signup_cc"));
            $option->add("deposit_bursars", $this->createColumnOption("deposit_bursars"));
            $option->add("deposit_cc", $this->createColumnOption("deposit_cc"));
            $option->add("exporter", $this->createColumnOption("exporter"));
            $option->add("signup", $this->createColumnOption("signup"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fcontrolsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fcontrolsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fcontrollist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
