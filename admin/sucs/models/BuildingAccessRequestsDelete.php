 ...
 * Page class
 */
class BuildingAccessRequestsDelete extends BuildingAccessRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuildingAccessRequestsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BuildingAccessRequestsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("BuildingAccessRequestsList"); // Return to list
                return;
            }
        }
