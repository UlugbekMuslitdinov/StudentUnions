 ...
 * Page class
 */
class PhoneRequestsView extends PhoneRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PhoneRequestsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID") ?? Route("ID")) !== null) {
                ...
                $returnUrl = "PhoneRequestsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PhoneRequestsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PhoneRequestsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
