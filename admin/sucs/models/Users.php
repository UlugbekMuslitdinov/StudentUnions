...
class Users extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // user_id
        $this->user_id = new DbField('users', 'users', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, 11, -1, false, '`user_id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // netID
        $this->netID = new DbField('users', 'users', 'x_netID', 'netID', '`netID`', '`netID`', 200, 20, -1, false, '`netID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // email
        $this->_email = new DbField('users', 'users', 'x__email', 'email', '`email`', '`email`', 201, 1000, -1, false, '`email`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // first_name
        $this->first_name = new DbField('users', 'users', 'x_first_name', 'first_name', '`first_name`', '`first_name`', 200, 100, -1, false, '`first_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // last_name
        $this->last_name = new DbField('users', 'users', 'x_last_name', 'last_name', '`last_name`', '`last_name`', 200, 100, -1, false, '`last_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
