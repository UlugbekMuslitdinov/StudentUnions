 ...
 * Page class
 */
class MembershipsDelete extends Memberships
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MembershipsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MembershipsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MembershipsList"); // Return to list
                return;
            }
        }
