 ...
 * Page class
 */
class WorkstationAccessRequestsDelete extends WorkstationAccessRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WorkstationAccessRequestsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("WorkstationAccessRequestsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("WorkstationAccessRequestsList"); // Return to list
                return;
            }
        }
