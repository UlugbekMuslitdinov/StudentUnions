 ...
 * Page class
 */
class DepartmentalAccessRequestsDelete extends DepartmentalAccessRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DepartmentalAccessRequestsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DepartmentalAccessRequestsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("DepartmentalAccessRequestsList"); // Return to list
                return;
            }
        }
