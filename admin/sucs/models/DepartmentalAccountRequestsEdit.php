 ...
 * Page class
 */
class DepartmentalAccountRequestsEdit extends DepartmentalAccountRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DepartmentalAccountRequestsEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // name_1
            $this->name_1->setDbValueDef($rsnew, $this->name_1->CurrentValue, "", $this->name_1->ReadOnly);

            // name_2
            $this->name_2->setDbValueDef($rsnew, $this->name_2->CurrentValue, null, $this->name_2->ReadOnly);

            // name_3
            $this->name_3->setDbValueDef($rsnew, $this->name_3->CurrentValue, null, $this->name_3->ReadOnly);
