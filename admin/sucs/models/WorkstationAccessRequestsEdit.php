 ...
 * Page class
 */
class WorkstationAccessRequestsEdit extends WorkstationAccessRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WorkstationAccessRequestsEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // workstation_tag
            $this->workstation_tag->setDbValueDef($rsnew, $this->workstation_tag->CurrentValue, "", $this->workstation_tag->ReadOnly);

            // access
            $this->access->setDbValueDef($rsnew, $this->access->CurrentValue, 0, $this->access->ReadOnly);

            // foodpro_location
            $this->foodpro_location->setDbValueDef($rsnew, $this->foodpro_location->CurrentValue, null, $this->foodpro_location->ReadOnly);
