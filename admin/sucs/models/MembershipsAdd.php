 ...
 * Page class
 */
class MembershipsAdd extends Memberships
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MembershipsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "MembershipsView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->membership_id->OldValue = $this->membership_id->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['membership_id'] = $this->membership_id->CurrentValue;
