 ...
 * Page class
 */
class DepartmentalAccountRequestsDelete extends DepartmentalAccountRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DepartmentalAccountRequestsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DepartmentalAccountRequestsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("DepartmentalAccountRequestsList"); // Return to list
                return;
            }
        }
