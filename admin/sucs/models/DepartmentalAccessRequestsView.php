 ...
 * Page class
 */
class DepartmentalAccessRequestsView extends DepartmentalAccessRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DepartmentalAccessRequestsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "DepartmentalAccessRequestsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DepartmentalAccessRequestsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "DepartmentalAccessRequestsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
