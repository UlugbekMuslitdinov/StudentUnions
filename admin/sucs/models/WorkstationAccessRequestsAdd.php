 ...
 * Page class
 */
class WorkstationAccessRequestsAdd extends WorkstationAccessRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WorkstationAccessRequestsAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("WorkstationAccessRequestsList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "WorkstationAccessRequestsList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "WorkstationAccessRequestsView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->request_type->CurrentValue = null;
        $this->request_type->OldValue = $this->request_type->CurrentValue;
        ...
        $this->workstation_tag->CurrentValue = null;
        $this->workstation_tag->OldValue = $this->workstation_tag->CurrentValue;
        ...
        $this->updates->CurrentValue = null;
        $this->updates->OldValue = $this->updates->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'workstation_tag' first before field var 'x_workstation_tag'
        $val = $CurrentForm->hasValue("workstation_tag") ? $CurrentForm->getValue("workstation_tag") : $CurrentForm->getValue("x_workstation_tag");
        if (!$this->workstation_tag->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->workstation_tag->Visible = false; // Disable update for API request
            } else {
                $this->workstation_tag->setFormValue($val);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->workstation_tag->CurrentValue = $this->workstation_tag->FormValue;
    ...
    protected function newRow()
    {
        ...
        $row['request_type'] = $this->request_type->CurrentValue;
        ...
        $row['workstation_tag'] = $this->workstation_tag->CurrentValue;
        $row['access'] = $this->access->CurrentValue;
        $row['foodpro_location'] = $this->foodpro_location->CurrentValue;
        $row['updates'] = $this->updates->CurrentValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->workstation_tag->EditValue = HtmlEncode($this->workstation_tag->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if ($this->workstation_tag->Required) {
            if (!$this->workstation_tag->IsDetailKey && EmptyValue($this->workstation_tag->FormValue)) {
                $this->workstation_tag->addErrorMessage(str_replace("%s", $this->workstation_tag->caption(), $this->workstation_tag->RequiredErrorMessage));
            }
        }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // request_type
        $this->request_type->setDbValueDef($rsnew, $this->request_type->CurrentValue, "", false);
        ...
        // workstation_tag
        $this->workstation_tag->setDbValueDef($rsnew, $this->workstation_tag->CurrentValue, "", false);
        ...
        // updates
        $this->updates->setDbValueDef($rsnew, $this->updates->CurrentValue, 0, false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("WorkstationAccessRequestsList"), "", $this->TableVar, true);
