 ...
 * Page class
 */
class NutritionClassList extends NutritionClass
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NutritionClassList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fnutrition_classlist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "NutritionClassAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "NutritionClassDelete";
        $this->MultiUpdateUrl = "NutritionClassUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fnutrition_classlistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->payment_option->AdvancedSearch->toJson(), ","); // Field payment_option
        $filterList = Concat($filterList, $this->class_name->AdvancedSearch->toJson(), ","); // Field class_name
        $filterList = Concat($filterList, $this->class_time->AdvancedSearch->toJson(), ","); // Field class_time
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fnutrition_classlistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        $this->payment_option->AdvancedSearch->SearchValue = @$filter["x_payment_option"];
        $this->payment_option->AdvancedSearch->SearchOperator = @$filter["z_payment_option"];
        $this->payment_option->AdvancedSearch->SearchCondition = @$filter["v_payment_option"];
        $this->payment_option->AdvancedSearch->SearchValue2 = @$filter["y_payment_option"];
        $this->payment_option->AdvancedSearch->SearchOperator2 = @$filter["w_payment_option"];
        $this->payment_option->AdvancedSearch->save();

        // Field class_name
        $this->class_name->AdvancedSearch->SearchValue = @$filter["x_class_name"];
        $this->class_name->AdvancedSearch->SearchOperator = @$filter["z_class_name"];
        $this->class_name->AdvancedSearch->SearchCondition = @$filter["v_class_name"];
        $this->class_name->AdvancedSearch->SearchValue2 = @$filter["y_class_name"];
        $this->class_name->AdvancedSearch->SearchOperator2 = @$filter["w_class_name"];
        $this->class_name->AdvancedSearch->save();

        // Field class_time
        $this->class_time->AdvancedSearch->SearchValue = @$filter["x_class_time"];
        $this->class_time->AdvancedSearch->SearchOperator = @$filter["z_class_time"];
        $this->class_time->AdvancedSearch->SearchCondition = @$filter["v_class_time"];
        $this->class_time->AdvancedSearch->SearchValue2 = @$filter["y_class_time"];
        $this->class_time->AdvancedSearch->SearchOperator2 = @$filter["w_class_time"];
        $this->class_time->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->student_id, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->phone_number, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->payment_option, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->class_name, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->class_time, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->payment_option); // payment_option
            $this->updateSort($this->class_name); // class_name
            $this->updateSort($this->class_time); // class_time
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->payment_option->setSort("");
                $this->class_name->setSort("");
                $this->class_time->setSort("");
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fnutrition_classlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fnutrition_classlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fnutrition_classlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fnutrition_classlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
