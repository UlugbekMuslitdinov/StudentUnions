 ...
 * Page class
 */
class PosAccessRequestsView extends PosAccessRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PosAccessRequestsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PosAccessRequestsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PosAccessRequestsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PosAccessRequestsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
