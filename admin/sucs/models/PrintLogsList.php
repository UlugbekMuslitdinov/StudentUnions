 ...
 * Page class
 */
class PrintLogsList extends PrintLogs
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'print_logs';

    // Page object name
    public $PageObjName = "PrintLogsList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fprint_logslist";
    ...
    public function __construct()
    {
        ...
        // Table object (print_logs)
        if (!isset($GLOBALS["print_logs"]) || get_class($GLOBALS["print_logs"]) == PROJECT_NAMESPACE . "print_logs") {
            $GLOBALS["print_logs"] = &$this;
        }
        ...
        $this->AddUrl = "PrintLogsAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PrintLogsDelete";
        $this->MultiUpdateUrl = "PrintLogsUpdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'print_logs');
        }
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fprint_logslistsrch";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("print_logs"));
                $doc->Text = @$content;
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->Copies->AdvancedSearch->toJson(), ","); // Field Copies
        $filterList = Concat($filterList, $this->Printer->AdvancedSearch->toJson(), ","); // Field Printer
        $filterList = Concat($filterList, $this->DocumentName->AdvancedSearch->toJson(), ","); // Field Document Name
        $filterList = Concat($filterList, $this->Client->AdvancedSearch->toJson(), ","); // Field Client
        $filterList = Concat($filterList, $this->PaperSize->AdvancedSearch->toJson(), ","); // Field Paper Size
        ...
        $filterList = Concat($filterList, $this->Duplex->AdvancedSearch->toJson(), ","); // Field Duplex
        $filterList = Concat($filterList, $this->Grayscale->AdvancedSearch->toJson(), ","); // Field Grayscale
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fprint_logslistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field Copies
        $this->Copies->AdvancedSearch->SearchValue = @$filter["x_Copies"];
        $this->Copies->AdvancedSearch->SearchOperator = @$filter["z_Copies"];
        $this->Copies->AdvancedSearch->SearchCondition = @$filter["v_Copies"];
        $this->Copies->AdvancedSearch->SearchValue2 = @$filter["y_Copies"];
        $this->Copies->AdvancedSearch->SearchOperator2 = @$filter["w_Copies"];
        $this->Copies->AdvancedSearch->save();

        // Field Printer
        $this->Printer->AdvancedSearch->SearchValue = @$filter["x_Printer"];
        $this->Printer->AdvancedSearch->SearchOperator = @$filter["z_Printer"];
        $this->Printer->AdvancedSearch->SearchCondition = @$filter["v_Printer"];
        $this->Printer->AdvancedSearch->SearchValue2 = @$filter["y_Printer"];
        $this->Printer->AdvancedSearch->SearchOperator2 = @$filter["w_Printer"];
        $this->Printer->AdvancedSearch->save();

        // Field Document Name
        $this->DocumentName->AdvancedSearch->SearchValue = @$filter["x_DocumentName"];
        $this->DocumentName->AdvancedSearch->SearchOperator = @$filter["z_DocumentName"];
        $this->DocumentName->AdvancedSearch->SearchCondition = @$filter["v_DocumentName"];
        $this->DocumentName->AdvancedSearch->SearchValue2 = @$filter["y_DocumentName"];
        $this->DocumentName->AdvancedSearch->SearchOperator2 = @$filter["w_DocumentName"];
        $this->DocumentName->AdvancedSearch->save();

        // Field Client
        $this->Client->AdvancedSearch->SearchValue = @$filter["x_Client"];
        $this->Client->AdvancedSearch->SearchOperator = @$filter["z_Client"];
        $this->Client->AdvancedSearch->SearchCondition = @$filter["v_Client"];
        $this->Client->AdvancedSearch->SearchValue2 = @$filter["y_Client"];
        $this->Client->AdvancedSearch->SearchOperator2 = @$filter["w_Client"];
        $this->Client->AdvancedSearch->save();

        // Field Paper Size
        $this->PaperSize->AdvancedSearch->SearchValue = @$filter["x_PaperSize"];
        $this->PaperSize->AdvancedSearch->SearchOperator = @$filter["z_PaperSize"];
        $this->PaperSize->AdvancedSearch->SearchCondition = @$filter["v_PaperSize"];
        $this->PaperSize->AdvancedSearch->SearchValue2 = @$filter["y_PaperSize"];
        $this->PaperSize->AdvancedSearch->SearchOperator2 = @$filter["w_PaperSize"];
        $this->PaperSize->AdvancedSearch->save();
        ...
        // Field Duplex
        $this->Duplex->AdvancedSearch->SearchValue = @$filter["x_Duplex"];
        $this->Duplex->AdvancedSearch->SearchOperator = @$filter["z_Duplex"];
        $this->Duplex->AdvancedSearch->SearchCondition = @$filter["v_Duplex"];
        $this->Duplex->AdvancedSearch->SearchValue2 = @$filter["y_Duplex"];
        $this->Duplex->AdvancedSearch->SearchOperator2 = @$filter["w_Duplex"];
        $this->Duplex->AdvancedSearch->save();

        // Field Grayscale
        $this->Grayscale->AdvancedSearch->SearchValue = @$filter["x_Grayscale"];
        $this->Grayscale->AdvancedSearch->SearchOperator = @$filter["z_Grayscale"];
        $this->Grayscale->AdvancedSearch->SearchCondition = @$filter["v_Grayscale"];
        $this->Grayscale->AdvancedSearch->SearchValue2 = @$filter["y_Grayscale"];
        $this->Grayscale->AdvancedSearch->SearchOperator2 = @$filter["w_Grayscale"];
        $this->Grayscale->AdvancedSearch->save();
    ...
    {
        $where = "";
        $this->buildBasicSearchSql($where, $this->Time, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->User, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->Printer, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->DocumentName, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->Client, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->PaperSize, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->_Language, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->Height, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->Width, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->Duplex, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->Grayscale, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Pages); // Pages
            $this->updateSort($this->Copies); // Copies
            $this->updateSort($this->Printer); // Printer
            $this->updateSort($this->DocumentName); // Document Name
            $this->updateSort($this->Client); // Client
            $this->updateSort($this->PaperSize); // Paper Size
            $this->updateSort($this->_Language); // Language
            $this->updateSort($this->Height); // Height
            $this->updateSort($this->Width); // Width
            $this->updateSort($this->Duplex); // Duplex
            $this->updateSort($this->Grayscale); // Grayscale
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->Pages->setSort("");
                $this->Copies->setSort("");
                $this->Printer->setSort("");
                $this->DocumentName->setSort("");
                $this->Client->setSort("");
                $this->PaperSize->setSort("");
                $this->_Language->setSort("");
                $this->Height->setSort("");
                $this->Width->setSort("");
                $this->Duplex->setSort("");
                $this->Grayscale->setSort("");
                $this->Size->setSort("");
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fprint_logslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fprint_logslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fprint_logslist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fprint_logslistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
