 ...
 * Page class
 */
class NutritionClassView extends NutritionClass
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NutritionClassView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "NutritionClassList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NutritionClassList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "NutritionClassList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
