 ...
 * Page class
 */
class NutritionClassEdit extends NutritionClass
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NutritionClassEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // student_id
            $this->student_id->setDbValueDef($rsnew, $this->student_id->CurrentValue, null, $this->student_id->ReadOnly);

            // phone_number
            $this->phone_number->setDbValueDef($rsnew, $this->phone_number->CurrentValue, "", $this->phone_number->ReadOnly);

            // payment_option
            $this->payment_option->setDbValueDef($rsnew, $this->payment_option->CurrentValue, "", $this->payment_option->ReadOnly);

            // class_name
            $this->class_name->setDbValueDef($rsnew, $this->class_name->CurrentValue, "", $this->class_name->ReadOnly);

            // class_time
            $this->class_time->setDbValueDef($rsnew, $this->class_time->CurrentValue, null, $this->class_time->ReadOnly);
