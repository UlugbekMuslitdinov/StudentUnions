 ...
 * Page class
 */
class PosAccessRequestsDelete extends PosAccessRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PosAccessRequestsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PosAccessRequestsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PosAccessRequestsList"); // Return to list
                return;
            }
        }
