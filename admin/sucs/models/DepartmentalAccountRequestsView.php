 ...
 * Page class
 */
class DepartmentalAccountRequestsView extends DepartmentalAccountRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DepartmentalAccountRequestsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "DepartmentalAccountRequestsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DepartmentalAccountRequestsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "DepartmentalAccountRequestsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
