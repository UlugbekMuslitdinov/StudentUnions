 ...
 * Page class
 */
class BuildingAccessRequestAccessAdd extends BuildingAccessRequestAccess
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuildingAccessRequestAccessAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("BuildingAccessRequestAccessList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "BuildingAccessRequestAccessList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "BuildingAccessRequestAccessView") {
