 ...
 * Page class
 */
class NutritionClassDelete extends NutritionClass
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NutritionClassDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NutritionClassList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("NutritionClassList"); // Return to list
                return;
            }
        }
