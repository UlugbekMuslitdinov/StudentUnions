 ...
 * Page class
 */
class BuildingAccessRequestsEdit extends BuildingAccessRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuildingAccessRequestsEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // form_type
            $this->form_type->setDbValueDef($rsnew, $this->form_type->CurrentValue, "", $this->form_type->ReadOnly);
            ...
            // pin
            $this->pin->setDbValueDef($rsnew, $this->pin->CurrentValue, null, $this->pin->ReadOnly);
            ...
            // other_areas
            $this->other_areas->setDbValueDef($rsnew, $this->other_areas->CurrentValue, null, $this->other_areas->ReadOnly);
            ...
            $this->alarm_access->setDbValueDef($rsnew, $tmpBool, null, $this->alarm_access->ReadOnly);

            // alarm_area
            $this->alarm_area->setDbValueDef($rsnew, $this->alarm_area->CurrentValue, null, $this->alarm_area->ReadOnly);

            // alarm_password
            $this->alarm_password->setDbValueDef($rsnew, $this->alarm_password->CurrentValue, null, $this->alarm_password->ReadOnly);

            // replacement_catcard
            $this->replacement_catcard->setDbValueDef($rsnew, $this->replacement_catcard->CurrentValue, null, $this->replacement_catcard->ReadOnly);

            // replacement_other
            $this->replacement_other->setDbValueDef($rsnew, $this->replacement_other->CurrentValue, null, $this->replacement_other->ReadOnly);

            // replacement_problem
            $this->replacement_problem->setDbValueDef($rsnew, $this->replacement_problem->CurrentValue, null, $this->replacement_problem->ReadOnly);
            ...
            // net_id
            $this->net_id->setDbValueDef($rsnew, $this->net_id->CurrentValue, null, $this->net_id->ReadOnly);
