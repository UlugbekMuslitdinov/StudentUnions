 ...
 * Page class
 */
class ComputerAccessRequestsView extends ComputerAccessRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ComputerAccessRequestsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ComputerAccessRequestsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ComputerAccessRequestsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "ComputerAccessRequestsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
