 ...
 * Page class
 */
class DepartmentalAccessRequestsAdd extends DepartmentalAccessRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DepartmentalAccessRequestsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "DepartmentalAccessRequestsView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->new_catwork->CurrentValue = 0;
    ...
    protected function newRow()
    {
        ...
        $row['new_catwork'] = $this->new_catwork->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        $this->new_catwork->setDbValueDef($rsnew, $tmpBool, null, strval($this->new_catwork->CurrentValue) == "");
