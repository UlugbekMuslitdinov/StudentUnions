 ...
 * Page class
 */
class WorkstationAccessRequestsView extends WorkstationAccessRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WorkstationAccessRequestsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "WorkstationAccessRequestsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "WorkstationAccessRequestsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "WorkstationAccessRequestsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
