...
/**
 * Table class for workstation_access_requests
 */
class WorkstationAccessRequests extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'workstation_access_requests';
        $this->TableName = 'workstation_access_requests';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`workstation_access_requests`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_id', 'id', '`id`', '`id`', 19, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // supervisor_name
        $this->supervisor_name = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_supervisor_name', 'supervisor_name', '`supervisor_name`', '`supervisor_name`', 200, 80, -1, false, '`supervisor_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // supervisor_phone
        $this->supervisor_phone = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_supervisor_phone', 'supervisor_phone', '`supervisor_phone`', '`supervisor_phone`', 200, 20, -1, false, '`supervisor_phone`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // request_type
        $this->request_type = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_request_type', 'request_type', '`request_type`', '`request_type`', 200, 20, -1, false, '`request_type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // employee_position
        $this->employee_position = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_employee_position', 'employee_position', '`employee_position`', '`employee_position`', 200, 20, -1, false, '`employee_position`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // employee_first_name
        $this->employee_first_name = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_employee_first_name', 'employee_first_name', '`employee_first_name`', '`employee_first_name`', 200, 45, -1, false, '`employee_first_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // employee_last_name
        $this->employee_last_name = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_employee_last_name', 'employee_last_name', '`employee_last_name`', '`employee_last_name`', 200, 45, -1, false, '`employee_last_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // employee_title
        $this->employee_title = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_employee_title', 'employee_title', '`employee_title`', '`employee_title`', 200, 80, -1, false, '`employee_title`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // employee_email
        $this->employee_email = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_employee_email', 'employee_email', '`employee_email`', '`employee_email`', 200, 80, -1, false, '`employee_email`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // employee_phone
        $this->employee_phone = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_employee_phone', 'employee_phone', '`employee_phone`', '`employee_phone`', 200, 20, -1, false, '`employee_phone`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // employee_unit
        $this->employee_unit = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_employee_unit', 'employee_unit', '`employee_unit`', '`employee_unit`', 200, 60, -1, false, '`employee_unit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // employee_netid
        $this->employee_netid = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_employee_netid', 'employee_netid', '`employee_netid`', '`employee_netid`', 200, 60, -1, false, '`employee_netid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // workstation_tag
        $this->workstation_tag = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_workstation_tag', 'workstation_tag', '`workstation_tag`', '`workstation_tag`', 200, 140, -1, false, '`workstation_tag`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->workstation_tag->Nullable = false; // NOT NULL field
        $this->workstation_tag->Required = true; // Required field
        $this->workstation_tag->Sortable = true; // Allow sort
        $this->workstation_tag->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->workstation_tag->Param, "CustomMsg");
        $this->Fields['workstation_tag'] = &$this->workstation_tag;

        // access
        $this->access = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_access', 'access', '`access`', '`access`', 3, 2, -1, false, '`access`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // foodpro_location
        $this->foodpro_location = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_foodpro_location', 'foodpro_location', '`foodpro_location`', '`foodpro_location`', 200, 45, -1, false, '`foodpro_location`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // updates
        $this->updates = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_updates', 'updates', '`updates`', '`updates`', 3, 2, -1, false, '`updates`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // comments
        $this->comments = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_comments', 'comments', '`comments`', '`comments`', 200, 250, -1, false, '`comments`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // timestamp
        $this->timestamp = new DbField('workstation_access_requests', 'workstation_access_requests', 'x_timestamp', 'timestamp', '`timestamp`', CastDateFieldForLike("`timestamp`", 0, "DB"), 135, 19, 0, false, '`timestamp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`workstation_access_requests`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->workstation_tag->DbValue = $row['workstation_tag'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("WorkstationAccessRequestsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "WorkstationAccessRequestsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "WorkstationAccessRequestsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "WorkstationAccessRequestsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "WorkstationAccessRequestsView";
            case Config("API_ADD_ACTION"):
                return "WorkstationAccessRequestsAdd";
            case Config("API_EDIT_ACTION"):
                return "WorkstationAccessRequestsEdit";
            case Config("API_DELETE_ACTION"):
                return "WorkstationAccessRequestsDelete";
            case Config("API_LIST_ACTION"):
                return "WorkstationAccessRequestsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("WorkstationAccessRequestsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("WorkstationAccessRequestsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "WorkstationAccessRequestsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "WorkstationAccessRequestsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("WorkstationAccessRequestsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("WorkstationAccessRequestsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("WorkstationAccessRequestsDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        // workstation_tag
        $this->workstation_tag->EditAttrs["class"] = "form-control";
        $this->workstation_tag->EditCustomAttributes = "";
        if (!$this->workstation_tag->Raw) {
            $this->workstation_tag->CurrentValue = HtmlDecode($this->workstation_tag->CurrentValue);
        }
        $this->workstation_tag->EditValue = $this->workstation_tag->CurrentValue;
        $this->workstation_tag->PlaceHolder = RemoveHtml($this->workstation_tag->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->workstation_tag);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->workstation_tag);
