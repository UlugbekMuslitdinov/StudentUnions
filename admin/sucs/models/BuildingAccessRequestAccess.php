...
/**
 * Table class for building_access_request_access
 */
class BuildingAccessRequestAccess extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'building_access_request_access';
        $this->TableName = 'building_access_request_access';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`building_access_request_access`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('building_access_request_access', 'building_access_request_access', 'x_id', 'id', '`id`', '`id`', 19, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // request_id
        $this->request_id = new DbField('building_access_request_access', 'building_access_request_access', 'x_request_id', 'request_id', '`request_id`', '`request_id`', 19, 11, -1, false, '`request_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // location_id
        $this->location_id = new DbField('building_access_request_access', 'building_access_request_access', 'x_location_id', 'location_id', '`location_id`', '`location_id`', 19, 11, -1, false, '`location_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`building_access_request_access`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BuildingAccessRequestAccessList");
    }
    ...
    {
        global $Language;
        if ($pageName == "BuildingAccessRequestAccessView") {
            return $Language->phrase("View");
        } elseif ($pageName == "BuildingAccessRequestAccessEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "BuildingAccessRequestAccessAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "BuildingAccessRequestAccessView";
            case Config("API_ADD_ACTION"):
                return "BuildingAccessRequestAccessAdd";
            case Config("API_EDIT_ACTION"):
                return "BuildingAccessRequestAccessEdit";
            case Config("API_DELETE_ACTION"):
                return "BuildingAccessRequestAccessDelete";
            case Config("API_LIST_ACTION"):
                return "BuildingAccessRequestAccessList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BuildingAccessRequestAccessView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BuildingAccessRequestAccessView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "BuildingAccessRequestAccessAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "BuildingAccessRequestAccessAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BuildingAccessRequestAccessEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BuildingAccessRequestAccessAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("BuildingAccessRequestAccessDelete", $this->getUrlParm());
    }
