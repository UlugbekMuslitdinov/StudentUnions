 ...
 * Page class
 */
class BuildingAccessRequestsView extends BuildingAccessRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BuildingAccessRequestsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "BuildingAccessRequestsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "BuildingAccessRequestsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "BuildingAccessRequestsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
