...
class UsersEdit extends Users
{
    ...
    protected function editRow()
    {
        ...
        $conn = $this->getConnection();
        if ($this->netID->CurrentValue != "") { // Check field with unique index
            $filterChk = "(`netID` = '" . AdjustSql($this->netID->CurrentValue, $this->Dbid) . "')";
            ...
            if ($rsChk->fetch()) {
                $idxErrMsg = str_replace("%f", $this->netID->caption(), $Language->phrase("DupIndex"));
                $idxErrMsg = str_replace("%v", $this->netID->CurrentValue, $idxErrMsg);
