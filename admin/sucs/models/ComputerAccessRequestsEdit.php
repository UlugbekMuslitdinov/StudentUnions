 ...
 * Page class
 */
class ComputerAccessRequestsEdit extends ComputerAccessRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ComputerAccessRequestsEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // employee_type
            $this->employee_type->setDbValueDef($rsnew, $this->employee_type->CurrentValue, "", $this->employee_type->ReadOnly);
