...
/**
 * Table class for nutrition_class
 */
class NutritionClass extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'nutrition_class';
        $this->TableName = 'nutrition_class';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`nutrition_class`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('nutrition_class', 'nutrition_class', 'x_id', 'id', '`id`', '`id`', 19, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // first_name
        $this->first_name = new DbField('nutrition_class', 'nutrition_class', 'x_first_name', 'first_name', '`first_name`', '`first_name`', 200, 45, -1, false, '`first_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // last_name
        $this->last_name = new DbField('nutrition_class', 'nutrition_class', 'x_last_name', 'last_name', '`last_name`', '`last_name`', 200, 45, -1, false, '`last_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // email
        $this->_email = new DbField('nutrition_class', 'nutrition_class', 'x__email', 'email', '`email`', '`email`', 200, 45, -1, false, '`email`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // student_id
        $this->student_id = new DbField('nutrition_class', 'nutrition_class', 'x_student_id', 'student_id', '`student_id`', '`student_id`', 200, 45, -1, false, '`student_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->student_id->Sortable = true; // Allow sort
        $this->student_id->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->student_id->Param, "CustomMsg");
        $this->Fields['student_id'] = &$this->student_id;

        // phone_number
        $this->phone_number = new DbField('nutrition_class', 'nutrition_class', 'x_phone_number', 'phone_number', '`phone_number`', '`phone_number`', 200, 45, -1, false, '`phone_number`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // payment_option
        $this->payment_option = new DbField('nutrition_class', 'nutrition_class', 'x_payment_option', 'payment_option', '`payment_option`', '`payment_option`', 200, 45, -1, false, '`payment_option`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->payment_option->Nullable = false; // NOT NULL field
        $this->payment_option->Required = true; // Required field
        $this->payment_option->Sortable = true; // Allow sort
        $this->payment_option->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->payment_option->Param, "CustomMsg");
        $this->Fields['payment_option'] = &$this->payment_option;

        // class_name
        $this->class_name = new DbField('nutrition_class', 'nutrition_class', 'x_class_name', 'class_name', '`class_name`', '`class_name`', 200, 45, -1, false, '`class_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->class_name->Nullable = false; // NOT NULL field
        $this->class_name->Required = true; // Required field
        $this->class_name->Sortable = true; // Allow sort
        $this->class_name->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->class_name->Param, "CustomMsg");
        $this->Fields['class_name'] = &$this->class_name;

        // class_time
        $this->class_time = new DbField('nutrition_class', 'nutrition_class', 'x_class_time', 'class_time', '`class_time`', '`class_time`', 200, 45, -1, false, '`class_time`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->class_time->Sortable = true; // Allow sort
        $this->class_time->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->class_time->Param, "CustomMsg");
        $this->Fields['class_time'] = &$this->class_time;

        // timestamp
        $this->timestamp = new DbField('nutrition_class', 'nutrition_class', 'x_timestamp', 'timestamp', '`timestamp`', CastDateFieldForLike("`timestamp`", 0, "DB"), 135, 19, 0, false, '`timestamp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`nutrition_class`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->payment_option->DbValue = $row['payment_option'];
        $this->class_name->DbValue = $row['class_name'];
        $this->class_time->DbValue = $row['class_time'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("NutritionClassList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "NutritionClassEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "NutritionClassAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "NutritionClassView";
            case Config("API_ADD_ACTION"):
                return "NutritionClassAdd";
            case Config("API_EDIT_ACTION"):
                return "NutritionClassEdit";
            case Config("API_DELETE_ACTION"):
                return "NutritionClassDelete";
            case Config("API_LIST_ACTION"):
                return "NutritionClassList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("NutritionClassView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("NutritionClassView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "NutritionClassAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "NutritionClassAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NutritionClassEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NutritionClassAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("NutritionClassDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->payment_option->EditValue = $this->payment_option->CurrentValue;
        ...
        $this->class_name->EditValue = $this->class_name->CurrentValue;
        ...
        $this->class_time->EditValue = $this->class_time->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->student_id);
                    $doc->exportCaption($this->phone_number);
                    $doc->exportCaption($this->payment_option);
                    $doc->exportCaption($this->class_name);
                    $doc->exportCaption($this->class_time);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->student_id);
                        $doc->exportField($this->phone_number);
                        $doc->exportField($this->payment_option);
                        $doc->exportField($this->class_name);
                        $doc->exportField($this->class_time);
