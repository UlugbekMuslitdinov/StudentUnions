...
// Page object
$WorkstationAccessRequestsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fworkstation_access_requestsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fworkstation_access_requestsadd = currentForm = new ew.Form("fworkstation_access_requestsadd", "add");
    ...
    fworkstation_access_requestsadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fworkstation_access_requestsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fworkstation_access_requestsadd.validate = function () {
    ...
    // Form_CustomValidate
    fworkstation_access_requestsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fworkstation_access_requestsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fworkstation_access_requestsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fworkstation_access_requestsadd" id="fworkstation_access_requestsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fworkstation_access_requestsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fworkstation_access_requestsadd", "x_timestamp", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
