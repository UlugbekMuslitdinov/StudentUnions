...
// Page object
$PosAccessRequestsView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fpos_access_requestsview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fpos_access_requestsview = currentForm = new ew.Form("fpos_access_requestsview", "view");
    loadjs.done("fpos_access_requestsview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpos_access_requestsview" id="fpos_access_requestsview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->supervisor_name->Visible) { // supervisor_name ?>
    <tr id="r_supervisor_name">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_supervisor_name"><?= $Page->supervisor_name->caption() ?></span></td>
...
<?php if ($Page->supervisor_phone->Visible) { // supervisor_phone ?>
    <tr id="r_supervisor_phone">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_supervisor_phone"><?= $Page->supervisor_phone->caption() ?></span></td>
...
<?php if ($Page->request_type->Visible) { // request_type ?>
    <tr id="r_request_type">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_request_type"><?= $Page->request_type->caption() ?></span></td>
...
<?php if ($Page->employee_position->Visible) { // employee_position ?>
    <tr id="r_employee_position">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_employee_position"><?= $Page->employee_position->caption() ?></span></td>
...
<?php if ($Page->employee_first_name->Visible) { // employee_first_name ?>
    <tr id="r_employee_first_name">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_employee_first_name"><?= $Page->employee_first_name->caption() ?></span></td>
...
<?php if ($Page->employee_last_name->Visible) { // employee_last_name ?>
    <tr id="r_employee_last_name">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_employee_last_name"><?= $Page->employee_last_name->caption() ?></span></td>
...
<?php if ($Page->employee_title->Visible) { // employee_title ?>
    <tr id="r_employee_title">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_employee_title"><?= $Page->employee_title->caption() ?></span></td>
...
<?php if ($Page->employee_email->Visible) { // employee_email ?>
    <tr id="r_employee_email">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_employee_email"><?= $Page->employee_email->caption() ?></span></td>
...
<?php if ($Page->employee_phone->Visible) { // employee_phone ?>
    <tr id="r_employee_phone">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_employee_phone"><?= $Page->employee_phone->caption() ?></span></td>
...
<?php if ($Page->employee_unit->Visible) { // employee_unit ?>
    <tr id="r_employee_unit">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_employee_unit"><?= $Page->employee_unit->caption() ?></span></td>
...
<?php if ($Page->employee_netid->Visible) { // employee_netid ?>
    <tr id="r_employee_netid">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_employee_netid"><?= $Page->employee_netid->caption() ?></span></td>
...
<?php if ($Page->employee_id->Visible) { // employee_id ?>
    <tr id="r_employee_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_employee_id"><?= $Page->employee_id->caption() ?></span></td>
...
<?php if ($Page->access->Visible) { // access ?>
    <tr id="r_access">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_access"><?= $Page->access->caption() ?></span></td>
...
<?php if ($Page->catcard->Visible) { // catcard ?>
    <tr id="r_catcard">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_catcard"><?= $Page->catcard->caption() ?></span></td>
...
<?php if ($Page->register_pin->Visible) { // register_pin ?>
    <tr id="r_register_pin">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_register_pin"><?= $Page->register_pin->caption() ?></span></td>
...
<?php if ($Page->updates->Visible) { // updates ?>
    <tr id="r_updates">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_updates"><?= $Page->updates->caption() ?></span></td>
...
<?php if ($Page->comments->Visible) { // comments ?>
    <tr id="r_comments">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_comments"><?= $Page->comments->caption() ?></span></td>
...
<?php if ($Page->timestamp->Visible) { // timestamp ?>
    <tr id="r_timestamp">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pos_access_requests_timestamp"><?= $Page->timestamp->caption() ?></span></td>
