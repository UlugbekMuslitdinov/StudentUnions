...
// Page object
$DepartmentalAccountRequestsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fdepartmental_account_requestsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fdepartmental_account_requestsadd = currentForm = new ew.Form("fdepartmental_account_requestsadd", "add");
    ...
    fdepartmental_account_requestsadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fdepartmental_account_requestsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fdepartmental_account_requestsadd.validate = function () {
    ...
    // Form_CustomValidate
    fdepartmental_account_requestsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fdepartmental_account_requestsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fdepartmental_account_requestsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fdepartmental_account_requestsadd" id="fdepartmental_account_requestsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fdepartmental_account_requestsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fdepartmental_account_requestsadd", "x_timestamp", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
