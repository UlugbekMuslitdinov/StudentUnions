...
loadjs.ready("head", function () {
    ...
    fweb_supportadd = currentForm = new ew.Form("fweb_supportadd", "add");
    ...
    // Validate form
    fweb_supportadd.validate = function () {
    ...
    // Form_CustomValidate
    fweb_supportadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fweb_supportadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fweb_supportadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fweb_supportadd" id="fweb_supportadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fweb_supportadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fweb_supportadd", "x_timestamp", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
