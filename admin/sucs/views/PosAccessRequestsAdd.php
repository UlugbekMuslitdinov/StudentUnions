...
// Page object
$PosAccessRequestsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpos_access_requestsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fpos_access_requestsadd = currentForm = new ew.Form("fpos_access_requestsadd", "add");
    ...
    fpos_access_requestsadd.addFields([
    ...
    // Validate form
    fpos_access_requestsadd.validate = function () {
    ...
    // Form_CustomValidate
    fpos_access_requestsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpos_access_requestsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fpos_access_requestsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpos_access_requestsadd" id="fpos_access_requestsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fpos_access_requestsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpos_access_requestsadd", "x_timestamp", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
