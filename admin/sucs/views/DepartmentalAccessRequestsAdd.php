...
// Page object
$DepartmentalAccessRequestsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fdepartmental_access_requestsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fdepartmental_access_requestsadd = currentForm = new ew.Form("fdepartmental_access_requestsadd", "add");
    ...
    fdepartmental_access_requestsadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fdepartmental_access_requestsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fdepartmental_access_requestsadd.validate = function () {
    ...
    // Form_CustomValidate
    fdepartmental_access_requestsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fdepartmental_access_requestsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fdepartmental_access_requestsadd.lists.new_catwork = <?= $Page->new_catwork->toClientList($Page) ?>;
    fdepartmental_access_requestsadd.lists.delete = <?= $Page->delete->toClientList($Page) ?>;
    loadjs.done("fdepartmental_access_requestsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fdepartmental_access_requestsadd" id="fdepartmental_access_requestsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->new_catwork->isInvalidClass() ?>" data-table="departmental_access_requests" data-field="x_new_catwork" name="x_new_catwork[]" id="x_new_catwork_929896" value="1"<?= ConvertToBool($Page->new_catwork->CurrentValue) ? " checked" : "" ?><?= $Page->new_catwork->editAttributes() ?> aria-describedby="x_new_catwork_help">
    <label class="custom-control-label" for="x_new_catwork_929896"></label>
</div>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->delete->isInvalidClass() ?>" data-table="departmental_access_requests" data-field="x_delete" name="x_delete[]" id="x_delete_363797" value="1"<?= ConvertToBool($Page->delete->CurrentValue) ? " checked" : "" ?><?= $Page->delete->editAttributes() ?> aria-describedby="x_delete_help">
    <label class="custom-control-label" for="x_delete_363797"></label>
</div>
...
<script>
loadjs.ready(["fdepartmental_access_requestsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fdepartmental_access_requestsadd", "x_timestamp", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
