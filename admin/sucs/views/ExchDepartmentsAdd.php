...
// Page object
$ExchDepartmentsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fexch_departmentsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fexch_departmentsadd = currentForm = new ew.Form("fexch_departmentsadd", "add");
    ...
    fexch_departmentsadd.addFields([
        ["name", [fields.name.visible && fields.name.required ? ew.Validators.required(fields.name.caption) : null], fields.name.isInvalid]
    ]);

    // Set invalid fields
    $(function() {
        var f = fexch_departmentsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fexch_departmentsadd.validate = function () {
    ...
    // Form_CustomValidate
    fexch_departmentsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fexch_departmentsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fexch_departmentsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fexch_departmentsadd" id="fexch_departmentsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
