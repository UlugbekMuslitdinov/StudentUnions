...
// Page object
$WebSupportFilesAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fweb_support_filesadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fweb_support_filesadd = currentForm = new ew.Form("fweb_support_filesadd", "add");
    ...
    fweb_support_filesadd.addFields([
    ...
    // Validate form
    fweb_support_filesadd.validate = function () {
    ...
    // Form_CustomValidate
    fweb_support_filesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fweb_support_filesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fweb_support_filesadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fweb_support_filesadd" id="fweb_support_filesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
