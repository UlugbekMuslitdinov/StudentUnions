...
// Page object
$ComputerAccessRequestsEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fcomputer_access_requestsedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fcomputer_access_requestsedit = currentForm = new ew.Form("fcomputer_access_requestsedit", "edit");
    ...
    fcomputer_access_requestsedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fcomputer_access_requestsedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fcomputer_access_requestsedit.validate = function () {
    ...
    // Form_CustomValidate
    fcomputer_access_requestsedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcomputer_access_requestsedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcomputer_access_requestsedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcomputer_access_requestsedit" id="fcomputer_access_requestsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_computer_access_requests_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_computer_access_requests_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="computer_access_requests" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fcomputer_access_requestsedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fcomputer_access_requestsedit", "x_timestamp", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
