...
// Page object
$DepartmentalAccessRequestAccountAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fdepartmental_access_request_accountadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fdepartmental_access_request_accountadd = currentForm = new ew.Form("fdepartmental_access_request_accountadd", "add");
    ...
    fdepartmental_access_request_accountadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fdepartmental_access_request_accountadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fdepartmental_access_request_accountadd.validate = function () {
    ...
    // Form_CustomValidate
    fdepartmental_access_request_accountadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fdepartmental_access_request_accountadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fdepartmental_access_request_accountadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fdepartmental_access_request_accountadd" id="fdepartmental_access_request_accountadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
