...
// Page object
$BuildingAccessRequestsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fbuilding_access_requestsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fbuilding_access_requestsadd = currentForm = new ew.Form("fbuilding_access_requestsadd", "add");
    ...
    fbuilding_access_requestsadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fbuilding_access_requestsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fbuilding_access_requestsadd.validate = function () {
    ...
    // Form_CustomValidate
    fbuilding_access_requestsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fbuilding_access_requestsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fbuilding_access_requestsadd.lists.alarm_access = <?= $Page->alarm_access->toClientList($Page) ?>;
    fbuilding_access_requestsadd.lists.delete = <?= $Page->delete->toClientList($Page) ?>;
    loadjs.done("fbuilding_access_requestsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fbuilding_access_requestsadd" id="fbuilding_access_requestsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->delete->isInvalidClass() ?>" data-table="building_access_requests" data-field="x_delete" name="x_delete[]" id="x_delete_309028" value="1"<?= ConvertToBool($Page->delete->CurrentValue) ? " checked" : "" ?><?= $Page->delete->editAttributes() ?> aria-describedby="x_delete_help">
    <label class="custom-control-label" for="x_delete_309028"></label>
</div>
...
<script>
loadjs.ready(["fbuilding_access_requestsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fbuilding_access_requestsadd", "x_timestamp", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
