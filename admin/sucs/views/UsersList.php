...
<?php if ($Page->user_id->Visible) { // user_id ?>
        <th data-name="user_id" class="<?= $Page->user_id->headerCellClass() ?>"><div id="elh_users_user_id" class="users_user_id"><?= $Page->renderSort($Page->user_id) ?></div></th>
<?php } ?>
<?php if ($Page->netID->Visible) { // netID ?>
        <th data-name="netID" class="<?= $Page->netID->headerCellClass() ?>"><div id="elh_users_netID" class="users_netID"><?= $Page->renderSort($Page->netID) ?></div></th>
<?php } ?>
<?php if ($Page->first_name->Visible) { // first_name ?>
        <th data-name="first_name" class="<?= $Page->first_name->headerCellClass() ?>"><div id="elh_users_first_name" class="users_first_name"><?= $Page->renderSort($Page->first_name) ?></div></th>
<?php } ?>
<?php if ($Page->last_name->Visible) { // last_name ?>
        <th data-name="last_name" class="<?= $Page->last_name->headerCellClass() ?>"><div id="elh_users_last_name" class="users_last_name"><?= $Page->renderSort($Page->last_name) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_users_user_id">
...
<span id="el<?= $Page->RowCount ?>_users_netID">
...
<span id="el<?= $Page->RowCount ?>_users_first_name">
...
<span id="el<?= $Page->RowCount ?>_users_last_name">
