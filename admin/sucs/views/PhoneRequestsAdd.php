...
// Page object
$PhoneRequestsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fphone_requestsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fphone_requestsadd = currentForm = new ew.Form("fphone_requestsadd", "add");
    ...
    // Validate form
    fphone_requestsadd.validate = function () {
    ...
    // Form_CustomValidate
    fphone_requestsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fphone_requestsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fphone_requestsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fphone_requestsadd" id="fphone_requestsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fphone_requestsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fphone_requestsadd", "x_timestamp", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
