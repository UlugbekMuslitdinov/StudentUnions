...
loadjs.ready("head", function () {
    ...
    fresourcesadd = currentForm = new ew.Form("fresourcesadd", "add");
    ...
    // Validate form
    fresourcesadd.validate = function () {
    ...
    // Form_CustomValidate
    fresourcesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fresourcesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fresourcesadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fresourcesadd" id="fresourcesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
