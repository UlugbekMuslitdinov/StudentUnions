...
<h2>Preview <em style="color:green;">Pasta/Stir-Fry</em> Menu</h2>
...
<h3 style="margin-bottom:0; margin-top:15px;">Starch</h3>
<?php 
...
if (!$display) {
	echo '<p><span style="color:#ff0000;">No starches to display.</span><br />
	The "Starch" header and this message will be hidden on the live menu.</p>';
}
?>
...
<h3 style="margin-bottom:0;">Protein</h3>
<?php 
...
if (!$display) {
	echo '<p><span style="color:#ff0000;">No proteins to display.</span><br />
	The "Protein" header and this message will be hidden on the live menu.</p>';
}
?>

<h3 style="margin-bottom:0; margin-top:15px;">Sauce</h3>
<?php 
...
if (!$display) {
	echo '<p><span style="color:#ff0000;">No sauces to display.</span><br />
	The "Sauce" header and this message will be hidden on the live menu.</p>';
}
?>
<br />
<form>
