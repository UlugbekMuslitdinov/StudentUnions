...
<title>Bear Down Kitchen Menu System</title>
...
<?php
	...
	echo '<p style="padding-top:5px; text-align:center;"><a href="/dining/menu_central.php">Back to Menu Central</a> | <a href="'.create_logout_link("Return%20to%20Menu%20Central").'">Logout of UA NetID WebAuth</a></p>';
...
if (!$grantAccess) {
	...
	if (isset($_POST['wk1Status']) && $_POST['wk1Status']) {
	
		// select database
		$db = new db_mysqli("menus_bdk_breakfast");
	
		// query to edit week 1 status
		$db->query("UPDATE week SET 
		status = \"" . $_POST['wk1Status'] . "\"
		WHERE id = 1");

	} else if (isset($_POST['wk2Status']) && $_POST['wk2Status']) {
	...
	} else if (isset($_POST['wk3Status']) && $_POST['wk3Status']) {
	...
	## day 1 ##
	if (isset($_POST['day1Menu']) && $_POST['day1Menu']) {
	
		// select database
		$db = new db_mysqli("menus_bdk_breakfast");
	
		// query to edit day 1 menu
		$db->query("UPDATE day SET
	...
	## day 2 ##
	if (isset($_POST['day2Menu']) && $_POST['day2Menu']) {
	...
	## day 3 ##
	if (isset($_POST['day3Menu']) && $_POST['day3Menu']) {
	...
	## day 4 ##
	if (isset($_POST['day4Menu']) && $_POST['day4Menu']) {
	...
	## day 5 ##
	if (isset($_POST['day5Menu']) && $_POST['day5Menu']) {
	...
	## day 6 ##
	if (isset($_POST['day6Menu']) && $_POST['day6Menu']) {
	...
	## day 7 ##
	if (isset($_POST['day7Menu']) && $_POST['day7Menu']) {
	...
	## day 8 ##
	if (isset($_POST['day8Menu']) && $_POST['day8Menu']) {
	...
	## day 9 ##
	if (isset($_POST['day9Menu']) && $_POST['day9Menu']) {
	...
	## day 10 ##
	if (isset($_POST['day9Menu']) && $_POST['day10Menu']) {
	...
	## day 11 ##
	if (isset($_POST['day11Menu']) && $_POST['day11Menu']) {
	...
	## day 12 ##
	if (isset($_POST['day12Menu']) && $_POST['day12Menu']) {
	...
	## day 13 ##
	if (isset($_POST['day13Menu']) && $_POST['day13Menu']) {
	...
	## day 14 ##
	if (isset($_POST['day14Menu']) && $_POST['day14Menu']) {
	...
	## day 15 ##
	if (isset($_POST['day15Menu']) && $_POST['day15Menu']) {
	...
	## day 16 ##
	if (isset($_POST['day16Menu']) && $_POST['day16Menu']) {
	
		// select database
		$db = new db_mysqli("menus_bdk_breakfast");
	
		// query to edit day 16 menu
		$db->query("UPDATE day SET
		menuID = \"" . $_POST['day16Menu'] . "\"
		WHERE id = 16");

	} // END IF for day menu updates

	## day 17 ##
	if (isset($_POST['day17Menu']) && $_POST['day17Menu']) {
	
		// select database
		$db = new db_mysqli("menus_bdk_breakfast");
	
		// query to edit day 17 menu
		$db->query("UPDATE day SET
		menuID = \"" . $_POST['day17Menu'] . "\"
		WHERE id = 17");

	} // END IF for day menu updates

	## day 18 ##
	if (isset($_POST['day18Menu']) && $_POST['day18Menu']) {
	
		// select database
		$db = new db_mysqli("menus_bdk_breakfast");
	
		// query to edit day 18 menu
		$db->query("UPDATE day SET
		menuID = \"" . $_POST['day18Menu'] . "\"
		WHERE id = 18");
...
<tr>
	<td colspan="7" style="text-align:left;"><p style="padding-bottom:3px;"><strong>Welcome to the Bear Down Kitchen Menu Management System</strong></p>
	<p style="line-height:15px;">Use the calendar grid below to make updates to the 3-week rotating menu. For each day, a total of 20 menus are available for customization, with 18 being 'active' at any given time. You may also 'close' the restaurant on a day-by-day basis, by selecting the "Closed" option from any of the "Change Menu..." pulldowns. Or you may close an entire week (Mon-Fri+Sun) by using the pulldowns in the far left column. If you are unsure of what a particular icon does, hold your cursor over it to view a brief description. Please note that changes made here appear on the live website immediately.</p>
	<div style="float:left;"><h2 style="color:green;">Breakfast Menu</h2></div>
	<div style="float:right;">
	<p style="font-size:14px;"><!--<a href="/dining/menu_bdk/breakfast/admin_menu.php">-->Breakfast<!--</a>--> | <a href="/dining/menu_bdk/grill/admin_menu.php">Grill & Deli</a> | <a href="/dining/menu_bdk/lunch/admin_menu.php">Lunch</a> | <a href="/dining/menu_bdk/pizza/admin_menu.php">Pizza</a> | <a href="/dining/menu_bdk/salad/admin_menu.php">Salad Bar</a> | <a href="/dining/menu_bdk/saute/admin_menu.php">Pasta/Stir-Fry</a></p>
	<ul style="padding:7px 0 0 20px;">
		<li><a href="/dining/sumc/beardownkitchen" target="_blank">View Live Menu</a> | <a href="history.php">View Admin Log</a></li>
	</ul>
	</div>
	</td>
</tr>
<tr bgcolor="#CCCCCC">
	<td style="text-align:center; padding:5px 10px 5px 10px;"><a href="admin_menu.php" title="Refresh: click here if you've changed a menu name but are not seeing the updated name in the calendar grid below"><img src="/dining/menu_bdk/images/refresh.gif" width="25" height="25" align="bottom" /></a></td>
...
<!-- BEGIN DAY 1 -->
	...
	<?php
		if ($menuNameRow['name'] == 'Closed') {
			...
			echo '<br /><a href="javascript:;" onclick="javascript:window.open(\'admin_menu_edit.php?menu=' . $dayRow['menuID'] . '\',\'View\',\'width=725, height=750, scrollbars=yes, resizable=yes, toolbar=yes, location=yes\')"><img src="/dining/menu_bdk/images/edit.gif" width="20" height="22" alt="Edit" title="Edit" /></a>';
			echo '&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;" onclick="javascript:window.open(\'admin_menu_preview.php?menu=' . $dayRow['menuID'] . '\',\'View\',\'width=725, height=750, scrollbars=yes, resizable=yes, toolbar=yes, location=yes\')"><img src="/dining/menu_bdk/images/preview.gif" width="20" height="22" alt="Preview" title="Preview" /></a>';
...
<!-- BEGIN DAY 6 -->
	<td <?php if ($dayOfWk == 'Sunday') { echo ' bgcolor="#d0f5c4"'; } ?>><p style="text-align:right; color:#F60;"><?php echo $sun1; ?><br />&nbsp;<br /></p>
	<form enctype="multipart/form-data" action="<?= $_SERVER['PHP_SELF'] ?>" method="POST">
...
<!-- BEGIN DAY 12 -->
	<td><p style="text-align:right; color:#F60;"><?php echo $sun2; ?><br />&nbsp;<br /></p>
	<form enctype="multipart/form-data" action="<?= $_SERVER['PHP_SELF'] ?>" method="POST">
...
<!-- BEGIN DAY 16 -->
	...
	<form enctype="multipart/form-data" action="<?= $_SERVER['PHP_SELF'] ?>" method="POST">
	<select name="day<?php echo $day16; ?>Menu" onChange="this.form.submit();">
	<?php
...
<!-- BEGIN DAY 17 -->
	...
	<form enctype="multipart/form-data" action="<?= $_SERVER['PHP_SELF'] ?>" method="POST">
	<select name="day<?php echo $day17; ?>Menu" onChange="this.form.submit();">
	<?php
...
<!-- BEGIN DAY 18 -->
	<td><p style="text-align:right; color:#F60;"><?php echo $sun3; ?><br />&nbsp;<br /></p>
	<form enctype="multipart/form-data" action="<?= $_SERVER['PHP_SELF'] ?>" method="POST">
	<select name="day<?php echo $day18; ?>Menu" onChange="this.form.submit();">
	<?php
