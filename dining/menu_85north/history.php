...
if (!$grantAccessAdmin) {
	...
	echo "<p style=\"padding-top:20px; text-align:center;\">You are not on the list of authorized users. Please contact <a href=\"mailto:su-web@email.arizona.edu\">su-web@email.arizona.edu</a> if you need access or have questions.<br />&nbsp;<br />
...
<title>Menu Admin Update Log ~ '85 North Restaurant Menu System</title>
...
<h2><em style="color:green;">'85 North</em> Menu Admin Update Log</h2>
