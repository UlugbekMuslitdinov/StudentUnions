...
<h2>Edit <em style="color:green;">Hot Line Lunch</em> Menu</h2>
<?php
if (!$_POST) {
	echo '<p style="padding-left:10px; color:#ff0000; font-size:9px;">Please note, "Grains" and "Vegetarian" dish types are intentionally disabled. Only "Entr&eacute;es" and "Sides" apply to the Cactus Grill Hot Line Lunch menu.</p>';
}
?>
