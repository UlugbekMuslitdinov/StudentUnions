...
//	echo '<p style="padding-top:20px; text-align:center;"><a href="https://webauth.arizona.edu/webauth/logout?logout_href=http://' . $_SERVER['SERVER_NAME'] . '/dining/menu_pangea/&logout_text=Return%20to%20Pangea Menu">Logout of UA NetID WebAuth</a></p>';
	...
	if (isset($_POST['wk1Status']) && $_POST['wk1Status']) {
		...
		// query to edit week 3 status
		$db->query("UPDATE week SET 
		status = \"" . $_POST['wk3Status'] . "\"
		WHERE id = 3");

	} else if (isset($_POST['wk4Status']) && $_POST['wk4Status']) {

		// select database
		$db = new db_mysqli("menus_cactus_hotline");
			
	
		// query to edit week 4 status
		$db->query("UPDATE week SET 
		status = \"" . $_POST['wk4Status'] . "\"
		WHERE id = 4");
	...
	## day 10 ##
	if (isset($_POST['day10Menu']) && $_POST['day10Menu']) {
	...
	## day 19 ##
	if (isset($_POST['day19Menu']) && $_POST['day19Menu']) {
	
		// select database
		$db = new db_mysqli("menus_cactus_hotline");
			
	
		// query to edit day 19 menu
		$db->query("UPDATE day SET
		menuID = \"" . $_POST['day19Menu'] . "\"
		WHERE id = 19");

	} // END IF for day menu updates

	## day 20 ##
	if (isset($_POST['day20Menu']) && $_POST['day20Menu']) {
	
		// select database
		$db = new db_mysqli("menus_cactus_hotline");
			
	
		// query to edit day 20 menu
		$db->query("UPDATE day SET
		menuID = \"" . $_POST['day20Menu'] . "\"
		WHERE id = 20");
...
<tr>
	<td colspan="6" style="text-align:left;"><p style="padding-bottom:3px;"><strong>Welcome to the Cactus Grill Menu Management System</strong></p>
	<p style="line-height:15px;">Use the calendar grid below to make updates to the 4-week rotating "hot line lunch" menu. For each day, a total of 25 menus are available for customization, with 20 being 'active' at any given time. You may also 'close' the restaurant on a day-by-day basis, by selecting the "Closed" option from any of the "Change Menu..." pulldowns. Or you may close an entire week (Mon-Fri) by using the pulldowns in the far left column. If you are unsure of what a particular icon does, hold your cursor over it to view a brief description. Please note that changes made here appear on the live website immediately.</p>
	<div style="float:left;"><h2 style="color:green;">"Hot Line Lunch" Menu</h2></div>
	<div style="float:right;">
	<p style="font-size:14px;"><!--<a href="/dining/menu_cactus/hotline/admin_menu.php">-->Lunch Menu<!--</a>--> | <a href="/dining/menu_cactus/hotline_dinner/admin_menu.php">Dinner Menu</a></p>
	<ul style="padding:7px 0 0 20px;">
		<li style="padding-bottom:5px;"><a href="/dining/sumc/cactus" target="_blank">View Live Menu</a> | <a href="history.php">View Admin Log</a></li>
		<li>Plate pricing: +<span style="color:red; font-weight:bold;">$<? echo $offsetRow['offset']; ?></span> (<a href="javascript:;" onclick="javascript:winBRopen('offset_edit.php','Plate','450', '200', 'no')">edit</a> | <a href="admin_menu.php">refresh</a>)</li>
	</ul>
	</div>
	</td>
</tr>
<tr bgcolor="#CCCCCC">
	<td style="text-align:center; padding:5px 10px 5px 10px;"><a href="admin_menu.php" title="Refresh: click here if you've changed a menu name but are not seeing the updated name in the calendar grid below"><img src="/dining/menu_cactus/hotline/images/refresh.gif" width="25" height="25" align="bottom" /></a></td>
...
$dayCount = $daysPast % 7;
$weekCount = $weeksPast % 3; ## New Rotation : 
...
<!-- BEGIN DAY 1 -->
	...
	<?php
		if ($menuNameRow['name'] == 'Closed') {
			...
			echo '<br /><a href="javascript:;" onclick="javascript:window.open(\'admin_menu_edit.php?menu=' . $dayRow['menuID'] . '\',\'View\',\'width=725, height=750, scrollbars=yes, resizable=yes, toolbar=yes, location=yes\')"><img src="/dining/menu_cactus/hotline/images/edit.gif" width="20" height="22" alt="Edit" title="Edit" /></a>';
			echo '&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;" onclick="javascript:window.open(\'admin_menu_preview.php?menu=' . $dayRow['menuID'] . '\',\'View\',\'width=725, height=750, scrollbars=yes, resizable=yes, toolbar=yes, location=yes\')"><img src="/dining/menu_cactus/hotline/images/preview.gif" width="20" height="22" alt="Preview" title="Preview" /></a>';
		}
		if ($week1 == 'Closed') {
