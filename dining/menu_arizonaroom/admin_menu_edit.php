...
<title>Edit Menu ~ Arizona Room Menu System</title>
<link rel="stylesheet" type="text/css" href="admin_menu.css" />
</head>

<body>
<h1 style="text-align:center; margin-top:20px;">Arizona Room Menu System</h1>
...
$itemResult = $db->query("SELECT * FROM item WHERE menuID = " . $_GET['menu'] . " AND dishID = " . $soups . " ORDER BY id");
...
<?php
	...
	$result = $db->query("DELETE FROM item WHERE menuID = " . $_GET['id'] . " AND dishID = " . $soups . "");
