...
<title>Menu Admin Update Log ~ Arizona Room Menu System</title>
...
?>
	...
	<div style="padding:10px 20px;">
		...
		while ($eventRow = $event->fetch_assoc()) {
			...
			$eventSoup = $db->query("SELECT * FROM history_event_content WHERE id = '" . $eventRow['id'] . "' AND dishID = " . $soups . " ");
			
			echo '<td class="history"><ol class="historyNums">';
			while ($eventSoupRow = $eventSoup->fetch_assoc()) {
