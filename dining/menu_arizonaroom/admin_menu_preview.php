...
<title>Preview Menu ~ Arizona Room Menu System</title>
...
<h3 style="margin-bottom:0; margin-top:15px;">Desserts</h3>
<?php 
...
if (!$display) {
	...
	The "Desserts" header and this message will be hidden on the live menu.</p>';
}
?>
