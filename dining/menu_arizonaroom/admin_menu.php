...
<title>Arizona Room Menu System</title>
...
<tr>
	<td colspan="6" style="text-align:left;"><p style="padding-bottom:3px;"><strong>Welcome to the Arizona Room Menu Management System</strong></p>
	...
	<p style="text-align:right;"><a href="/dining/sumc/arizonaroom" target="_blank">View Live Menu</a> | <a href="history.php">View Admin Log</a></p></td>
</tr>
<tr bgcolor="#CCCCCC">
	<td style="text-align:center; padding:5px 10px 5px 10px;"><a href="admin_menu.php" title="Refresh: click here if you've changed a menu name but are not seeing the updated name in the calendar grid below"><img src="/dining/menu_arizonaroom/refresh.gif" width="25" height="25" align="bottom" /></a></td>
...
<!-- BEGIN DAY 1 -->
	...
	<?php
		if ($menuNameRow['name'] == 'Closed') {
			...
			echo '<br /><a href="javascript:;" onclick="javascript:window.open(\'admin_menu_edit.php?menu=' . $dayRow['menuID'] . '\',\'View\',\'width=725, height=750, scrollbars=yes, resizable=yes, toolbar=yes, location=yes\')"><img src="/dining/menu_arizonaroom/edit.gif" width="20" height="22" alt="Edit" title="Edit" /></a>';
			echo '&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;" onclick="javascript:window.open(\'admin_menu_preview.php?menu=' . $dayRow['menuID'] . '\',\'View\',\'width=725, height=750, scrollbars=yes, resizable=yes, toolbar=yes, location=yes\')"><img src="/dining/menu_arizonaroom/preview.gif" width="20" height="22" alt="Preview" title="Preview" /></a>';
