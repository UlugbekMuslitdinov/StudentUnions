...
<title>Edit Menu ~ Pangea Restaurant Menu System</title>
...
Yes <input type="radio" value="Yes" name="prices" <? if ($nameRow['prices'] == "Yes") {echo 'checked="checked"';} ?> />&nbsp;&nbsp;&nbsp;&nbsp;No <input type="radio" value="No" name="prices" <? if ($nameRow['prices'] == "No") {echo 'checked="checked"';} ?> /><br />&nbsp;<br />
