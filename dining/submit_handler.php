...
$amount = 30;
if ($_POST['dorm'] == 'Babcock'){$amount = 90;}
...
if ($_POST['payment'] == 'Credit Card'){
    ...
    $creditcard['transaction_type'] = 'authorization';
    ...
    $email_response = send_mail_to_manager($_POST, 'su-sueventplanning@email.arizona.edu');
