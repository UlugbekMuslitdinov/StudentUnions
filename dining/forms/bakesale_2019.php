...
$foods = Array(
	...
	"breads" => Array(
		...
		"choices"	=> Array(
			"banana"	=> "Banana-Nut",
			"chocolate"	=> "Chocolate",
			"orange"	=> "Cranberry-Orange Nut",
			"pumpkin"	=> "Pumpkin",
			"zucchini"	=> "Zucchini Nut"
		)
	),
	"rings" => Array(
		"name"	=> "Danish Rings",
	...
	"bitecookies" => Array(
		"name" => "Bite-Sized Cookies in a 1lb. bag",
		"price" => 4
	),
	"lechecookies" => Array(
		"name" => "Dulce de Leche cookies (short bread cookie with caramel)",
		"price" => 4
	),
	"holidaycookie" => Array(
	...
	"macaroons" => Array(
		"name" => "Coconut Macaroons (Flourless Cookies)",
		"price" => 4
	)
);
...
$date_names = Array(
	...
	"nov-26" => "November 26<sup></sup>",
	"nov-27" => "November 27<sup></sup>"
);
$success = false;
$formerrors = Array();
...
<?php if($success){ ?>
			...
			<div id="bakesale-form">
				...
				<div style="text-align: center;">Go back to the <a href="bakesale.php">Bake Sale Pre-Order From</a> and order some more!</div><br /><br /><br /><br /><br />
				<div class="subheader">
				</div>
			</div>
		</div>
				...
				<div class="row" style="margin-top: 20px;">
					<span id="info-pickup" <?=(isset($formerrors["fields"]["info-pickup"])?"class=\"error\"":"")?>>
						...
						<label>
							...
							<span class="super-block">
								<!-- <sup>MONDAY</sup> -->
								<p class="font-sans-italic"><b>Monday, Nov. 25</b></p>
							</span>
						</label>
						<label style="margin-left: 20px;">								
							<input type="radio" value="nov-26" name="info-pickup" <?=(isset($_POST["info-pickup"])&&$_POST["info-pickup"]=="nov-26"?"checked ":"")?>/>
							<span class="super-block">
								<!-- <sup>TUESDAY</sup> -->
								<p class="font-sans-italic"><b>Tuesday, Nov. 26</b></p>
							</span>
						</label>
						<label style="margin-left: 20px;">							
							<input type="radio" value="nov-27" name="info-pickup" <?=(isset($_POST["info-pickup"])&&$_POST["info-pickup"]=="nov-27"?"checked ":"")?>/>
							<span class="super-block">
								<!-- <sup>WEDNESDAY</sup> -->
								<p class="font-sans-italic"><b>Wednesday, Nov. 27</b></p>
							</span>
						</label>
					</span>
				</div>
...
'					<div class="food-item" onchange="update_single_price(\''.$shortname.'\')">
					...
					<div class="food-item" onchange="update_single_price('pies')" id="food-pies">
						<div class="food-left" style="padding: 0px; border-width: 0px; text-align: center;">
							...
							<p style="margin: 0px; font-size: 19px; color: #886f51; letter-spacing: 0.8;"><em>IDB Account &#9679; Meal Plan Card &#9679; Cash &#9679; All Major Credit Cards Accepted</em></p>
						</div>
						<div style="width: 10px;"></div>
				...
				<div>
					<span class="sh-right" style="padding: 0; width: 100%;">
