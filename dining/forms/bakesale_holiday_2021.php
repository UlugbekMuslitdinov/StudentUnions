...
$foods = Array(
	...
	"breads" => Array(
		...
		"price"		=> 6,
		"choices"	=> Array(
			"banananutbread"	=> "Banana - Bananas and walnuts &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;",
	...
	"danishclaws" => Array(
		...
		"price"		=> 7,
		"choices"	=> Array(
			"almond"	=> "Almond - Almond paste, chopped walnuts, slivered almonds, topped with streusel, baked and glazed",
	...
	"cakes" => Array(
		...
		"choices"	=> Array(
			...
			"bouchenoel"	=> "Bouche Noel - Decorated chocolate Christmas log"
		)
	),
	//"specialty" => Array(
//		"name"	=> "SPECIALTY ITEMS",
...
//	),
	...
	"treats" => Array(
		...
		"choices"	=> Array(
			...
			"gingerbreadcookie"	=> "Decorated Gingerbread Cookie – Hand decorated traditional cookie"
		)
	)
);
...
$date_names = Array(
	"dec-13" => "December 13<sup></sup>",
	"dec-14" => "December 14<sup></sup>",
	"dec-15" => "December 15<sup></sup>",
	"dec-16" => "December 16<sup></sup>"
);
$success = false;
$formerrors = Array();
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	if(empty($formerrors)){
		...
		$success = true;
		$subject = "Holiday Bake Sale  - " . date("F j, Y, g:i a") . "";
	...
	<body>
		<div id="page-container">
			<div class="col-sm-12 tgo-header no-padding">
				<img src="/template/images/banners/holiday_bakesale_banner_2.png" width="950" height="272"><br /><br /><br />
			...
			<form action="" method="post" id="bakesale-form">
				...
				<div class="row" style="margin-top: 20px;">
					<span id="info-pickup" <?=(isset($formerrors["fields"]["info-pickup"])?"class=\"error\"":"")?>>
						...
						<label>
							<input type="radio" value="dec-13" name="info-pickup" <?=(isset($_POST["info-pickup"])&&$_POST["info-pickup"]=="dec-13"?"checked ":"")?>/>	<b>Monday, December 13, 2021 | 10AM - 3pm</b>
						</label><br />
						<label style="margin-top: 30px;">								
							<input type="radio" value="dec-14" name="info-pickup" <?=(isset($_POST["info-pickup"])&&$_POST["info-pickup"]=="dec-14"?"checked ":"")?>/>  <b>Tuesday, December 14, 2021 | 10AM - 3pm</b>
						</label><br />
						<label style="margin-top: 30px;">							
							<input type="radio" value="dec-15" name="info-pickup" <?=(isset($_POST["info-pickup"])&&$_POST["info-pickup"]=="dec-15"?"checked ":"")?>/>  <b>Wednesday, December 15, 2021 | 10AM - 3pm</b>
						</label><br />
						<label style="margin-top: 30px;">							
							<input type="radio" value="dec-16" name="info-pickup" <?=(isset($_POST["info-pickup"])&&$_POST["info-pickup"]=="dec-16"?"checked ":"")?>/>  <b>Thursday, December 16, 2021 | 10AM - 3pm</b>
						</label>
					</span>
				</div>	
				</td>
				...
				<div class="row" style="margin-top: 20px;">
				 ...
				 <div align="left" class="row" style="margin-top: 20px;">
					<span class="super-block">
						<p><span style='padding:3px; background-color:#972e3d; color: white; font-weight:bold; font-size: 16px;'><b>ORDERS MUST BE RECEIVED BY NOON ON 12/15</b></span></p>
					</span>
				</div>	
				</td>
				</tr>
...
'					<div class="food-item" onchange="update_single_price(\''.$shortname.'\')">
				...
				<div class="subheader" style="margin-top: 20px; margin-bottom: 5px;">
				...
				<div class="subheader" style="margin-top: 5px; margin-bottom: 100px;">
					<span class="sh-left" style="width: 100%; font-family: serif; font-weight: 900; font-size:16px; text-align: center; color: #fff; text-transform: uppercase; letter-spacing: 1; font-weight: 900;">
						❮❮❮  <em><b>QUESTIONS? CONTACT EMILY ROMERO -> EMILYR1@ARIZONA.EDU OR 520-621-7038 | 520-363-1618</b></em>  ❯❯❯
					</span>
				</div><br />
			</form>
		</div>
