...
$foods = Array(
	...
	"holidaycookie" => Array(
		"name" => "HOLIDAY COOKIE<br /><span class='item-description'>Assorted hand decorated holiday cookie</span>",
		"price" => 2
	),
	"blockacookie" => Array(
		"name" => "BLOCK A COOKIE<br /><span class='item-description'>Block A cookie</span>",
		"price" => 3.50
	)
);
...
<?php if($success){ 
		header("Location: http://".$_SERVER[HTTP_HOST]."/dining/forms/bakesale.php?confirm=feast");
?>
...
<div id="feast-form">
	...
	<div style="font-size:20px;font-weight:400; color:red" align="center">Thank you for your order!</div>
	<h3 style="text-align: center; color:red">An email has been sent confirming the details of your order.</h3>
	<br /><br /><br />
	<div class="subheader">
	</div>
</div>
			...
			<form action="" method="post" id="bakesale-form">
				...
				<div class="row" style="margin-top: 20px;">
					<span id="info-pickup" <?=(isset($formerrors["fields"]["info-pickup"])?"class=\"error\"":"")?>>
						...
						<label>
							<input type="radio" value="dec-14" name="info-pickup" <?=(isset($_POST["info-pickup"])&&$_POST["info-pickup"]=="dec-14"?"checked ":"")?>/>								
							<span class="super-block">
								<!-- <sup>MONDAY</sup> -->
								<p class="font-sans-italic"><b>Monday, Dec. 14</b><br />10AM - 3PM</p>
							</span>
						</label>
						<label style="margin-left: 20px;">								
							<input type="radio" value="dec-15" name="info-pickup" <?=(isset($_POST["info-pickup"])&&$_POST["info-pickup"]=="dec-15"?"checked ":"")?>/>
							<span class="super-block">
								<!-- <sup>TUESDAY</sup> -->
								<p class="font-sans-italic"><b>Tuesday, Dec. 15</b><br />10AM - 3PM
								</p>
							</span>
						</label>
						<label style="margin-left: 20px;">							
							<input type="radio" value="dec-16" name="info-pickup" <?=(isset($_POST["info-pickup"])&&$_POST["info-pickup"]=="dec-16"?"checked ":"")?>/>
							<span class="super-block">
								<!-- <sup>WEDNESDAY</sup> -->
								<p class="font-sans-italic"><b>Wednesday, Dec. 16</b><br />10AM - 3PM</p>
							</span>
						</label>
					</span>
				</div>
