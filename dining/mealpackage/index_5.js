...
(function main() {
    ...
    window.onload = function () {
        ...
        $('input[type=radio][name=days]').change(function() {
            ...
            else if (this.value == '3day') {
                cost_days = 90;
            }

            var new_total = cost_days + cost_water;

            document.getElementById('order_total').innerHTML = new_total;
            document.getElementById('order_total_2').innerHTML = new_total;
            document.forms['meal_package_form'].order_total_hidden.value = new_total;
...
function formValidation() {
    ...
    var days = document.forms["meal_package_form"]["days"].value;
