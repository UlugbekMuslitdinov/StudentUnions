...
var_dump($transaction_object["response"]); echo '<br>';
...
function encrypt($data){
	...
	// $cipherText = openssl_encrypt($data, 'AES-256-CBC', $key, OPENSSL_RAW_DATA | OPENSSL_ZERO_PADDING, $iv);
...
function decrypt($cipherText){
	...
	// $data = openssl_decrypt($cipherText, 'AES-256-CBC', $key, OPENSSL_RAW_DATA | OPENSSL_ZERO_PADDING, $iv);
