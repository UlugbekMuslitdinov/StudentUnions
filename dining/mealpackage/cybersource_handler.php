...
if($decision == 'ACCEPT')
{
    ...
    $email_response = send_mail_to_manager($order_info, 'su-web@email.arizona.edu');
	// $email_response = send_mail_to_manager($order_info, 'sueventplanning@email.arizona.edu');
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <table rules="all" style="border-color: #666; border: 1px;" cellpadding="3">
															...
															<tr style="background: #eee;"><td><strong>Payment Amount:</strong> </td><td>$' . $data['amount'] . '</td></tr>
