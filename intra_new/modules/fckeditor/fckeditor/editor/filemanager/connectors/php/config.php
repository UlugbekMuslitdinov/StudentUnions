...
//$path = substr($_REQUEST['REQUEST_URI'], strpos($_REQUEST['REQUEST_URI'], 'training')+9);
//$path = substr($path, 0, strpos($path, '/'));
//var_dump($path);
// Path to user files relative to the document root.
//$Config['UserFilesPath'] = 'https://www.union.arizona.edu/intra_new/files/'.$_SESSION['node_unit'].'/';
$Config['UserFilesPath'] = 'https://www.union.arizona.edu/intra_new/files/';

// Fill the following value it you prefer to specify the absolute path for the
// user files directory. Useful if you are using a virtual directory, symbolic
// link or alias. Examples: 'C:\\MySite\\userfiles\\' or '/root/mysite/userfiles/'.
// Attention: The above 'UserFilesPath' must point to the same directory.
//$Config['UserFilesAbsolutePath'] = '/www/intra_new/files/'.$_SESSION['node_unit'].'/';
$Config['UserFilesAbsolutePath'] = '/srv/www/htdocs/uploads/Dropbox/uploads/union/intra/';
