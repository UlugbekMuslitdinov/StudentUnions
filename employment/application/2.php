			...
			<div style="float:left; margin-left:30px; width:840px;">
				...
				<div style="background-color:#D2E5CA; padding: 1px 0px 15px 15px;">
					...
					<div style="padding: 15px 0;">
						<?php $_SESSION['employment_app'] -> form_start(2); ?>
						...
						<div style="width:30%;margin:0 1.5%;float:left;">
							...
							<section>
								...
								if(is_array($positions) && count($positions) == 0){
									echo '<input type="radio" name="position" disabled>';
								}else{
									$_SESSION['employment_app'] -> radio('redistribute', 'position', $_SESSION['employment_app']->application->applying_for->type);
								}
								?>
								<strong>I want to work in the following positions: </strong>
								<br/>
								<?php
						...
						<div style="width:30%;margin:0 1.5%;float:left;">
							...
							<?php $_SESSION['employment_app'] -> radio('redistribute', 'any', $_SESSION['employment_app']->application->applying_for->type); ?><label for="redistribute" ><strong>I want to work anywhere in the Union </strong></label>
						</div>
					</div>
