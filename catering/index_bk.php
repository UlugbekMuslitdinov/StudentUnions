...
<div class="wrap_catering" style="margin-top: 5px;">
	...
	<div class="c_header">
		<img src="js/images/catering_banner.jpg">
	</div>
	...
	<div class="c_content">
		<div class="cc_top">
			<img src="js/images/gold_rule.jpg">
		</div>

		<div class="cc_left">
			<img src="js/images/intro_box.png">
		</div>
			...
			<ul class="ccr_nav">
				...
				<li class="nav_li_no_child">
					<a href="/catering/team/" target="_blank" >
						<img src="js/images/meet_the_team.jpg">
					</a>
				</li>

				<li class="nav_li_1 nav_li" id="nav_li_1">
					<a class="nav_li_a">
						<img src="js/images/nav_guidelines.png">
					</a>
				...
				<li class="nav_li_2 nav_li" id="nav_li_2">
					<a class="nav_li_a" href="/catering/request/event">
						<img src="js/images/nav_catering_form.png">
					</a>
					<!-- <div class="ccr_subnav">
						<ul class="subnav_ul">
							<li class="subnav_li">
				...
				<!-- <li class="nav_li_3 nav_li" id="nav_li_3">
					<a class="nav_li_a">
						<img src="js/images/nav_catering_menu.png">
					</a>
					<div class="ccr_subnav">
						<ul class="subnav_ul">
							<li class="subnav_li">
				...
				<li class="nav_li_contact">
					<a href="../catering/contact_us.php" target="_blank" >
						<img src="js/images/nav_contact_us.jpg">
					</a>
				</li>
		...
		<div class="Wallop Wallop--fade">
			<div class="Wallop-list">
				<div class="Wallop-item">
					<img src="js/images/slides/slide1.jpg">
				</div>
				<div class="Wallop-item">
					<img src="js/images/slides/slide2.jpg">
				</div>
				<!-- <div class="Wallop-item">
					<img src="js/images/slides/slide3.jpg">
				</div> -->
				<div class="Wallop-item">
					<img src="js/images/slides/slide4.jpg">
				</div>
				<!-- <div class="Wallop-item">
					<img src="js/images/slides/slide5.jpg">
				</div> -->
				<div class="Wallop-item">
					<img src="js/images/slides/slide6.jpg">
				</div>
				<div class="Wallop-item">
					<img src="js/images/slides/slide7.jpg">
				</div>
				<div class="Wallop-item">
					<img src="js/images/slides/slide8.jpg">
				</div>
			</div>
