 ...
 * Page class
 */
class MealTimesDelete extends MealTimes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MealTimesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MealTimesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MealTimesList"); // Return to list
                return;
            }
        }
