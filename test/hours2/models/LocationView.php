...
class LocationView extends Location
{
    ...
    // Page object name
    public $PageObjName = "LocationView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("location_id") ?? Route("location_id")) !== null) {
                ...
                $returnUrl = "LocationList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "LocationList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "LocationList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
