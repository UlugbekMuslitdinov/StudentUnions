 ...
 * Page class
 */
class MenuSpecialsList extends MenuSpecials
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MenuSpecialsList";
    ...
    public $FormName = "fmenu_specialslist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "MenuSpecialsAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "MenuSpecialsDelete";
        $this->MultiUpdateUrl = "MenuSpecialsUpdate";
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->menu_special_price); // menu_special_price
            $this->updateSort($this->menu_restaurant); // menu_restaurant
            $this->updateSort($this->menu_category); // menu_category
            $this->updateSort($this->menu_special_startdate); // menu_special_startdate
            $this->updateSort($this->menu_special_enddate); // menu_special_enddate
            $this->updateSort($this->menu_special_replace_item); // menu_special_replace_item
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->setSessionOrderBy($orderBy);
                $this->id->setSort("");
                $this->menu_special->setSort("");
                $this->menu_special_price->setSort("");
                $this->menu_restaurant->setSort("");
                $this->menu_category->setSort("");
                $this->menu_special_comments->setSort("");
                $this->menu_special_startdate->setSort("");
                $this->menu_special_enddate->setSort("");
                $this->menu_special_replace_item->setSort("");
            }
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fmenu_specialslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fmenu_specialslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("menu_special_price", $this->createColumnOption("menu_special_price"));
            $option->add("menu_restaurant", $this->createColumnOption("menu_restaurant"));
            $option->add("menu_category", $this->createColumnOption("menu_category"));
            $option->add("menu_special_startdate", $this->createColumnOption("menu_special_startdate"));
            $option->add("menu_special_enddate", $this->createColumnOption("menu_special_enddate"));
            $option->add("menu_special_replace_item", $this->createColumnOption("menu_special_replace_item"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fmenu_specialssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fmenu_specialssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fmenu_specialslist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
