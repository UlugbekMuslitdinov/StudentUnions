...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fmeal_timesedit = new ew.Form("fmeal_timesedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fmeal_timesedit;
    ...
    fmeal_timesedit.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fmeal_timesedit" id="fmeal_timesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
