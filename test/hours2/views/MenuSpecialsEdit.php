...
loadjs.ready(["fmenu_specialsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmenu_specialsedit", "x_menu_special_startdate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fmenu_specialsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmenu_specialsedit", "x_menu_special_enddate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
