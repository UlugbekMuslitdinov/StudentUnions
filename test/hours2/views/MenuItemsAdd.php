...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fmenu_itemsadd = new ew.Form("fmenu_itemsadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fmenu_itemsadd;
    ...
    fmenu_itemsadd.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fmenu_itemsadd" id="fmenu_itemsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
