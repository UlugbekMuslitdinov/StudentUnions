...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    flocationedit = new ew.Form("flocationedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = flocationedit;
    ...
    flocationedit.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="flocationedit" id="flocationedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
