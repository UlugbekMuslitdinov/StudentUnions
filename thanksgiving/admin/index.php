...
// Get last page count
$query = "SELECT COUNT(1) FROM forms ORDER BY id DESC";
$result = $db->query($query);
...
$query = "SELECT * FROM forms ORDER BY id DESC LIMIT " . $starting_row . ", " . $rows_per_page;
$result = $db->query($query);
...
<div class="col-12 page_title">Thanksgiving Orders <span style="margin-left:750px;"><button><a href="reporting.php">REPORTING</a></button>&nbsp;&nbsp;&nbsp; <button><a href="export.php">EXPORT</a></button></span></div>
