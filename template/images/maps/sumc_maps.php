	...
	<body bgcolor="#ffffff">
		...
		<div align="center">
			...
			<table width="600" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><img src="<? echo 'UnionMap/sumc_' . $level . '.png' ?>" alt="sumc map" height="420" width="600" border="0"></td>
				</tr>
			</table>
			<br/>
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td valign="top"><img src="/infodesk/maps/sumc_legend.png" alt="map legend" width="326" border="0"></td>
					<td valign="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td valign="top"><img src="/infodesk/maps/sumc_notice.png" alt="" width="273" border="0"></td>
				</tr>
			</table>
		</div>
	</body>
