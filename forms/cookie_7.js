...
function dateValidation(value) {
    ...
    if(date > Date.parse('2022-4-19') && date <= Date.parse('2022-4-22')) {
        return true;
    }
	else if(date > Date.parse('2022-4-24') && date <= Date.parse('2022-4-29')) {
        return true;
    }
    else if(date > Date.parse('2022-5-1') && date <= Date.parse('2022-5-6')) {
        return true;
    }
    else if(date > Date.parse('2022-5-8') && date <= Date.parse('2022-5-13')) {
        return true;
    } else {
		return false;
	}
