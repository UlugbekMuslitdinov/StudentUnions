...
<?php }else{ ?>
			...
			<form class="col-sm-12" action="" method="post" id="bakesale-form" name="bakesale-form">
				...
				<div class="container-fluid row" style="margin-top: 20px;">
					...
					<span class="super-block">
							<p class="font-serif-italic"><b>PICKUP TIME:&nbsp;<span class="font-sans-italic"><b> 10am-3pm</b></span></b></p>
					</span> 
					<span class="super-block">
...
'					<div class="food-item" onchange="update_single_price(\''.$shortname.'\')">
	...
	<br />
					<div class="" style="padding: 10px 30px 0px 0px; border: 0px solid #333;">
							<b style="font-weight: bolder; letter-spacing: -0.5px;">TOTAL: $</b>
							<span id="total-no-tax" style="color: #BE1E35; font-size: 30px; font-weight: bold;">$0.00</span>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<b style="font-weight: bolder; letter-spacing: -0.5px;">TAX: $</b>
							<span id="tax" style="color: #BE1E35; font-size: 30px; font-weight: bold;">$0.00</span>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<b style="font-weight: bolder; letter-spacing: -0.5px;">GRAND TOTA: $</b>
