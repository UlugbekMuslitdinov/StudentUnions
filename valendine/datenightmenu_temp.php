...
<table class="table" width="95%" border="0" id="datenight-table" cellspacing="0">
  <thead>
    <tr>
      <th width="50%" id="menu_1_td"><h2>
		  <input type="checkbox" id="menu_1" name="menu_1" value="1" onClick="selectMenu(1)" >
		  &nbsp;<label for="menu_1" id="menu1_label" >Menu 1</label></h2>
	  </th><span> </span>
      <th width="50%" id="menu_2_td"><h2>
		  <!--<input type="radio" name="menu" id="menu_2" value="2" onClick="selectMenu(2)"  />-->
		  <input type="checkbox" id="menu_2" name="menu_2" value="2" onClick="selectMenu(2)" >
		  &nbsp;<label for="menu_2" id="menu2_label" >Menu 2 (<span id="green_option">Plant-Based Option</span>)</label></h2></th>
    </tr>
    </thead>
    <tbody>
    <tr>
      <td id="menu-info" valign="top"><p><h4><span id="title">Starter</span><br>
        ...
        <p><h4><span id="title">Entrée</span><br>
          <small>Ribeye Steak</small></h4>
          Roasted Mushrooms and Demi-Glace</p>
        <p><h4><span id="title">Sides</span></h4>
          Creamy Yukon Gold Mashed Potatoes<br>
          Roasted Tri-Color Cauliflower<br>
          Grilled Jumbo Asparagus, Orange Zest<br><br>
        Brioche Bread and Butter</p>
        <p><h4><span id="title">Dessert</span></h4>
      ...
      <td id="menu-info" valign="top"><p><h4><span id="title">Starter</span><br>
        ...
        Cheese Bread and Butter</p>
        <p><h4><span id="title">Dessert</span></h4>
          Tropical Mousse Cheese Cake<br>
        </p></td>
    </tr>
    <tr>
...
<p>&nbsp;</p>
					<div class="form-group grand-total">
						...
						<div>$<span id="grand_total" name="grand_total">0</span></div>
						<br>
...
<br>
				...
				<div class="row" align="center">
					<div class="col-md-12">
						<img class="img-fluid" src="./images/thanksgiving_sides_bottom_2.png" style="height:2rem;max-width: 100%;" />
					</div><br /><br />
				</div><br /><br />
		</div>
	</div>
...
function selectMenu(menuNum) {
	...
	var menu_1 = document.getElementById("quantity_menu1");
	var menu_2 = document.getElementById("quantity_menu2");
	...
	menu_1.disabled = false;
	menu_2.disabled = false;
	// Update the Grand Total amount with the checkbox selection.
	var grant_total = Number(menu_1.value) + Number(menu_2.value);
	var grant_total = grant_total * 59;
	total.innerHTML = grant_total; /* Calculate the Grand Total.*/
}
function updateTotal(menuNum) {
	...
	total.innerHTML = 59 * amountOrdered;
	total.value = 59 * amountOrdered;
}
</script>
