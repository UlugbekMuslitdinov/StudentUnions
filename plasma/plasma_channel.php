...
delivPage="get_deliv_block_channel.php";
...
* {cursor: none;}
	...
	<body style="overflow:hidden;background-color:#000;">
			...
			-->
			<div id="image_1" style="opacity:1; width:1600px; height:900px; position:absolute; top:0; left:0; overflow:hidden;" ><?php randomFeed(27); ?></div>
		
			<div id="image_2" style="opacity:0; width:1600px; height:900px; position:absolute; top:0; left:0; overflow:hidden;" >
			<script type="text/javascript">
			  firstLoad();
			</script>
			</div>
