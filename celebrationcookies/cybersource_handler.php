...
if($decision == 'ACCEPT') {
	...
	<body style="font-family: verdana;font-size: 14px; line-height: 150%">
		...
		<b>TOTAL: </b> $'.$_REQUEST['req_merchant_defined_data29'].' ($' . $_REQUEST['req_merchant_defined_data13'] . ' + $' . $_REQUEST['req_merchant_defined_data28'] . ' tax)<br/><br/>
		...
		<td align="center"><span style="font-size:20px;font-weight:bold;">'.$_REQUEST['req_merchant_defined_data16'].'</span></td>
		</tr>
		<tr>
		...
		<td align="center"><span style="font-size:20px;font-weight:bold;">'.$_REQUEST['req_merchant_defined_data20'].'</span></td>
		</tr>
		<tr>
		...
		<td align="center"><span style="font-size:20px;font-weight:bold;">'.$_REQUEST['req_merchant_defined_data22'].'</span></td>
		</tr>
		<tr>
		<td>Donate Spring Cookie 5-Pack - $11.99</td>
		<td align="center"><span style="font-size:20px;font-weight:bold;">'.$_REQUEST['req_merchant_defined_data23'].'</span></td>
		</tr>
		<tr>
		<td>Donate Graduation Potted Cookie Bouquet - $19.99</td>
		<td align="center"><span style="font-size:20px;font-weight:bold;">'.$_REQUEST['req_merchant_defined_data24'].'</span></td>
		</tr>
		<tr>
		<td>Donate Graduation Cookie 4-Pack - $9.99</td>
		<td align="center"><span style="font-size:20px;font-weight:bold;">'.$_REQUEST['req_merchant_defined_data25'].'</span></td>
		</tr>
		<tr>
		<td>Donate Graduation Cookie 5-Pack - $11.99</td>
		<td align="center"><span style="font-size:20px;font-weight:bold;">'.$_REQUEST['req_merchant_defined_data26'].'</span></td>
		</tr>
		<tr>
		<td>Donate Sports Cookie 5-Pack - $11.99</td>
		<td align="center"><span style="font-size:20px;font-weight:bold;">'.$_REQUEST['req_merchant_defined_data27'].'</span></td>
		</tr>
		</table>
	</body>
	</html>';
