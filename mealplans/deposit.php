...
mp_start('Deposit', 0, 1);
	...
	<?php
		...
		## There is an entry in the db/control table for this but it doesn't appear to be intended for this iteration of the Bursars option. Added in code so it can be automated by time/date.

		// set the deadline
		// $bursarDeadline = strtotime("2016-02-07 23:59:59");
		// $bursarDeadline = strtotime("2016-09-08 23:59:59");		
		// $bursarDeadline = strtotime("2017-02-03 23:59:59");
		// $bursarDeadline = strtotime("2017-09-07 23:59:59");
		$bursarDeadline = strtotime("2018-09-11 23:59:59");
		// $bursarDeadline = strtotime("2019-09-11 23:59:59");
		// $bursarDeadline = strtotime("2019-02-11 23:59:59");
	...
	<div>
		<div style="float:left;">
			...
			<p style="padding:0 0 5px 20px; margin:0; font-size:11px;"><strong>NOTE:</strong> After <?php echo date('n/j/Y', $bursarDeadline); ?> you <strong style="color:#ff0000;">will not</strong> be able to charge to your Bursars account for the remainder of the semester. Please plan accordingly.</p>
