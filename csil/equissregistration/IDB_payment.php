<?php
$form3 ='
	<h1>IDB/Check Verification</h1>
    
    <p>If you have been approved to pay by IDB or check, you should have been provided with a verification code.  Please enter that code below.</p>
    
    <form action="application.php" method="post">
	
		<input type="hidden" name="page3_submitted" value="true">
    	
        <p>Verification Code: <input type="text" name="idb_var_code" size="30" maxlength="50" /><br /></p>
    ...
    <p>If you did not mean to pay with IDB or check code, you can still complete your registration by paying with a credit card <a href="application.php?page=cc3">here</a></p>
</p>
<p>
