...
require_once($_SERVER['DOCUMENT_ROOT'] . '/catcash/includes/tia_functions.php');
...
function tia_transaction($transaction_type, $amount, $iso, $tender_number = '3', $terminal_number = 3, $online='T', $manual = 'F'){
global $cipher;
