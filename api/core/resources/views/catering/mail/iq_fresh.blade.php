        ...
        <tr>
            <td class="center" align="center" valign="top">
                <table class="container float-center" align="center" width="600"><tbody><tr><th class="small-12 large-12 columns first last" style="padding: 16px;">
                    ...
                    <p style="color:#ba6d39; font-size: 40px; font-weight: 600;">IQ Fresh</p>
                    ...
                    @else
                        ...
                        <p>
                            Hi,<br /><br />
                            There is a new order for IQ Fresh online catering!<br/> Please check the order and follow up.
                        </p>
                    @endif
                    ...
                    @include('catering.mail.iq_fresh.lunch')

                    @include('catering.mail.iq_fresh.teamlunch')

                    @include('catering.mail.catalyst.grandTotal')

                    <table class="small-12 large-12 columns"  cellpadding="0" cellspacing="0" style="margin-top:50px;border-top: 1px solid #c8942b;"> <tr> <td class="content-block" style="text-align:center; font-size:12px;color:#9e9e9e; padding-top: 10px;"> <span class="apple-link">IQ Fresh<br />1303 E University Blvd, Tucson, AZ 85719</span> </td> </tr> </table>
