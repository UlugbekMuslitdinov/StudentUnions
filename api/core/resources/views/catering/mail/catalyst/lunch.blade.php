...
<h5 class="mb-0 menu-section-title" style="color: #f58220; font-size: 19px; border-bottom: 2px solid #c8942b;">Lunch</h5>
<table  class="small-12 large-12 columns" style="width: 100%"><tbody>
    ...
    @if (isset($data->lunch->total) && $data->lunch->total != 0)
            ...
            <tr class="first-item" style="font-size: 15px;">
                <td>Lunch</td><td></td><td></td><td class="text-right"></td>
            </tr>

            @if ($data->lunch->qty != 0)

            <tr class="child-item"  style="font-size: 14px;">
            <td style="padding-left: 10px; font-size: 14px;"> - "Build Your Own" Lunch Box</td><td class="text-center" style="font-size: 14px; text-align: right;">${{$data->lunch->price}}</td><td class="text-center" style="font-size: 14px; text-align: right;">{{$data->lunch->qty}}</td><td class="text-right" style="font-size: 14px; text-align: right;">${{$data->lunch->total}}</td>
            </tr>
