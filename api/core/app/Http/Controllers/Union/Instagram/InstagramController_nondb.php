...
class InstagramController extends Controller 
{
	...
	// The Token expires every 2 month.  Refresh the Token automatically.
	public function refreshToken($token) {
		$fetch_link = "https://graph.instagram.com/refresh_access_token?grant_type=ig_refresh_token&access_token=" . $token;
		$json = file_get_contents($fetch_link);
