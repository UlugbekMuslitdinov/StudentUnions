<?php
   ...
   <div style="padding-left:20px;">
    ...
    <p style="width:500px;">
    In order to create a marketing campaign that best suits your needs, we need a little information. Once we receive your request, we will contact you and discuss a strategy to best reach your audience, and the tactics necessary to make your department, event, restaurant, or promotion a success. If you're not sure what you need, just fill out the General form, and we'll call you. <? if ($error1 == true) { print "<b><font color=\"red\">**</font></b>"; } ?><br />
    </p>
    ...
    / Year<? if ($error4 == true) { print "<b><font color=\"red\">**</font></b>"; } ?>) 
        ...
        <tr width="150px">
            ...
            *<i>Please Note: Marketing is here to create campaigns for you, and Fast Design / Fast Copy can help you create those quick, last minute requests. If your turnaround time is shorter than 14 days, please contact Fast Design, 621-5305.</i>
            </td>
       </tr>
       <tr>
            ...
            <td>
            	<textarea name="reqDesc" cols="50" rows="10" onfocus="this.value=''"><? if (isset($_SESSION['reqDesc']) && ($_SESSION['reqDesc'] != "") && ($_SESSION['reqDesc'] != "Enter Description Here")) { print stripslashes($_SESSION['reqDesc']); }else{ print "Enter as much information as you can about your project, the action you would like your audience to take, the feel of the campaign you would like to get across, the challenges you have had with campaigns in the past - anything we should know!"; } ?></textarea>
            </td>
       </tr>
       </table>
       </div>
...
<table>
    ...
    <tr>
    	...
    	<td colspan="2">
        <input type="text" name="webURL"  size="80" <? print "value=" . $_SESSION['webURL']; ?> >
        </td>
    </tr>
    <!--  <tr>
    	<td width="80px">&nbsp;
