<?php
  ...
  page_start($page_options);
		...
		for ($i = 1; $i < 41; $i++) {
			...
			$error = true;
			print "You have fields missing. Pleas fill them in.";
				}
			print "</font>";
			print "</div>";
		}
...
if (($diffDays < 14) && ($diffDays > 2)) {
	...
	require('marketing_db.inc');
      ...
      $project_id = mysql_insert_id();
			$to = 'create@email.arizona.edu, micheleh@email.arizona.edu';
    ...
    $project_id = $IDnum;
		$to = 'micheleh@email.arizona.edu, create@email.arizona.edu, mburton@email.arizona.edu, jmasson@email.arizona.edu';
