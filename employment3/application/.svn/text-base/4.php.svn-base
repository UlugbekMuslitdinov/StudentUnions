...
<div style="float:left; margin-left:30px; width:800px;">
	...
	<div style="float:left;">
		...
		<div style="float:left; background-color:#D2E5CA; width:525px; padding: 10px 10px 10px 10px;">
			...
			<br /><br />
			Duties: <br />
			<?= $_SESSION['employment_app'] -> textArea('com_duties', $_SESSION['employment_app']->application->application_values['com_duties']); ?>
			<br /><br />
			Employed From: 
			...
			<?= $_SESSION['employment_app'] -> textArea('com_leave', $_SESSION['employment_app']->application->application_values['com_leave']); ?>
			<br /><br />
