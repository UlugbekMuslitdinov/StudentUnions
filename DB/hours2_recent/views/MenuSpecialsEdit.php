...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fmenu_specialsedit = new ew.Form("fmenu_specialsedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fmenu_specialsedit;
    ...
    fmenu_specialsedit.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fmenu_specialsedit" id="fmenu_specialsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fmenu_specialsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmenu_specialsedit", "x_menu_special_startdate", jQuery.extend(true, {"ignoreReadonly":true,"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fmenu_specialsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmenu_specialsedit", "x_menu_special_enddate", jQuery.extend(true, {"ignoreReadonly":true,"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
