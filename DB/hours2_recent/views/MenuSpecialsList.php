...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fmenu_specialslist = new ew.Form("fmenu_specialslist", "list");
    currentPageID = ew.PAGE_ID = "list";
    currentForm = fmenu_specialslist;
...
<form name="fmenu_specialslist" id="fmenu_specialslist" class="ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<table id="tbl_menu_specialslist" class="table table-bordered table-hover table-sm ew-table"><!-- .ew-table -->
<thead>
...
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_menu_specials_id" class="menu_specials_id"><?= $Page->renderFieldHeader($Page->id) ?></div></th>
<?php } ?>
<?php if ($Page->menu_special_price->Visible) { // menu_special_price ?>
        <th data-name="menu_special_price" class="<?= $Page->menu_special_price->headerCellClass() ?>"><div id="elh_menu_specials_menu_special_price" class="menu_specials_menu_special_price"><?= $Page->renderFieldHeader($Page->menu_special_price) ?></div></th>
<?php } ?>
<?php if ($Page->menu_restaurant->Visible) { // menu_restaurant ?>
        <th data-name="menu_restaurant" class="<?= $Page->menu_restaurant->headerCellClass() ?>"><div id="elh_menu_specials_menu_restaurant" class="menu_specials_menu_restaurant"><?= $Page->renderFieldHeader($Page->menu_restaurant) ?></div></th>
<?php } ?>
<?php if ($Page->menu_category->Visible) { // menu_category ?>
        <th data-name="menu_category" class="<?= $Page->menu_category->headerCellClass() ?>"><div id="elh_menu_specials_menu_category" class="menu_specials_menu_category"><?= $Page->renderFieldHeader($Page->menu_category) ?></div></th>
<?php } ?>
<?php if ($Page->menu_special_startdate->Visible) { // menu_special_startdate ?>
        <th data-name="menu_special_startdate" class="<?= $Page->menu_special_startdate->headerCellClass() ?>"><div id="elh_menu_specials_menu_special_startdate" class="menu_specials_menu_special_startdate"><?= $Page->renderFieldHeader($Page->menu_special_startdate) ?></div></th>
<?php } ?>
<?php if ($Page->menu_special_enddate->Visible) { // menu_special_enddate ?>
        <th data-name="menu_special_enddate" class="<?= $Page->menu_special_enddate->headerCellClass() ?>"><div id="elh_menu_specials_menu_special_enddate" class="menu_specials_menu_special_enddate"><?= $Page->renderFieldHeader($Page->menu_special_enddate) ?></div></th>
<?php } ?>
<?php if ($Page->menu_special_replace_item->Visible) { // menu_special_replace_item ?>
        <th data-name="menu_special_replace_item" class="<?= $Page->menu_special_replace_item->headerCellClass() ?>"><div id="elh_menu_specials_menu_special_replace_item" class="menu_specials_menu_special_replace_item"><?= $Page->renderFieldHeader($Page->menu_special_replace_item) ?></div></th>
<?php } ?>
<?php
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge([
            ...
            "id" => "r" . $Page->RowCount . "_menu_specials",
