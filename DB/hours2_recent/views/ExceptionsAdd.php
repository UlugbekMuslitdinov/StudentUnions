...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fexceptionsadd = new ew.Form("fexceptionsadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fexceptionsadd;
    ...
    fexceptionsadd.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fexceptionsadd" id="fexceptionsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fexceptionsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fexceptionsadd", "x_date_of", jQuery.extend(true, {"ignoreReadonly":true,"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
