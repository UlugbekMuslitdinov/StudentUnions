...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fhours_defaultedit = new ew.Form("fhours_defaultedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fhours_defaultedit;
    ...
    fhours_defaultedit.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fhours_defaultedit" id="fhours_defaultedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
