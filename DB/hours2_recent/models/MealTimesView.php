 ...
 * Page class
 */
class MealTimesView extends MealTimes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MealTimesView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "MealTimesList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MealTimesList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "MealTimesList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
