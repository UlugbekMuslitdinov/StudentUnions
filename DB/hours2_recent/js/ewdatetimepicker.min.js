 ...
 */
ew.dateTimePickerOptions={keepInvalid:!0},ew.createDateTimePicker=function(t,e,a){if(!e.includes("$rowindex$")){var i=jQuery,n=ew.getElement(e,t),o=ew.getElement("sv_"+e,t),r=i(o||n),d=tempusDominus.Namespace.NAME,s=tempusDominus.Namespace.dataKey;if(n&&!r.data(s)&&!r.parent().data(s)){a=Object.assign({},ew.dateTimePickerOptions,a);var u=!i.isBoolean(a.inputGroup)||a.inputGroup;delete a.inputGroup,a.debug=a.debug||ew.DEBUG;var l={id:e,form:t,enabled:!0,inputGroup:u,options:a};if(i(document).trigger("datetimepicker",[l]),l.enabled){if(!1!==l.inputGroup){var p=r,c=r.hasClass("is-invalid");e="datetimepicker_"+t+"_"+r.attr("id");$btn=i('<button class="btn btn-default" type="button"><i class="far fa-calendar-alt"></i></button>').on("click."+s,(function(){p.removeClass("is-invalid")})),r.addClass(d+"-input").attr("data-target","#"+e).wrap(`<div class="input-group${c?" is-invalid":""}" id="${e}" data-target-input="nearest" data-td-target-toggle="nearest"></div>`).after($btn.attr("data-target","#"+e).attr("data-td-toggle",s)).on("focus."+s,(function(){p.tooltip("hide").tooltip("disable")})).on("blur."+s,(function(){p.tooltip("enable")})),r=r.parent().on("change."+s,(function(t){t.date&&p.trigger("change")}))}else r.addClass(s+"-input").attr("data-td-toggle",s).attr("data-target","#"+r.attr("id")).on("change."+s,(function(t){t.date&&r[0]!==n&&i(n).val(r.val()).trigger("change")})).on("focus."+s,(function(){r.tooltip("hide").tooltip("disable")})).on("blur."+s,(function(){r.tooltip("enable")}));r.tempusDominus(l.options)}}}};
