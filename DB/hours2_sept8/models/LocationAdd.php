 ...
 * Page class
 */
class LocationAdd extends Location
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LocationAdd";
    ...
    public function run()
    {
        ...
        // Set up lookup cache
        $this->setupLookupOptions($this->group_hours);
        $this->setupLookupOptions($this->breakfast);
        $this->setupLookupOptions($this->lunch);
        $this->setupLookupOptions($this->dinner);
        $this->setupLookupOptions($this->continuous);
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "LocationView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->location_url->CurrentValue = null;
        $this->location_url->OldValue = $this->location_url->CurrentValue;
        ...
        $this->group_hours->CurrentValue = null;
        $this->group_hours->OldValue = $this->group_hours->CurrentValue;
        $this->phone->CurrentValue = null;
        $this->phone->OldValue = $this->phone->CurrentValue;
        $this->subgroup->CurrentValue = null;
        $this->subgroup->OldValue = $this->subgroup->CurrentValue;
        $this->old_id->CurrentValue = null;
        $this->old_id->OldValue = $this->old_id->CurrentValue;
        $this->short_name->CurrentValue = null;
        $this->short_name->OldValue = $this->short_name->CurrentValue;
        $this->accept_plus_discount->CurrentValue = null;
        $this->accept_plus_discount->OldValue = $this->accept_plus_discount->CurrentValue;
        $this->lat->CurrentValue = null;
        $this->lat->OldValue = $this->lat->CurrentValue;
        $this->long->CurrentValue = null;
        $this->long->OldValue = $this->long->CurrentValue;
        $this->ua_mobile_categories->CurrentValue = null;
        $this->ua_mobile_categories->OldValue = $this->ua_mobile_categories->CurrentValue;
        $this->breakfast->CurrentValue = "no";
        $this->lunch->CurrentValue = null;
        $this->lunch->OldValue = $this->lunch->CurrentValue;
        $this->dinner->CurrentValue = null;
        $this->dinner->OldValue = $this->dinner->CurrentValue;
        $this->continuous->CurrentValue = null;
        $this->continuous->OldValue = $this->continuous->CurrentValue;
        $this->hours_message->CurrentValue = null;
        $this->hours_message->OldValue = $this->hours_message->CurrentValue;
    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->old_id->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->old_id->setFormValue($val, true, $validate);
            }
        }
        ...
        if (!$this->accept_plus_discount->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->accept_plus_discount->setFormValue($val, true, $validate);
            }
        }
    ...
    protected function newRow()
    {
        ...
        $row['location_name'] = $this->location_name->CurrentValue;
        $row['location_url'] = $this->location_url->CurrentValue;
        $row['group_id'] = $this->group_id->CurrentValue;
        $row['active'] = $this->active->CurrentValue;
        $row['group_hours'] = $this->group_hours->CurrentValue;
        $row['phone'] = $this->phone->CurrentValue;
        $row['subgroup'] = $this->subgroup->CurrentValue;
        $row['old_id'] = $this->old_id->CurrentValue;
        $row['short_name'] = $this->short_name->CurrentValue;
        $row['accept_plus_discount'] = $this->accept_plus_discount->CurrentValue;
        $row['lat'] = $this->lat->CurrentValue;
        $row['long'] = $this->long->CurrentValue;
        $row['ua_mobile_categories'] = $this->ua_mobile_categories->CurrentValue;
        $row['breakfast'] = $this->breakfast->CurrentValue;
        $row['lunch'] = $this->lunch->CurrentValue;
        $row['dinner'] = $this->dinner->CurrentValue;
        $row['continuous'] = $this->continuous->CurrentValue;
        $row['hours_message'] = $this->hours_message->CurrentValue;
        return $row;
    }
    ...
    public function renderRow()
    {
        ...
        // location_name
        $this->location_name->RowCssClass = "row";

        // location_url
        $this->location_url->RowCssClass = "row";
        ...
        // group_hours
        $this->group_hours->RowCssClass = "row";

        // phone
        $this->phone->RowCssClass = "row";

        // subgroup
        $this->subgroup->RowCssClass = "row";

        // old_id
        $this->old_id->RowCssClass = "row";

        // short_name
        $this->short_name->RowCssClass = "row";

        // accept_plus_discount
        $this->accept_plus_discount->RowCssClass = "row";

        // lat
        $this->lat->RowCssClass = "row";

        // long
        $this->long->RowCssClass = "row";

        // ua_mobile_categories
        $this->ua_mobile_categories->RowCssClass = "row";

        // breakfast
        $this->breakfast->RowCssClass = "row";

        // lunch
        $this->lunch->RowCssClass = "row";

        // dinner
        $this->dinner->RowCssClass = "row";

        // continuous
        $this->continuous->RowCssClass = "row";

        // hours_message
        $this->hours_message->RowCssClass = "row";
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->old_id->ViewValue = FormatNumber($this->old_id->ViewValue, "");
            ...
            $this->accept_plus_discount->ViewValue = FormatNumber($this->accept_plus_discount->ViewValue, "");
            ...
            // location_name
            $this->location_name->setupEditAttributes();
            ...
            // location_url
            $this->location_url->setupEditAttributes();
            ...
            // subgroup
            $this->subgroup->setupEditAttributes();
            ...
            // old_id
            $this->old_id->setupEditAttributes();
            ...
            if (strval($this->old_id->EditValue) != "" && is_numeric($this->old_id->EditValue)) {
                $this->old_id->EditValue = FormatNumber($this->old_id->EditValue, null);
            }

            // short_name
            $this->short_name->setupEditAttributes();
            ...
            // accept_plus_discount
            $this->accept_plus_discount->setupEditAttributes();
            ...
            if (strval($this->accept_plus_discount->EditValue) != "" && is_numeric($this->accept_plus_discount->EditValue)) {
                $this->accept_plus_discount->EditValue = FormatNumber($this->accept_plus_discount->EditValue, null);
            }
            ...
            // ua_mobile_categories
            $this->ua_mobile_categories->setupEditAttributes();
            ...
            // hours_message
            $this->hours_message->setupEditAttributes();
    ...
    protected function addRow($rsold = null)
    {
        ...
        // location_name
        $this->location_name->setDbValueDef($rsnew, $this->location_name->CurrentValue, null, false);

        // location_url
        $this->location_url->setDbValueDef($rsnew, $this->location_url->CurrentValue, null, false);
        ...
        // group_hours
        $this->group_hours->setDbValueDef($rsnew, $this->group_hours->CurrentValue, null, false);

        // phone
        $this->phone->setDbValueDef($rsnew, $this->phone->CurrentValue, null, false);

        // subgroup
        $this->subgroup->setDbValueDef($rsnew, $this->subgroup->CurrentValue, null, false);

        // old_id
        $this->old_id->setDbValueDef($rsnew, $this->old_id->CurrentValue, null, false);

        // short_name
        $this->short_name->setDbValueDef($rsnew, $this->short_name->CurrentValue, null, false);

        // accept_plus_discount
        $this->accept_plus_discount->setDbValueDef($rsnew, $this->accept_plus_discount->CurrentValue, null, false);

        // lat
        $this->lat->setDbValueDef($rsnew, $this->lat->CurrentValue, null, false);

        // long
        $this->long->setDbValueDef($rsnew, $this->long->CurrentValue, null, false);

        // ua_mobile_categories
        $this->ua_mobile_categories->setDbValueDef($rsnew, $this->ua_mobile_categories->CurrentValue, "", false);

        // breakfast
        $this->breakfast->setDbValueDef($rsnew, $this->breakfast->CurrentValue, "", strval($this->breakfast->CurrentValue) == "");

        // lunch
        $this->lunch->setDbValueDef($rsnew, $this->lunch->CurrentValue, "", false);

        // dinner
        $this->dinner->setDbValueDef($rsnew, $this->dinner->CurrentValue, "", false);

        // continuous
        $this->continuous->setDbValueDef($rsnew, $this->continuous->CurrentValue, "", false);

        // hours_message
        $this->hours_message->setDbValueDef($rsnew, $this->hours_message->CurrentValue, null, false);

        // Call Row Inserting event
        $insertRow = $this->rowInserting($rsold, $rsnew);

        // Check if key value entered
        if ($insertRow && $this->ValidateKey && strval($rsnew['location_id']) == "") {
