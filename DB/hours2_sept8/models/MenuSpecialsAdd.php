...
class MenuSpecialsAdd extends MenuSpecials
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        // menu_special_startdate
        $this->menu_special_startdate->setDbValueDef($rsnew, UnFormatDateTime($this->menu_special_startdate->CurrentValue, $this->menu_special_startdate->formatPattern()), null, false);

        // menu_special_enddate
        $this->menu_special_enddate->setDbValueDef($rsnew, UnFormatDateTime($this->menu_special_enddate->CurrentValue, $this->menu_special_enddate->formatPattern()), null, false);
