...
class HoursEdit extends Hours
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // openm
            $this->openm->setDbValueDef($rsnew, UnFormatDateTime($this->openm->CurrentValue, $this->openm->formatPattern()), null, $this->openm->ReadOnly);

            // closem
            $this->closem->setDbValueDef($rsnew, UnFormatDateTime($this->closem->CurrentValue, $this->closem->formatPattern()), null, $this->closem->ReadOnly);

            // opent
            $this->opent->setDbValueDef($rsnew, UnFormatDateTime($this->opent->CurrentValue, $this->opent->formatPattern()), null, $this->opent->ReadOnly);

            // closet
            $this->closet->setDbValueDef($rsnew, UnFormatDateTime($this->closet->CurrentValue, $this->closet->formatPattern()), null, $this->closet->ReadOnly);

            // openw
            $this->openw->setDbValueDef($rsnew, UnFormatDateTime($this->openw->CurrentValue, $this->openw->formatPattern()), null, $this->openw->ReadOnly);

            // closew
            $this->closew->setDbValueDef($rsnew, UnFormatDateTime($this->closew->CurrentValue, $this->closew->formatPattern()), null, $this->closew->ReadOnly);

            // openr
            $this->openr->setDbValueDef($rsnew, UnFormatDateTime($this->openr->CurrentValue, $this->openr->formatPattern()), null, $this->openr->ReadOnly);

            // closer
            $this->closer->setDbValueDef($rsnew, UnFormatDateTime($this->closer->CurrentValue, $this->closer->formatPattern()), null, $this->closer->ReadOnly);

            // openf
            $this->openf->setDbValueDef($rsnew, UnFormatDateTime($this->openf->CurrentValue, $this->openf->formatPattern()), null, $this->openf->ReadOnly);

            // closef
            $this->closef->setDbValueDef($rsnew, UnFormatDateTime($this->closef->CurrentValue, $this->closef->formatPattern()), null, $this->closef->ReadOnly);

            // opens
            $this->opens->setDbValueDef($rsnew, UnFormatDateTime($this->opens->CurrentValue, $this->opens->formatPattern()), null, $this->opens->ReadOnly);

            // closes
            $this->closes->setDbValueDef($rsnew, UnFormatDateTime($this->closes->CurrentValue, $this->closes->formatPattern()), null, $this->closes->ReadOnly);

            // openu
            $this->openu->setDbValueDef($rsnew, UnFormatDateTime($this->openu->CurrentValue, $this->openu->formatPattern()), null, $this->openu->ReadOnly);

            // closeu
            $this->closeu->setDbValueDef($rsnew, UnFormatDateTime($this->closeu->CurrentValue, $this->closeu->formatPattern()), null, $this->closeu->ReadOnly);
