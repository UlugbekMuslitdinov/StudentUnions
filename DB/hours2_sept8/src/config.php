...
$CONFIG = [
    ...
    "RANDOM_KEY" => '03hYozVd8QvnnYsL', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/project3.css", // Project stylesheet file name
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-red",
    "NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-red navbar-dark border-bottom-0",
    ...
    "ADMIN_USER_NAME" => "su-wdev", // Administrator user name
    "ADMIN_PASSWORD" => "hours2", // Administrator password
    ...
    */
    ...
    "CONFIG_CLIENT_VARS" => [
        ...
        "IMPORT_FILE_ALLOWED_EXT", // Import file allowed extensions
        "USE_COLORBOX",
