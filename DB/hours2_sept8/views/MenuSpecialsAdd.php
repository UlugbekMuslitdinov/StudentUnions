...
loadjs.ready(["fmenu_specialsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmenu_specialsadd", "x_menu_special_startdate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fmenu_specialsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fmenu_specialsadd", "x_menu_special_enddate", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
