...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fmenu_itemsview = new ew.Form("fmenu_itemsview", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = fmenu_itemsview;
...
$Page->showMessage();
?>
<form name="fmenu_itemsview" id="fmenu_itemsview" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->menu_item->Visible) { // menu_item ?>
    <tr id="r_menu_item"<?= $Page->menu_item->rowAttributes() ?>>
...
<?php if ($Page->menu_item_price->Visible) { // menu_item_price ?>
    <tr id="r_menu_item_price"<?= $Page->menu_item_price->rowAttributes() ?>>
...
<?php if ($Page->menu_item_comments->Visible) { // menu_item_comments ?>
    <tr id="r_menu_item_comments"<?= $Page->menu_item_comments->rowAttributes() ?>>
