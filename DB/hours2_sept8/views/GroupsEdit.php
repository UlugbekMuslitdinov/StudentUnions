...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fgroupsedit = new ew.Form("fgroupsedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fgroupsedit;
    ...
    fgroupsedit.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fgroupsedit" id="fgroupsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
