...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fexceptionsdelete = new ew.Form("fexceptionsdelete", "delete");
    currentPageID = ew.PAGE_ID = "delete";
    currentForm = fexceptionsdelete;
...
$Page->showMessage();
?>
<form name="fexceptionsdelete" id="fexceptionsdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
