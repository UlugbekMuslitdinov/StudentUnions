...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fhours_cateringview = new ew.Form("fhours_cateringview", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = fhours_cateringview;
...
$Page->showMessage();
?>
<form name="fhours_cateringview" id="fhours_cateringview" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->day_from->Visible) { // day_from ?>
    <tr id="r_day_from"<?= $Page->day_from->rowAttributes() ?>>
...
<?php if ($Page->day_to->Visible) { // day_to ?>
    <tr id="r_day_to"<?= $Page->day_to->rowAttributes() ?>>
...
<?php if ($Page->time_from->Visible) { // time_from ?>
    <tr id="r_time_from"<?= $Page->time_from->rowAttributes() ?>>
...
<?php if ($Page->time_to->Visible) { // time_to ?>
    <tr id="r_time_to"<?= $Page->time_to->rowAttributes() ?>>
