...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    flocation_descriptionsadd = new ew.Form("flocation_descriptionsadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = flocation_descriptionsadd;
    ...
    flocation_descriptionsadd.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="flocation_descriptionsadd" id="flocation_descriptionsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
