...
ew.createDateTimePicker = function(formid, id, options) {
    ...
    if (args.inputGroup !== false) {
        ...
        // 	<button class="btn btn-default" type="button" data-target="#{id}" data-td-toggle="td"><i class="far fa-calendar-alt"></i></button>
        // </div>
        var $textbox = $input,
        ...
        // <input type="text" class="form-control td-input" id="{id}" data-td-toggle="td" data-target="#{id}"/>
