 ...
 * Page class
 */
class ExceptionsEdit extends Exceptions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ExceptionsEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // date_of
            $this->date_of->setDbValueDef($rsnew, UnFormatDateTime($this->date_of->CurrentValue, $this->date_of->formatPattern()), null, $this->date_of->ReadOnly);

            // open
            $this->open->setDbValueDef($rsnew, UnFormatDateTime($this->open->CurrentValue, $this->open->formatPattern()), null, $this->open->ReadOnly);

            // close
            $this->close->setDbValueDef($rsnew, UnFormatDateTime($this->close->CurrentValue, $this->close->formatPattern()), null, $this->close->ReadOnly);
