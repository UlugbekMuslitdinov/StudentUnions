...
class MealTimesEdit extends MealTimes
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // startm
            $this->startm->setDbValueDef($rsnew, UnFormatDateTime($this->startm->CurrentValue, $this->startm->formatPattern()), null, $this->startm->ReadOnly);

            // endm
            $this->endm->setDbValueDef($rsnew, UnFormatDateTime($this->endm->CurrentValue, $this->endm->formatPattern()), null, $this->endm->ReadOnly);

            // startt
            $this->startt->setDbValueDef($rsnew, UnFormatDateTime($this->startt->CurrentValue, $this->startt->formatPattern()), null, $this->startt->ReadOnly);

            // endt
            $this->endt->setDbValueDef($rsnew, UnFormatDateTime($this->endt->CurrentValue, $this->endt->formatPattern()), null, $this->endt->ReadOnly);

            // startw
            $this->startw->setDbValueDef($rsnew, UnFormatDateTime($this->startw->CurrentValue, $this->startw->formatPattern()), null, $this->startw->ReadOnly);

            // endw
            $this->endw->setDbValueDef($rsnew, UnFormatDateTime($this->endw->CurrentValue, $this->endw->formatPattern()), null, $this->endw->ReadOnly);

            // startr
            $this->startr->setDbValueDef($rsnew, UnFormatDateTime($this->startr->CurrentValue, $this->startr->formatPattern()), null, $this->startr->ReadOnly);

            // endr
            $this->endr->setDbValueDef($rsnew, UnFormatDateTime($this->endr->CurrentValue, $this->endr->formatPattern()), null, $this->endr->ReadOnly);

            // startf
            $this->startf->setDbValueDef($rsnew, UnFormatDateTime($this->startf->CurrentValue, $this->startf->formatPattern()), null, $this->startf->ReadOnly);

            // endf
            $this->endf->setDbValueDef($rsnew, UnFormatDateTime($this->endf->CurrentValue, $this->endf->formatPattern()), null, $this->endf->ReadOnly);

            // starts
            $this->starts->setDbValueDef($rsnew, UnFormatDateTime($this->starts->CurrentValue, $this->starts->formatPattern()), null, $this->starts->ReadOnly);

            // ends
            $this->ends->setDbValueDef($rsnew, UnFormatDateTime($this->ends->CurrentValue, $this->ends->formatPattern()), null, $this->ends->ReadOnly);

            // startu
            $this->startu->setDbValueDef($rsnew, UnFormatDateTime($this->startu->CurrentValue, $this->startu->formatPattern()), null, $this->startu->ReadOnly);

            // endu
            $this->endu->setDbValueDef($rsnew, UnFormatDateTime($this->endu->CurrentValue, $this->endu->formatPattern()), null, $this->endu->ReadOnly);
