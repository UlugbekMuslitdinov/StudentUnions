...
class Location extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // location_name
        $this->location_name = new DbField(
            'location',
            'location',
            'x_location_name',
            'location_name',
        ...
        $this->location_name->InputTextType = "text";
        $this->Fields['location_name'] = &$this->location_name;

        // location_url
        $this->location_url = new DbField(
            'location',
            'location',
            'x_location_url',
            'location_url',
        ...
        $this->location_url->InputTextType = "text";
        ...
        $this->group_hours->InputTextType = "text";
        ...
        $this->subgroup->InputTextType = "text";
        $this->Fields['subgroup'] = &$this->subgroup;

        // old_id
        $this->old_id = new DbField(
            'location',
            'location',
            'x_old_id',
            'old_id',
        ...
        $this->short_name->InputTextType = "text";
        $this->Fields['short_name'] = &$this->short_name;

        // accept_plus_discount
        $this->accept_plus_discount = new DbField(
            'location',
            'location',
            'x_accept_plus_discount',
            'accept_plus_discount',
            '`accept_plus_discount`',
            '`accept_plus_discount`',
            3,
        ...
        $this->accept_plus_discount->InputTextType = "text";
        ...
        $this->ua_mobile_categories = new DbField(
            'location',
            'location',
        ...
        $this->ua_mobile_categories->InputTextType = "text";
        ...
        $this->breakfast->InputTextType = "text";
        ...
        $this->dinner->InputTextType = "text";
        ...
        $this->continuous->InputTextType = "text";
        ...
        // hours_message
        $this->hours_message = new DbField(
            'location',
            'location',
            'x_hours_message',
            'hours_message',
        ...
        $this->hours_message->InputTextType = "text";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("LocationList");
    }
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->location_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->location_id->CurrentValue);
        } else {
