...
class MenuSpecials extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->menu_special->InputTextType = "text";
        $this->Fields['menu_special'] = &$this->menu_special;

        // menu_special_price
        $this->menu_special_price = new DbField(
            'menu_specials',
            'menu_specials',
            'x_menu_special_price',
            'menu_special_price',
            '`menu_special_price`',
            '`menu_special_price`',
            131,
        ...
        $this->menu_special_price->InputTextType = "text";
        ...
        // menu_restaurant
        $this->menu_restaurant = new DbField(
            'menu_specials',
            'menu_specials',
            'x_menu_restaurant',
            'menu_restaurant',
        ...
        $this->menu_restaurant->InputTextType = "text";
        ...
        // menu_category
        $this->menu_category = new DbField(
            'menu_specials',
            'menu_specials',
            'x_menu_category',
            'menu_category',
        ...
        $this->menu_category->InputTextType = "text";
        ...
        $this->menu_special_comments = new DbField(
            'menu_specials',
            'menu_specials',
            'x_menu_special_comments',
            'menu_special_comments',
            '`menu_special_comments`',
            '`menu_special_comments`',
            201,
        ...
        $this->menu_special_comments->InputTextType = "text";
        $this->Fields['menu_special_comments'] = &$this->menu_special_comments;

        // menu_special_startdate
        $this->menu_special_startdate = new DbField(
            'menu_specials',
            'menu_specials',
            'x_menu_special_startdate',
            'menu_special_startdate',
            '`menu_special_startdate`',
            CastDateFieldForLike("`menu_special_startdate`", 0, "DB"),
            135,
            19,
            0,
            false,
        ...
        $this->menu_special_startdate->InputTextType = "text";
        ...
        $this->menu_special_enddate = new DbField(
            'menu_specials',
            'menu_specials',
            'x_menu_special_enddate',
            'menu_special_enddate',
            '`menu_special_enddate`',
            CastDateFieldForLike("`menu_special_enddate`", 0, "DB"),
            135,
            19,
            0,
            false,
        ...
        $this->menu_special_enddate->InputTextType = "text";
        ...
        $this->menu_special_replace_item = new DbField(
            'menu_specials',
            'menu_specials',
            'x_menu_special_replace_item',
            'menu_special_replace_item',
            '`menu_special_replace_item`',
            '`menu_special_replace_item`',
            3,
        ...
        $this->menu_special_replace_item->InputTextType = "text";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MenuSpecialsList");
    }
