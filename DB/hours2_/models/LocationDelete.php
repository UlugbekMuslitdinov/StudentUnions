 ...
 * Page class
 */
class LocationDelete extends Location
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LocationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("LocationList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("LocationList"); // Return to list
                return;
            }
        }
