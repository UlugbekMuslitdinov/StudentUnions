...
class HoursDefaultAdd extends HoursDefault
{
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (strval($this->hour_id->EditValue) != "" && is_numeric($this->hour_id->EditValue)) {
                $this->hour_id->EditValue = FormatNumber($this->hour_id->EditValue, null);
            }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // mon_open
        $this->mon_open->setDbValueDef($rsnew, UnFormatDateTime($this->mon_open->CurrentValue, $this->mon_open->formatPattern()), null, false);

        // mon_close
        $this->mon_close->setDbValueDef($rsnew, UnFormatDateTime($this->mon_close->CurrentValue, $this->mon_close->formatPattern()), null, false);

        // tue_open
        $this->tue_open->setDbValueDef($rsnew, UnFormatDateTime($this->tue_open->CurrentValue, $this->tue_open->formatPattern()), null, false);

        // tue_close
        $this->tue_close->setDbValueDef($rsnew, UnFormatDateTime($this->tue_close->CurrentValue, $this->tue_close->formatPattern()), null, false);

        // wed_open
        $this->wed_open->setDbValueDef($rsnew, UnFormatDateTime($this->wed_open->CurrentValue, $this->wed_open->formatPattern()), null, false);

        // wed_close
        $this->wed_close->setDbValueDef($rsnew, UnFormatDateTime($this->wed_close->CurrentValue, $this->wed_close->formatPattern()), null, false);

        // thu_open
        $this->thu_open->setDbValueDef($rsnew, UnFormatDateTime($this->thu_open->CurrentValue, $this->thu_open->formatPattern()), null, false);

        // thu_close
        $this->thu_close->setDbValueDef($rsnew, UnFormatDateTime($this->thu_close->CurrentValue, $this->thu_close->formatPattern()), null, false);

        // fri_open
        $this->fri_open->setDbValueDef($rsnew, UnFormatDateTime($this->fri_open->CurrentValue, $this->fri_open->formatPattern()), null, false);

        // fri_close
        $this->fri_close->setDbValueDef($rsnew, UnFormatDateTime($this->fri_close->CurrentValue, $this->fri_close->formatPattern()), null, false);

        // sat_open
        $this->sat_open->setDbValueDef($rsnew, UnFormatDateTime($this->sat_open->CurrentValue, $this->sat_open->formatPattern()), null, false);

        // sat_close
        $this->sat_close->setDbValueDef($rsnew, UnFormatDateTime($this->sat_close->CurrentValue, $this->sat_close->formatPattern()), null, false);

        // sun_open
        $this->sun_open->setDbValueDef($rsnew, UnFormatDateTime($this->sun_open->CurrentValue, $this->sun_open->formatPattern()), null, false);

        // sun_close
        $this->sun_close->setDbValueDef($rsnew, UnFormatDateTime($this->sun_close->CurrentValue, $this->sun_close->formatPattern()), null, false);
