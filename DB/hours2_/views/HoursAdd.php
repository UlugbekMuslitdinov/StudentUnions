...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fhoursadd = new ew.Form("fhoursadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fhoursadd;
    ...
    fhoursadd.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fhoursadd" id="fhoursadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->type->isInvalidClass() ?>" data-table="hours" data-field="x_type" name="x_type[]" id="x_type_190911" value="1"<?= ConvertToBool($Page->type->CurrentValue) ? " checked" : "" ?><?= $Page->type->editAttributes() ?> aria-describedby="x_type_help">
