...
loadjs.ready(["fperiodsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fperiodsadd", "x_start_date", jQuery.extend(true, {"ignoreReadonly":true,"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fperiodsadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fperiodsadd", "x_end_date", jQuery.extend(true, {"ignoreReadonly":true,"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->type->isInvalidClass() ?>" data-table="periods" data-field="x_type" name="x_type[]" id="x_type_307393" value="1"<?= ConvertToBool($Page->type->CurrentValue) ? " checked" : "" ?><?= $Page->type->editAttributes() ?> aria-describedby="x_type_help">
