...
var extra_price = [5.99,5.99,5.99,3.00];
...
function partyPackUpgrade(new_val){
	if (new_val < party_pack_upgrade){
		...
		$("#upgrade_diet_coke").val(0);
		$("#upgrade_sprite").val(0);
		$("#upgrade_coke_zero").val(0);
		$("#upgrade_dr_pepper").val(0);
		$("#upgrade_diet_dr_pepper").val(0);
		soda_selected['upgrade_coke'] = 0;
		soda_selected['upgrade_diet_coke'] = 0;
		soda_selected['upgrade_coke_zero'] = 0;
		soda_selected['upgrade_sprite'] = 0;
		soda_selected['upgrade_dr_pepper'] = 0;
		soda_selected['upgrade_diet_dr_pepper'] = 0;
		upgrade_selected = 0;
	}
...
$("#upgrade_coke_zero").bind("keyup mouseup change focusout", function(){
	checkPartyPackUpgrade($(this).attr("id"));
});

$("#upgrade_dr_pepper").bind("keyup mouseup change focusout", function(){
	checkPartyPackUpgrade($(this).attr("id"));
});

$("#upgrade_diet_dr_pepper").bind("keyup mouseup change focusout", function(){
	checkPartyPackUpgrade($(this).attr("id"));
});
...
function checkPartyPackUpgradeSum(diff){
	...
	// console.log(diff);
	// console.log('party pack upgrade : ' + party_pack_upgrade);
...
$('body').on('click','#reviewOrder',function(){
	...
	// Better use loop
	var pack_upgrade_selected = soda_selected['upgrade_coke'] + soda_selected['upgrade_diet_coke'] + soda_selected['upgrade_coke_zero'] + soda_selected['upgrade_sprite'] + soda_selected['upgrade_dr_pepper'] + soda_selected['upgrade_diet_dr_pepper'];
	if (pack_upgrade_selected != party_pack_upgrade){
		error = true;
		getErrPosition("#partyPack_upgrade_err");
		$("#partyPack_upgrade_err").text('Select one flavor per Party Pack');
	}
